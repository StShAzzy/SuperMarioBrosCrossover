package neoart.flod.xm
{
   ...
   public final class XMPlayer extends SBPlayer
   {
      ...
      var patterns:Vector.<XMPattern>;
      
      var instruments:Vector.<XMInstrument>;
                        ...
                        case XM.FX_EXTENDED_EFFECTS:
                           switch(_loc4_)
                           {
                              ...
                              case XM.EX_VIBRATO_CONTROL:
                                 _loc8_.waveControl = _loc8_.waveControl & 240 | _loc5_;
                                 break;
                              ...
                              case XM.EX_TREMOLO_CONTROL:
                                 _loc8_.waveControl = _loc8_.waveControl & 15 | _loc5_ << 4;
                                 break;
                        ...
                        case XM.FX_SET_ENVELOPE_POSITION:
                           if(_loc1_.hasVolume)
                           {
                              ...
                              else
                              {
                                 ...
                                 if(_loc11_ = (_loc13_ = _loc1_.volData.points[_loc8_.volEnvelope.position]).frame - _loc12_.frame)
                                 {
                        ...
                        case XM.FX_MULTI_RETRIG_NOTE:
                           ...
                           if(!_loc6_.volume)
                           {
                              if(_loc8_.retrigY)
                              {
                                 ...
                                 {
                                    if((!_loc6_.volume || _loc6_.volume > 80) && _loc8_.retrigX)
                                    {
         ...
         while(_loc7_)
         {
            ...
            switch(_loc4_.effect)
            {
               ...
               case XM.FX_GLOBAL_VOLUME_SLIDE:
                  ...
                  _loc3_ = _loc7_.volSlideMaster & 15;
                  if(_loc2_)
                  {
                     master += _loc2_;
                     if(master > 64)
               ...
               case XM.FX_MULTI_RETRIG_NOTE:
                  ...
                  {
                     if((!_loc4_.volume || _loc4_.volume > 80) && _loc7_.retrigX)
                     {
      ...
      private function update(param1:XMVoice) : void
      {
         ...
         if(_loc3_ & XM.FLAG_VOLUME)
         {
            ...
            _loc4_ = (_loc4_ = param1.volEnvelope.value * param1.volume * param1.fadeout * master) * (1 / (64 * 64 * 65536 * 64) * 0.5);
         ...
         {
            if((_loc4_ = param1.panning + (param1.panEnvelope.value - 32) * ((128 - Math.abs(param1.panning - 128)) / 32)) < 0)
            {
               _loc4_ = 0;
            }
            else if(_loc4_ > 255)
      ...
      private function envelope(param1:XMEnvelope, param2:XMData, param3:int, param4:XMVoice) : void
      {
         ...
         if(!param1.stopped)
         {
            ...
            {
               if(param2.flags & XM.ENVELOPE_LOOP && _loc6_ == param2.loopEnd)
               {
               ...
               if(_loc7_ = _loc8_.frame - _loc5_.frame)
               {
