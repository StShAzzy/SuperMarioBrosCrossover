package sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2
{
   ...
   import sample.libgme.__ZTV8Gbs_File;
   import sample.libgme.___gxx_personality_sj0;
   import sample.libgme._gme_gbs_type;
   import sample.libgme.eax;
   import sample.libgme.setjmp;
   
   public function F__ZL12new_gbs_filev() : void
   {
      var _loc3_:* = 0;
      var _loc4_:int = 0;
      var _loc10_:* = 0;
      ...
      while(true)
      {
         try
         {
            ...
            if(_loc1_ == 0)
            {
               ...
               F__ZN9Music_EmuC2Ev();
               _loc2_ += 16;
               _loc1_ = int(__ZTV8Gbs_File + 8);
               _loc7_ = li32(_loc3_ - 60);
               si32(_loc1_,_loc7_);
               _loc1_ = li32(_loc3_ - 60);
               si32(_gme_gbs_type,_loc1_ + 4);
               _loc2_ -= 16;
               si32(_loc9_,_loc2_);
               ESP = _loc2_;
