package sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2
{
   ...
   import sample.libgme.F__ZN9Music_EmuC2Ev;
   import sample.libgme.F_malloc;
   import sample.libgme.LongJmp;
   import sample.libgme.__ZTV7Sap_Emu;
   import sample.libgme.___gxx_personality_sj0;
   import sample.libgme._gme_sap_type;
   import sample.libgme.eax;
   import sample.libgme.setjmp;
   
   public function F__ZL11new_sap_emuv() : void
   {
      var _loc3_:* = 0;
      var _loc4_:int = 0;
      var _loc10_:* = 0;
      ...
      while(true)
      {
         try
         {
            if(!_loc4_)
            {
               ...
               _loc11_ = int(_loc1_ + 284);
               _loc1_ = li32(_loc3_ - 60);
               si32(_loc11_,_loc1_ + 280);
               _loc10_ = li32(_loc3_ - 60);
               si32(L_LSDA_543,_loc3_ - 28);
            ...
            if(_loc1_ == 0)
            {
               ...
               si32(0,_loc7_ + 268);
               si32(_loc11_ = int(__ZTV7Sap_Emu + 8),_loc1_);
               _loc1_ = li32(_loc3_ - 60);
               si32(0,_loc1_ + 980);
               _loc1_ = li32(_loc3_ - 60);
               si32(0,_loc1_ + 916);
               ...
               si32(0,_loc1_ + 1080);
               _loc1_ = li32(_loc3_ - 60);
               _loc11_ = int(_loc1_ + 67200);
               _loc1_ = li32(_loc3_ - 60);
               si32(_loc11_,_loc1_ + 67184);
               _loc1_ = li32(_loc3_ - 60);
               ...
               si32(__ZZN7Sap_EmuC4EvE5types,_loc7_ + 268);
               _loc1_ = li32(_loc3_ - 60);
               si32(6,_loc1_ + 220);
               _loc2_ -= 16;
               si32(_loc9_,_loc2_);
