package sample.libgme
{
   ...
   public function F__ZN7Kss_EmuC2Ev() : void
   {
      ...
      _loc1_ = li32(_loc3_);
      var _loc12_:*;
      si32(_loc12_ = int(_loc1_ + 792),_loc1_ + 788);
      _loc11_ = _loc1_ + 255;
      _loc10_ = 0;
      do
      {
         ...
         _loc12_ = int(_loc1_ + _loc10_);
         var _loc6_:* = int(_loc11_ + _loc10_);
         var _loc5_:* = _loc4_ & 168;
         si8(_loc5_ = _loc7_ | _loc5_,_loc6_ + 272);
         si8(_loc6_ = _loc5_ | 1,_loc12_ + 783);
      }
      while((_loc10_ += -1) != -256);
      
      si8(_loc12_ = (_loc12_ = li8(_loc1_ + 272)) | 64,_loc1_ + 272);
      si8(_loc12_ = (_loc12_ = li8(_loc1_ + 528)) | 64,_loc1_ + 528);
      _loc2_ -= 16;
      si32(_loc1_,_loc2_);
      ESP = _loc2_;
      F__ZN9Music_EmuC2Ev();
      ...
      si32(0,_loc1_ + 256);
      si32(0,_loc1_ + 268);
      si32(_loc12_ = int(__ZTV7Kss_Emu + 8),_loc1_);
      si32(0,_loc1_ + 904);
      si32(0,_loc1_ + 908);
      _loc2_ -= 16;
      si32(_loc12_ = int(_loc1_ + 66784),_loc2_);
      ESP = _loc2_;
      F__ZN6Ay_ApuC1Ev();
      _loc2_ += 16;
      si32(_loc12_ = int(_loc1_ + 68352),_loc1_ + 68336);
      si32(8,_loc1_ + 68340);
      si32(0,_loc1_ + 68332);
      si32(0,_loc1_ + 68328);
      si32(0,_loc1_ + 68344);
      ...
      si32(0,_loc1_ + 68156);
      si32(0,_loc1_ + 68872);
      si32(_gme_kss_type,_loc1_ + 4);
      si32(6,_loc1_ + 220);
      si32(__ZZN7Kss_EmuC4EvE5names,_loc1_ + 164);
      si32(__ZZN7Kss_EmuC4EvE5types,_loc1_ + 268);
      _loc2_ -= 16;
      si32(256,_loc2_ + 8);
      si32(255,_loc2_ + 4);
      si32(_loc12_ = int(_loc1_ + 68876),_loc2_);
      ESP = _loc2_;
      Fmemset();
      _loc2_ += 16;
      _loc2_ = _loc3_;
