package sample.libgme
{
   ...
   public function F__ZN9Gb_Square3runEiii() : void
   {
      ...
      _loc12_ = (_loc13_ = li32(_loc3_ + 36)) & _loc14_;
      _loc15_ = int((_loc15_ = li8((_loc11_ = li32(_loc3_ + 24)) + 1)) >>> 6);
      _loc10_ = li8(_loc15_ = int(__ZZN9Gb_Square3runEiiiE5table + _loc15_));
      if((_loc15_ = li32(_loc3_ + 64)) >= _loc10_)
      {
         _loc12_ = int(0 - _loc12_);
      }
      _loc15_ = li8(_loc11_ + 3);
      var _loc9_:*;
      _loc8_ = int((_loc11_ = (_loc9_ = (_loc9_ = (_loc9_ = li8(_loc11_ + 4)) << 8) & 1792) | _loc15_) + -1);
      _loc13_ >>= 1;
      if(uint(_loc8_) <= 2040)
      {
         _loc13_ = _loc12_;
      ...
      if(_loc13_ != _loc1_)
      {
         ...
         var _loc5_:*;
         si32(_loc5_ = int(_loc13_ - _loc1_),_loc2_ + 8);
         var _loc6_:*;
         si32(_loc9_ = int((_loc6_ = int(li32(_loc5_) * _loc12_)) + li32((_loc5_ = li32(_loc3_ + 16)) + 4)),_loc2_ + 4);
      ...
      if(_loc15_ == 0)
      {
         _loc8_ = int((_loc15_ = li32(_loc3_ + 28)) + _loc12_);
      }
      if(_loc8_ < _loc14_)
      {
         _loc12_ = _loc13_ << 1;
         ...
         _loc11_ = int(8192 - (_loc11_ << 2));
         do
         {
            if((_loc13_ = (_loc15_ = int(_loc13_ + 1)) & 7) != 0)
            {
               if(_loc13_ != _loc10_)
               {
                  continue;
            ...
            si32(_loc9_ = int((_loc6_ *= _loc8_) + _loc9_),_loc2_ + 4);
            si32(_loc15_,_loc2_);
            ESP = _loc2_;
            F__ZNK10Blip_SynthILi12ELi1EE16offset_resampledEjiP11Blip_Buffer();
            _loc2_ += 16;
         ...
         si32(_loc15_ = _loc12_ >> 1,_loc3_ + 32);
      }
      si32(_loc15_ = int(_loc8_ - _loc14_),_loc3_ + 28);
      _loc2_ = _loc4_;
      ESP = _loc2_;
   }
}
