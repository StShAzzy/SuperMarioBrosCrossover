package sample.libgme
{
   ...
   public function F__ZN7Spc_Emu12start_track_Ei() : void
   {
      ...
      if((_loc11_ = li32(_loc12_ + 268)) != 0)
      {
         ...
         var _loc7_:*;
         var _loc8_:*;
         si32(_loc7_ = int((_loc8_ = li32(_loc12_ + 264)) + _loc9_),_loc12_ + 272);
         _loc2_ -= 16;
      ...
      _loc6_ = _loc12_ + 1856;
      _loc5_ = L__2E_str10479;
      if(_loc10_ >= 65920)
      {
         while(true)
         {
            _loc4_ = li8(_loc7_ = int(_loc11_ - _loc1_));
            _loc7_ = li8(_loc7_ = int(L__2E_str11480 - _loc1_));
            _loc5_ = L__2E_str10479;
            if(_loc4_ == _loc7_)
            {
               if(_loc4_ != 0)
               ...
               si32(_loc7_ = (_loc8_ = (_loc8_ = li8(_loc11_ + 38)) << 8) | _loc7_,_loc3_ - 16);
               _loc1_ = int(_loc3_ - 16);
               _loc8_ = _loc1_ | 4;
               si8(_loc7_ = li8(_loc11_ + 39),_loc8_);
               _loc7_ = _loc1_ | 5;
               si8(_loc8_ = li8(_loc11_ + 40),_loc7_);
               _loc7_ = _loc1_ | 6;
               si8(_loc8_ = li8(_loc11_ + 41),_loc7_);
               _loc7_ = _loc1_ | 7;
               si8(_loc8_ = li8(_loc11_ + 42),_loc7_);
               si8(_loc7_ = li8(_loc11_ + 43),_loc3_ - 8);
               if(uint(_loc10_) >= 66048)
               {
                  _loc2_ -= 16;
                  si32(64,_loc2_ + 8);
                  si32(_loc7_ = int(_loc11_ + 65920),_loc2_ + 4);
                  si32(_loc7_ = int(_loc12_ + 68596),_loc2_);
                  ESP = _loc2_;
                  Fmemcpy();
                  _loc2_ += 16;
               }
               ...
               si32(_loc1_,_loc2_ + 4);
               si32(_loc6_,_loc2_);
               si32(_loc7_ = int(_loc11_ + 65792),_loc2_ + 12);
               si32(_loc7_ = int(_loc11_ + 256),_loc2_ + 8);
               ESP = _loc2_;
               F__ZN8Snes_Spc10load_stateERKN7Spc_Cpu11registers_tEPKvS5_();
               _loc2_ += 16;
               si8(_loc5_ = 0,_loc12_ + 2458);
               if((_loc7_ = (_loc7_ = li8(_loc12_ + 2052)) & 32) == 0)
               {
                  _loc2_ -= 16;
                  si32(255,_loc2_ + 4);
                  _loc1_ = li8(_loc12_ + 2069) << 11;
                  _loc11_ = li8(_loc12_ + 2053) << 8;
                  _loc10_ = int(65536 - _loc11_);
                  if(uint(_loc1_) >= uint(_loc10_))
                  {
                     _loc1_ = _loc10_;
                  }
                  si32(_loc1_,_loc2_ + 8);
                  si32(_loc7_ = int((_loc7_ = int(_loc12_ + _loc11_)) + 2804),_loc2_);
                  ESP = _loc2_;
                  Fmemset();
                  _loc2_ += 16;
                  _loc5_ = 0;
