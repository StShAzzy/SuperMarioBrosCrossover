   ...
   public function F__ZN7Spc_Emu5play_ElPs() : void
   {
      ...
      if(_loc13_ != 32000)
      {
         ...
         while(true)
         {
            ...
            si32(_loc13_ = int(_loc12_ + ((_loc13_ = int(_loc11_ - _loc8_)) << 1)),_loc2_ + 4);
            ESP = _loc2_;
            ...
            if((_loc8_ -= int(eax)) >= 1)
            {
               ...
               si32(_loc10_,_loc2_);
               var _loc6_:int;
               si32(_loc5_ = (_loc13_ = int((_loc6_ = li32(_loc3_ + 264) + (li32(_loc3_ + 268) << 1)) - _loc13_)) >> 1,_loc2_ + 4);
               ESP = _loc2_;
               ...
               si32(_loc13_ = int((_loc13_ = li32(_loc3_ + 272)) + (_loc5_ << 1)),_loc3_ + 272);
               if(uint(_loc13_) > uint(int(li32(_loc3_ + 264) + (li32(_loc3_ + 268) << 1))))
               {
                  _loc2_ -= 16;
                  si32(L__2E_str8505,_loc2_ + 12);
                  si32(96,_loc2_ + 8);
                  si32(L__2E_str7504,_loc2_ + 4);
                  si32(__ZZN14Fir_Resampler_5writeElE8__func__,_loc2_);
                  ESP = _loc2_;
                  F___assert();
                  _loc2_ += 16;
               }
      ...
      else
      {
         ...
         si32(_loc13_ = int(_loc3_ + 1856),_loc2_);
         ESP = _loc2_;
         F__ZN8Snes_Spc4playElPs();
         _loc2_ += 16;
         _loc7_ = eax;
