package sample.libgme
{
   ...
   public function F__ZN7Spc_Emu16set_sample_rate_El() : void
   {
      ...
      var _loc11_:int;
      var _loc7_:*;
      si32(_loc11_ = _loc7_ = Number((_loc7_ = lf64(_loc1_ + 184)) * 256),_loc1_ + 2160);
      _loc10_ = 0;
      if((_loc9_ = li32(_loc3_ + 4)) != 32000)
      {
         _loc2_ -= 16;
         var _loc8_:*;
         ...
         if(_loc6_ != 0)
         {
            ...
            _loc8_ = _loc4_ << 1;
            si32(_loc11_ = _loc5_ + _loc8_,_loc1_ + 272);
            _loc2_ -= 16;
         ...
         sf64(_loc7_ = Number(32000 / _loc7_),_loc2_ + 4);
         ESP = _loc2_;
