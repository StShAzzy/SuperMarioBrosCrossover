package sample.libgme
{
   ...
   public function F__ZN7Spc_Emu5skip_El() : void
   {
      ...
      _loc8_ = _loc3_;
      _loc3_ -= 128;
      _loc22_ = li32((_loc4_ = li32(_loc8_)) + 192);
      _loc21_ = li32(_loc8_ + 4);
      if(_loc22_ != 32000)
      {
         _loc20_ = li32(_loc4_ + 264);
         _loc19_ = (_loc22_ = int((_loc22_ = li32(_loc4_ + 272)) - _loc20_)) >> 1;
         _loc17_ = int(_loc19_ - ((_loc22_ = li32(_loc4_ + 284)) << 1));
         var _loc15_:Number;
         _loc16_ = (_loc22_ = int(_loc15_ = (_loc15_ = _loc21_) * lf64(_loc4_ + 304))) & -2;
         if(_loc17_ >= _loc16_)
         {
            _loc17_ = _loc16_;
         }
         _loc14_ = _loc19_ - _loc17_;
         if((uint(_loc13_ = li32(_loc4_ + 268))) < uint(_loc14_))
         {
            _loc3_ -= 16;
            si32(L__2E_str1135,_loc3_ + 12);
            si32(51,_loc3_ + 8);
            si32(L__2E_str134,_loc3_ + 4);
            si32(__ZZNK13blargg_vectorIsEixEjE8__func__,_loc3_);
            ESP = _loc3_;
            F___assert();
            _loc3_ += 16;
         }
         _loc1_ = _loc14_ << 1;
         si32(_loc22_ = int(_loc20_ + _loc1_),_loc4_ + 272);
         ...
         si32(_loc20_,_loc3_);
         _loc22_ = _loc17_ << 1;
         si32(_loc22_ = int(_loc20_ + _loc22_),_loc3_ + 4);
      ...
      if(_loc21_ >= 1)
      {
         ...
         if(_loc21_ >= 128001)
         {
            ...
            si32(0,_loc4_ + 2452);
            _loc3_ -= 16;
            si32(_loc22_ = int(_loc4_ + 2456),_loc3_ + 8);
            si32(_loc22_ = int(_loc21_ + -64000),_loc3_ + 4);
            si32(_loc9_,_loc3_);
            ESP = _loc3_;
            ...
            if((_loc10_ = eax) == 0)
            {
               var _loc11_:*;
               var _loc12_:*;
               si8(_loc11_ = (_loc12_ = (_loc22_ = li32(_loc4_ + 2448)) ^ -1) & li32(_loc4_ + 2452),_loc4_ + 2036);
               si8(_loc22_,_loc4_ + 2020);
               _loc21_ = 64000;
               if(((_loc22_ = li8(_loc4_ + 2052)) & 32) == 0)
               {
                  _loc3_ -= 16;
                  si32(255,_loc3_ + 4);
                  ...
                  si32(_loc22_ = int((_loc22_ = int(_loc4_ + _loc5_)) + 2804),_loc3_);
                  ESP = _loc3_;
                  Fmemset();
                  _loc3_ += 16;
                  _loc21_ = 64000;
                  ...
                  {
                     addr483:
                     var _loc7_:* = li32((_loc22_ = li32(_loc4_)) + 60);
                     _loc3_ -= 16;
                     si32(_loc22_ = int(_loc8_ - 128),_loc3_ + 8);
                     si32(64,_loc3_ + 4);
                     si32(_loc4_,_loc3_);
                     ESP = _loc3_;
                     ptr2fun[_loc7_]();
