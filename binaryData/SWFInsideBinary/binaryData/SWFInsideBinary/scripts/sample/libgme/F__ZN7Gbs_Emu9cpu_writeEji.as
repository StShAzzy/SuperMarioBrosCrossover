package sample.libgme
{
   ...
   public function F__ZN7Gbs_Emu9cpu_writeEji() : void
   {
      ...
      _loc12_ = int(_loc1_ + -40960);
      _loc11_ = li32(_loc3_ + 8);
      _loc10_ = li32(_loc3_);
      if(uint(_loc12_) <= 24575)
      {
         _loc12_ = int(_loc10_ + _loc12_);
         si8(_loc11_,_loc12_ + 484);
         var _loc8_:*;
         if((uint(_loc8_ = _loc1_ ^ 57344)) <= 8063)
         {
            if((uint(_loc8_ = int(_loc1_ + -65296))) <= 47)
            {
               _loc2_ -= 16;
               si32(_loc11_,_loc2_ + 12);
               si32(_loc1_,_loc2_ + 8);
               var _loc7_:*;
               si32(_loc8_ = int(li32(_loc10_ + 360) - (li32((_loc7_ = li32(_loc10_ + 292)) + 36) << 2)),_loc2_ + 4);
               si32(_loc8_ = int(_loc10_ + 25072),_loc2_);
               ESP = _loc2_;
               F__ZN6Gb_Apu14write_registerEiji();
               _loc2_ += 16;
            }
            else if((uint(_loc8_ = _loc1_ ^ 65286)) <= 1)
            {
               _loc1_ = li8(_loc10_ + 387);
               if((_loc8_ = _loc1_ & 4) != 0)
               {
                  si32(_loc8_ = (_loc7_ = int(256 - li8(_loc10_ + 24810))) << int(li8(_loc8_ = int(__ZZN7Gbs_Emu12update_timerEvE5rates + ((_loc8_ = li8(_loc10_ + 24811)) & 3))) - (int(_loc1_ >>> 7))),_loc10_ + 364);
               ...
               if((_loc5_ = lf64(_loc10_ + 176)) != 1)
               {
                  var _loc9_:Number;
                  si32(_loc8_ = int(_loc9_ = _loc6_ / _loc5_),_loc10_ + 364);
               }
            }
            else
            {
               _loc10_ = int(_loc12_ + 484);
               if(_loc1_ == 65280)
               {
                  si8(0,_loc10_);
               }
      ...
      else if((uint(_loc8_ = _loc1_ ^ 8192)) <= 8191)
      {
         _loc1_ = (_loc7_ = li32(_loc10_ + 352)) & _loc11_ << 14;
         if(_loc1_ == 0)
         {
            if((_loc8_ = li32(_loc10_ + 356)) <= 16384)
            {
            }
            §§goto(addr391);
         }
         _loc8_ = li32(_loc10_ + 348);
         _loc11_ = int(_loc1_ - _loc8_);
         _loc1_ = li32(_loc10_ + 340);
         _loc8_ = int(_loc1_ + -16392);
         _loc12_ = 0;
         ...
         {
            _loc2_ -= 16;
            si32(L__2E_str3170,_loc2_ + 12);
            si32(51,_loc2_ + 8);
            si32(L__2E_str2169,_loc2_ + 4);
            si32(__ZZNK13blargg_vectorIhEixEjE8__func__168,_loc2_);
            ESP = _loc2_;
            F___assert();
            _loc2_ += 16;
         }
         _loc7_ = int((_loc8_ = int((_loc8_ = li32(_loc10_ + 336)) + _loc12_)) + 8192);
