package sample.libgme
{
   ...
   public function F__ZNK8Gme_File12remap_track_EPi() : void
   {
      ...
      _loc9_ = li32(_loc1_);
      _loc7_ = li32((_loc8_ = li32(_loc3_)) + 8);
      _loc6_ = L__2E_str2189;
      if(uint(_loc9_) < uint(_loc7_))
      {
         ...
         if(uint(_loc9_) < uint(_loc5_))
         {
            ...
            si32(_loc5_ = 0,_loc1_);
            var _loc4_:int = _loc9_ * 40;
            if((_loc9_ = li32((_loc6_ = _loc7_ + _loc4_) + 16)) >= 0)
            {
               si32(_loc9_,_loc1_);
               _loc5_ = _loc9_;
               if(((_loc7_ = li8((_loc7_ = li32(_loc8_ + 4)) + 20)) & 2) == 0)
               {
                  si32(_loc5_ = int(_loc9_ - li8(_loc6_ + 12)),_loc1_);
               }
            }
            _loc7_ = li32(_loc8_ + 12);
            _loc6_ = L__2E_str3190;
            if(_loc5_ < _loc7_)
            {
            }
            §§goto(addr177);
