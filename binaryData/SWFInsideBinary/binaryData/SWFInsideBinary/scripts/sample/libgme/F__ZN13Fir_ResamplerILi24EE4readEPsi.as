package sample.libgme
{
   ...
   public function F__ZN13Fir_ResamplerILi24EE4readEPsi() : void
   {
      ...
      var _loc14_:* = 0;
      var _loc4_:*;
      _loc21_ = li32((_loc5_ = li32(_loc9_ = _loc4_ = int(ESP))) + 16);
      _loc19_ = int((_loc20_ = li32(_loc5_ + 12)) - _loc21_);
      _loc18_ = li32(_loc5_);
      _loc16_ = int((_loc17_ = li32(_loc5_ + 8)) - _loc18_);
      _loc14_ = _loc15_ = li32(_loc9_ + 4);
      if(_loc16_ >= 96)
      {
         _loc20_ = li32(_loc5_ + 32);
         _loc10_ = int(li32(_loc5_ + 28) >>> _loc21_);
         _loc11_ = int((_loc21_ = int(_loc5_ + 52)) + int(_loc21_ * 48));
         _loc17_ += -96;
         _loc12_ = (_loc16_ = li32(_loc9_ + 8) >> 1) + -1;
         _loc14_ = _loc15_;
         do
         {
            _loc13_ = 0;
            ...
            do
            {
               var _loc1_:* = _loc3_ << 1;
               var _loc7_:*;
               _loc16_ = si16(li16(_loc7_ = int(_loc11_ - _loc1_)));
               _loc1_ <<= 1;
               _loc1_ = int(_loc18_ - _loc1_);
               var _loc8_:* = int((_loc8_ = si16(li16(_loc1_ + 2))) * _loc16_);
               _loc7_ = si16(li16(_loc7_ - 2));
               var _loc2_:* = si16(li16(_loc1_ - 2));
               _loc2_ *= _loc7_;
               _loc2_ += _loc13_;
               _loc13_ = _loc2_ + _loc8_;
               _loc16_ = int((_loc8_ = si16(li16(_loc1_))) * _loc16_);
               _loc1_ = si16(li16(_loc1_ - 4));
               _loc1_ *= _loc7_;
               _loc1_ += _loc6_;
               _loc6_ = int(_loc1_ + _loc16_);
               _loc3_ += -2;
            }
            while(_loc3_ != -25);
            ...
            _loc16_ = (_loc16_ = int((_loc16_ = (_loc16_ = _loc10_ << 1) & 2) + _loc20_)) << 1;
            _loc18_ += _loc16_;
            _loc1_ = int(_loc13_ >>> 15);
            si16(_loc16_ = int(_loc6_ >>> 15),_loc14_);
      ...
      si32(_loc16_ = int(_loc20_ - _loc19_),_loc5_ + 16);
      _loc20_ = (_loc19_ = int(_loc17_ - _loc18_)) >> 1;
      if((uint(_loc16_ = li32(_loc5_ + 4))) < uint(_loc20_))
      {
         _loc4_ -= 16;
         si32(L__2E_str6503,_loc4_ + 12);
         si32(51,_loc4_ + 8);
         si32(L__2E_str5502,_loc4_ + 4);
         si32(__ZZNK13blargg_vectorIsEixEjE8__func__501,_loc4_);
         ESP = _loc4_;
         F___assert();
         _loc4_ += 16;
      }
      _loc1_ = _loc20_ << 1;
      _loc1_ = int((_loc16_ = li32(_loc5_)) + _loc1_);
      si32(_loc1_,_loc5_ + 8);
      _loc4_ -= 16;
      si32(_loc19_,_loc4_ + 8);
      si32(_loc18_,_loc4_ + 4);
      si32(_loc16_,_loc4_);
      _loc16_ = (_loc16_ = int(_loc14_ - _loc15_)) >> 1;
      ESP = _loc4_;
      Fmemmove();
      _loc4_ += 16;
      eax = _loc16_;
