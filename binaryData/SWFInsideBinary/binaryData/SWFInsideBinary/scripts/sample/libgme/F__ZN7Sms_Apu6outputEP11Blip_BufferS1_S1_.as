package sample.libgme
{
   ...
   public function F__ZN7Sms_Apu6outputEP11Blip_BufferS1_S1_() : void
   {
      ...
      if((_loc7_ = li32(_loc3_ + 12)) != 0)
      {
         _loc1_ = 0;
      }
      var _loc6_:*;
      if((_loc6_ = (_loc6_ = _loc9_ | _loc11_) | _loc7_) != 0)
      {
         if((_loc6_ = (_loc6_ = (_loc6_ = (_loc6_ = _loc8_ | _loc10_) | _loc1_) ^ 1) & 1) == 0)
         {
            _loc2_ -= 16;
      ...
      var _loc5_:* = li32(_loc6_ = li32(_loc3_));
      si32(_loc7_,_loc5_ + 4);
      si32(_loc11_,_loc5_ + 8);
      si32(_loc9_,_loc5_ + 12);
      var _loc4_:* = (_loc4_ = li32(_loc5_ + 20)) << 2;
      ...
      _loc5_ = (_loc5_ = li32(_loc6_ + 20)) << 2;
      si32(_loc5_ = li32(_loc5_ = int(_loc6_ + _loc5_)),_loc6_ + 16);
      _loc2_ = _loc3_;
      ESP = _loc2_;
   }
}
