package sample.libgme
{
   ...
   public function F__ZN11Blip_Buffer14remove_samplesEl() : void
   {
      ...
      {
         var _loc7_:*;
         if((_loc7_ = int((_loc8_ = li32((_loc9_ = li32(_loc3_)) + 4)) >>> 16)) < _loc1_)
         {
            _loc2_ -= 16;
         ...
         _loc7_ = _loc1_ << 16;
         var _loc6_:*;
         si32(_loc6_ = int(_loc8_ - _loc7_),_loc9_ + 4);
         _loc7_ = _loc1_ << 2;
         var _loc5_:*;
         var _loc4_:int = (_loc5_ = li32(_loc9_ + 8)) + _loc7_;
         _loc2_ -= 16;
         si32(_loc4_,_loc2_ + 4);
         si32(_loc5_,_loc2_);
         si32(_loc6_ = int((_loc6_ = int((_loc6_ &= -65536) >>> 14)) + 72),_loc2_ + 8);
         ESP = _loc2_;
         Fmemmove();
         _loc2_ += 16;
         ...
         si32(0,_loc2_ + 4);
         si32(_loc7_ = int(_loc5_ + _loc6_),_loc2_);
         ESP = _loc2_;
         Fmemset();
         _loc2_ += 16;
      }
