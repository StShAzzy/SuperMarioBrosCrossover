package sample.libgme
{
   ...
   import sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str20229;
   import sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str21230;
   ...
   public function F__ZN7Kss_Emu12start_track_Ei() : void
   {
      ...
      _loc2_ = _loc1_;
      var _loc29_:*;
      _loc28_ = li32((_loc29_ = li32(_loc30_ = li32((_loc14_ = li32(_loc2_)) + 252))) + 28);
      _loc1_ -= 16;
      si32(_loc30_,_loc1_);
      ESP = _loc1_;
      ptr2fun[_loc28_]();
      ...
      si32(16384,_loc1_ + 8);
      si32(201,_loc1_ + 4);
      si32(_loc27_ = _loc14_ + 988,_loc1_);
      ESP = _loc1_;
      Fmemset();
      _loc1_ += 16;
      _loc1_ -= 16;
      si32(49408,_loc1_ + 8);
      si32(_loc26_ = 0,_loc1_ + 4);
      si32(_loc25_ = _loc14_ + 17372,_loc1_);
      ESP = _loc1_;
      Fmemset();
      _loc1_ += 16;
      si8(-55,_loc14_ + 1001);
      ...
      _loc24_ = (_loc29_ = (_loc29_ = li8(_loc14_ + 935)) << 8) | _loc30_;
      ...
      _loc19_ = (_loc29_ = (_loc29_ = li8(_loc14_ + 933)) << 8) | _loc30_;
      ...
      if(_loc11_ != _loc24_)
      {
         si32(L__2E_str20229,_loc14_ + 16);
      }
      _loc30_ = li32(_loc14_ + 904);
      _loc30_ = int((_loc30_ = int((_loc29_ = li8(_loc14_ + 942)) + _loc30_)) + 8200);
      _loc1_ -= 16;
      si32(_loc30_,_loc1_ + 4);
      si32(_loc30_ = int((_loc30_ = int(_loc14_ + _loc19_)) + 988),_loc1_);
      si32(_loc11_,_loc1_ + 8);
      ESP = _loc1_;
      Fmemcpy();
      _loc1_ += 16;
      _loc30_ = int((_loc30_ = li8(_loc14_ + 942)) + _loc11_);
      si32(_loc21_ = -8200 - _loc30_,_loc14_ + 916);
      _loc29_ = int(8191 - _loc30_);
      _loc30_ = li32(_loc14_ + 912);
      _loc29_ = int((_loc29_ = (_loc30_ = int(_loc29_ + _loc30_)) >> 31) >>> 19);
      if((_loc22_ = (_loc30_ += _loc29_) & -8192) >= 1)
      {
         ...
         if(_loc15_ != 0)
         {
            ...
            while((_loc30_ = int(_loc15_ >>> _loc16_)) != 0);
            
         }
         si32(_loc30_ = int((_loc30_ = 1 << _loc16_) + -1),_loc14_ + 920);
         _loc26_ = _loc22_;
      }
      _loc17_ = li32(_loc2_ + 4);
      si32(_loc26_,_loc14_ + 924);
      _loc18_ = (_loc30_ = int(_loc26_ - _loc21_)) + 8;
      _loc30_ = li32(_loc14_ + 904);
      _loc1_ -= 16;
      ...
      if((_loc13_ = eax) == 0)
      {
         ...
         var _loc7_:*;
         si32(_loc30_ = (_loc7_ = li8(_loc14_ + 941)) & 127,_loc14_ + 972);
         _loc29_ = _loc11_ ^ -1;
         _loc29_ = int(_loc12_ + _loc29_);
         _loc7_ >>>= 7;
         _loc7_ = int(16384 >>> _loc7_);
         _loc5_ = (_loc29_ += _loc7_) / _loc7_;
         if(_loc30_ > _loc5_)
         {
            si32(_loc5_,_loc14_ + 972);
            si32(L__2E_str21230,_loc14_ + 16);
         }
         si8(-1,_loc14_ + 66523);
         si32(_loc30_ = int(_loc14_ + 792),_loc14_ + 788);
         si32(0,_loc14_ + 868);
         si32(0,_loc14_ + 864);
         si32(0,_loc14_ + 784);
         si32(_loc30_ = int(_loc14_ + 69132),_loc14_ + 828);
         si32(_loc29_ = int(_loc14_ + 68876),_loc14_ + 792);
         ...
         si32(0,_loc14_ + 876);
         si32(0,_loc14_ + 872);
         si32(_loc30_ = int(_loc14_ + 58332),_loc14_ + 856);
         si32(_loc30_,_loc14_ + 820);
         si32(_loc30_ = int(_loc14_ + 50140),_loc14_ + 852);
         si32(_loc30_,_loc14_ + 816);
         si32(_loc30_ = int(_loc14_ + 41948),_loc14_ + 848);
         si32(_loc30_,_loc14_ + 812);
         si32(_loc30_ = int(_loc14_ + 33756),_loc14_ + 844);
         si32(_loc30_,_loc14_ + 808);
         si32(_loc30_ = int(_loc14_ + 25564),_loc14_ + 840);
         si32(_loc30_,_loc14_ + 804);
         si32(_loc25_,_loc14_ + 836);
         si32(_loc25_,_loc14_ + 800);
         si32(_loc30_ = int(_loc14_ + 9180),_loc14_ + 832);
         ...
         si8(-1,_loc14_ + 66844);
         si32(_loc30_ = int(_loc14_ + 66972),_loc14_ + 66868);
         ...
         si32(148,_loc1_ + 8);
         si32(0,_loc1_ + 4);
         si32(_loc30_ = int(_loc14_ + 68160),_loc1_);
         ESP = _loc1_;
         Fmemset();
         _loc1_ += 16;
         if((_loc6_ = li32(_loc14_ + 68872)) != 0)
         {
            si32(0,_loc6_ + 976);
            si32(0,_loc6_ + 980);
            ...
            si32(0,_loc6_ + 48);
            si32(3,_loc6_ + 36);
            si32(_loc30_ = li32(_loc6_ + 28),_loc6_ + 32);
            si32(0,_loc6_ + 100);
            si32(0,_loc6_ + 104);
            si32(0,_loc6_ + 88);
            si32(0,_loc6_ + 92);
            si32(0,_loc6_ + 96);
            si32(3,_loc6_ + 84);
            si32(_loc30_ = li32(_loc6_ + 76),_loc6_ + 80);
            si32(0,_loc6_ + 148);
            si32(0,_loc6_ + 152);
            si32(0,_loc6_ + 136);
            si32(0,_loc6_ + 140);
            si32(0,_loc6_ + 144);
            si32(3,_loc6_ + 132);
            si32(_loc30_ = li32(_loc6_ + 124),_loc6_ + 128);
            si32(__ZL13noise_periods,_loc6_ + 1020);
            ...
            si32(0,_loc6_ + 1016);
            si32(3,_loc6_ + 1004);
            si32(_loc30_ = li32(_loc6_ + 996),_loc6_ + 1000);
         }
         ...
         si16(_loc30_ = (_loc29_ = (_loc29_ = li8(_loc14_ + 937)) << 8) | _loc30_,_loc14_ + 872);
         si32(_loc30_ = li32(_loc14_ + 976),_loc14_ + 980);
         si8(0,_loc14_ + 960);
         si8(0,_loc14_ + 961);
         var _loc9_:* = lf64(_loc14_ + 184);
         _loc1_ -= 16;
         si32(_loc29_ = int(_loc14_ + 67264),_loc1_);
         sf64(_loc9_ = Number((_loc8_ = _loc9_ * 1.4) * 0.000915032679738562),_loc1_ + 4);
         ESP = _loc1_;
         F__ZN11Blip_Synth_11volume_unitEd();
         _loc1_ += 16;
         _loc1_ -= 16;
         sf64(_loc9_ = Number(_loc8_ * 0.00000262451171875),_loc1_ + 4);
         si32(_loc30_ = int(_loc14_ + 68312),_loc1_);
         ESP = _loc1_;
         F__ZN11Blip_Synth_11volume_unitEd();
         _loc1_ += 16;
         if((_loc4_ = li32(_loc3_)) != 0)
         {
            _loc1_ -= 16;
            var _loc10_:Number;
            sf64(_loc10_ = _loc8_ * 0.00166015625,_loc1_ + 4);
            si32(_loc30_ = int(_loc4_ + 160),_loc1_);
            ESP = _loc1_;
            F__ZN11Blip_Synth_11volume_unitEd();
            _loc1_ += 16;
            _loc1_ -= 16;
            sf64(_loc10_,_loc1_ + 4);
            si32(_loc30_ = int(_loc4_ + 1032),_loc1_);
            ESP = _loc1_;
            F__ZN11Blip_Synth_11volume_unitEd();
            _loc1_ += 16;
         }
