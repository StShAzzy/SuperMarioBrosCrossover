package sample.libgme
{
   ...
   import sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L_LSDA_413;
   
   public function F__ZN9Music_EmuD2Ev() : void
   {
      var _loc5_:* = 0;
      var _loc10_:int = 0;
      var _loc17_:* = 0;
      ...
      while(true)
      {
         try
         {
            if(!_loc10_)
            {
               ...
               _loc4_ = int(__ZTV9Music_Emu + 8);
               _loc18_ = li32(_loc5_ - 60);
               si32(_loc4_,_loc18_);
               _loc17_ = li32((_loc4_ = li32(_loc5_ - 60)) + 248);
               si32(L_LSDA_413,_loc5_ - 28);
            ...
            if((_loc4_ = int(eax)) == 0)
            {
               ...
               if(_loc17_ != 0)
               {
                  _loc14_ = li32((_loc4_ = li32(_loc17_)) + 4);
                  _loc4_ = _loc16_ | 4;
                  si32(1,_loc4_);
                  _loc3_ -= 16;
                  si32(_loc17_,_loc3_);
               ...
               if((_loc13_ = li32((_loc4_ = li32(_loc5_ - 60)) + 240)) != 0)
               {
                  _loc3_ -= 16;
                  si32(_loc13_,_loc3_);
                  ESP = _loc3_;
            ...
            while(true)
            {
               ...
               if((_loc6_ = li32((_loc4_ = li32(_loc5_ - 60)) + 240)) != 0)
               {
                  _loc3_ -= 16;
                  si32(_loc6_,_loc3_);
                  ESP = _loc3_;
