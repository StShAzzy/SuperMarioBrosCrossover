package sample.libgme
{
   ...
   public function F__ZN8Snes_Spc5Timer10run_until_Ei() : void
   {
      var _loc3_:* = 0;
      var _loc1_:* = 0;
      var _loc4_:* = 0;
      ...
      _loc8_ = li32(_loc1_);
      _loc7_ -= _loc8_;
      var _loc6_:* = li32(_loc1_ + 12);
      si32(_loc8_ = int((_loc6_ = int((_loc7_ = int((_loc7_ /= _loc6_) + 1)) * _loc6_)) + _loc8_),_loc1_);
      _loc5_ = (_loc8_ = li32(_loc1_ + 8)) + _loc7_;
      if((_loc4_ = li32(_loc1_ + 4)) <= _loc5_)
      {
         _loc8_ = int(_loc5_ / _loc4_);
         si32(_loc7_ = (_loc7_ = int((_loc7_ = li32(_loc1_ + 20)) + _loc8_)) & 15,_loc1_ + 20);
         _loc5_ -= int(_loc8_ * _loc4_);
      }
