package sample.libgme
{
   ...
   public function F__ZN13Stereo_Buffer9bass_freqEi() : void
   {
      ...
      {
         _loc6_ = int((_loc7_ = _loc1_ << 16) / li32(_loc9_ + 44));
         _loc5_ = 13;
         do
         {
            _loc6_ >>= 1;
         ...
         if(_loc1_ >= 1)
         {
            _loc5_ = int(_loc7_ / li32(_loc9_ + 88));
            _loc4_ = 13;
            do
            {
               _loc5_ >>= 1;
            ...
            _loc5_ = int(_loc9_ + 108);
            _loc6_ = 31;
            if(_loc1_ >= 1)
            {
               _loc1_ = int(_loc7_ / li32(_loc9_ + 132));
               _loc9_ = 13;
               do
               {
                  _loc1_ >>= 1;
