package sample.libgme
{
   ...
   public function F__ZN11Blip_Buffer11mix_samplesEPKsl() : void
   {
      ...
      _loc1_ = li32(_loc3_);
      var _loc11_:*;
      if((_loc11_ = li32(_loc1_ + 12)) == 1)
      {
         _loc2_ -= 16;
         si32(L__2E_str1105,_loc2_ + 12);
         si32(429,_loc2_ + 8);
         si32(L__2E_str104,_loc2_ + 4);
         si32(__ZZN11Blip_Buffer11mix_samplesEPKslE8__func__,_loc2_);
         ESP = _loc2_;
         F___assert();
         _loc2_ += 16;
      }
      ...
      _loc7_ = (_loc8_ = li32(_loc1_ + 4)) >>> 16;
      _loc6_ = 0;
      if(_loc10_ != 0)
      {
         _loc1_ = li32(_loc3_ + 4);
         _loc5_ = (_loc11_ = int((_loc11_ = int((_loc11_ = _loc8_ & -65536) >>> 14)) + _loc9_)) + 32;
         _loc6_ = 0;
         _loc8_ = _loc10_;
         do
         {
            _loc11_ = int((_loc11_ = li32(_loc5_)) - _loc6_);
            var _loc4_:*;
            _loc6_ = (_loc4_ = si16(li16(_loc1_))) << 14;
      ...
      si32(_loc4_ = int((_loc4_ = li32((_loc11_ = int((_loc11_ = _loc7_ << 2) + _loc9_)) + 32)) - _loc6_),_loc11_ + 32);
      _loc2_ = _loc3_;
      ESP = _loc2_;
   }
}
