package sample.libgme
{
   ...
   public function F__ZN13Stereo_Buffer20mix_stereo_no_centerEPsi() : void
   {
      ...
      if((_loc13_ = li32(_loc4_ + 8)) != 0)
      {
         _loc12_ = li32(_loc3_ + 84);
         var _loc11_:*;
         _loc10_ = (_loc11_ = li32(_loc4_ + 4)) + 2;
         _loc9_ = li32(_loc3_ + 72);
         _loc8_ = li32(_loc3_ + 116);
         do
         {
            _loc1_ = _loc14_ >> 14;
            if((_loc11_ = (_loc11_ = _loc14_ << 2) >> 16) != _loc1_)
            {
               _loc1_ = int(32767 - (_loc14_ >> 31));
            }
            _loc5_ = _loc15_ >> 14;
            if((_loc11_ = (_loc11_ = _loc15_ << 2) >> 16) != _loc5_)
            {
               _loc5_ = int(32767 - (_loc15_ >> 31));
            }
            _loc11_ = li32(_loc9_);
            ...
            _loc7_ = int(_loc15_ - _loc7_);
            _loc15_ = int(_loc6_ + _loc7_);
            _loc6_ = _loc14_ >> _loc12_;
            _loc6_ = int(_loc14_ - _loc6_);
            _loc14_ = int(_loc11_ + _loc6_);
            _loc8_ += 4;
            _loc9_ += 4;
            _loc10_ += 4;
         }
