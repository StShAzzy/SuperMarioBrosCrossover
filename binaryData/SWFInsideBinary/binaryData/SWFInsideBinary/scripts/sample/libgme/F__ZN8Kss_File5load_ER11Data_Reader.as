package sample.libgme
{
   ...
   public function F__ZN8Kss_File5load_ER11Data_Reader() : void
   {
      ...
      var _loc10_:*;
      _loc9_ = li32((_loc10_ = li32(_loc1_)) + 12);
      _loc2_ -= 16;
      si32(16,_loc2_ + 8);
      si32(_loc10_ = int((_loc8_ = li32(_loc3_)) + 252),_loc2_ + 4);
      si32(_loc1_,_loc2_);
      ESP = _loc2_;
      ptr2fun[_loc9_]();
      _loc2_ += 16;
      if((_loc7_ = eax) == 0)
      {
         ...
         do
         {
            _loc1_ = int(L__2E_str11220 - _loc6_);
            _loc1_ = li8(_loc1_);
            if((_loc10_ = li8((_loc10_ = int(_loc8_ - _loc6_)) + 252)) == _loc1_)
            {
               continue;
            }
            _loc4_ = 0;
            while(true)
            {
               _loc1_ = int(L__2E_str12221 - _loc4_);
               _loc1_ = li8(_loc1_);
               _loc10_ = li8((_loc10_ = int(_loc8_ - _loc4_)) + 252);
