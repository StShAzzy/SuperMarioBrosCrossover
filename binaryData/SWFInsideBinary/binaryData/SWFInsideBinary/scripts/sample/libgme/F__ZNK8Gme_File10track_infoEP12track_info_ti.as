package sample.libgme
{
   ...
   public function F__ZNK8Gme_File10track_infoEP12track_info_ti() : void
   {
      ...
      var _loc18_:int = 0;
      var _loc3_:* = int(ESP);
      _loc20_ = li32((_loc4_ = li32(_loc8_ = _loc3_)) + 8);
      ...
      si8(0,_loc19_ + 1552);
      si8(0,_loc19_ + 16);
      _loc20_ = li32(_loc20_ = li32(_loc4_ + 4));
      _loc3_ -= 16;
      si32(255,_loc3_ + 8);
      si32(_loc20_,_loc3_ + 4);
      si32(_loc20_ = int(_loc19_ + 16),_loc3_);
      ESP = _loc3_;
      F__ZN8Gme_File11copy_field_EPcPKci();
      _loc3_ += 16;
      _loc20_ = li32(_loc4_ + 8);
      _loc18_ = L__2E_str2189;
      ...
      if(uint(_loc20_) > uint(_loc17_))
      {
         ...
         if(uint(_loc16_) > uint(_loc17_))
         {
            ...
            {
               _loc3_ -= 16;
               si32(L__2E_str1188,_loc3_ + 12);
               si32(51,_loc3_ + 8);
               si32(L__2E_str187,_loc3_ + 4);
               si32(__ZZNK13blargg_vectorIN12M3u_Playlist7entry_tEEixEjE8__func__,_loc3_);
               ESP = _loc3_;
               F___assert();
               _loc3_ += 16;
            }
            _loc20_ = int(_loc17_ * 40);
            var _loc14_:*;
            _loc1_ = li32((_loc13_ = (_loc14_ = li32(_loc4_ + 28)) + _loc20_) + 16);
            _loc15_ = 0;
            if(_loc1_ >= 0)
            {
               _loc15_ = _loc1_;
               if(((_loc20_ = li8((_loc20_ = li32(_loc4_ + 4)) + 20)) & 2) == 0)
               {
                  _loc15_ = int(_loc1_ - li8(_loc13_ + 12));
               }
            }
            _loc20_ = li32(_loc4_ + 12);
            _loc18_ = L__2E_str3190;
            if(_loc15_ < _loc20_)
            {
            }
            §§goto(addr642);
         }
         var _loc9_:* = li32((_loc20_ = li32(_loc4_)) + 20);
         _loc3_ -= 16;
         ...
         if((_loc18_ = eax) == 0)
         {
            ...
            if(li32(_loc4_ + 32) != 0)
            {
               ...
               si32(int(_loc19_ + 1552),_loc3_);
               ESP = _loc3_;
               F__ZN8Gme_File11copy_field_EPcPKci();
               _loc3_ += 16;
               if((uint(_loc20_ = li32(_loc4_ + 32))) < uint(_loc17_))
               {
                  _loc3_ -= 16;
                  si32(L__2E_str1188,_loc3_ + 12);
                  si32(51,_loc3_ + 8);
               ...
               _loc20_ = int(_loc19_ + 528);
               var _loc12_:int = _loc17_ * 40;
               _loc2_ = (_loc14_ = li32(_loc4_ + 28)) + _loc12_;
               ...
               F__ZN8Gme_File11copy_field_EPcPKci();
               _loc3_ += 16;
               if((_loc5_ = li32(_loc2_ + 20)) >= 0)
               {
                  si32(_loc20_ = int(_loc5_ * 1000),_loc19_ + 4);
               }
               if((_loc6_ = li32(_loc2_ + 24)) >= 0)
               {
                  si32(_loc20_ = int(_loc6_ * 1000),_loc19_ + 8);
               }
               _loc7_ = li32(_loc2_ + 28);
               _loc18_ = 0;
               if(_loc7_ >= 0)
               {
                  si32(_loc20_ = int(_loc7_ * 1000),_loc19_ + 12);
                  _loc18_ = 0;
               }
            }
         }
