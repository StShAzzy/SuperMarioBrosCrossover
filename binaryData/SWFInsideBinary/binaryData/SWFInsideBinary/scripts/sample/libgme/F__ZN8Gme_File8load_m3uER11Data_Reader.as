package sample.libgme
{
   ...
   public function F__ZN8Gme_File8load_m3uER11Data_Reader() : void
   {
      var _loc3_:* = 0;
      var _loc9_:* = 0;
      var _loc7_:* = 0;
      ...
      _loc1_ = int((_loc9_ = li32(_loc3_)) + 28);
      si32(_loc1_,_loc2_);
      ESP = _loc2_;
      ...
      if(_loc8_ == 0)
      {
         if((_loc7_ = li32(_loc9_ + 32)) != 0)
         {
            si32(_loc7_,_loc9_ + 8);
         }
         if((_loc6_ = li32(_loc9_ + 44)) != 0)
         {
            si8(0,_loc9_ + 131);
            _loc5_ = _loc9_ + 108;
            do
            {
               _loc1_ = _loc6_;
               var _loc4_:int;
               si8(_loc4_ = (_loc4_ = _loc1_ % 10) + 48,_loc5_ + 22);
               _loc5_ += -1;
               _loc6_ = int(_loc1_ / 10);
            }
            while(_loc1_ > 9);
