package sample.libgme
{
   ...
   public function F__ZN7Gbs_Emu10run_clocksERii() : void
   {
      ...
      while(true)
      {
         ...
         _loc2_ -= 16;
         si32(int(_loc8_ - _loc1_),_loc2_ + 4);
         si32(_loc10_,_loc2_);
         ESP = _loc2_;
         F__ZN6Gb_Cpu3runEi();
         _loc2_ += 16;
         var _loc5_:*;
         _loc1_ = int(li32(_loc11_ + 360) - ((_loc5_ = li32((_loc5_ = li32(_loc11_ + 292)) + 36)) << 2));
         si32(_loc1_,_loc11_ + 360);
         if(int(eax) != 0)
         {
            if((_loc8_ = li32(_loc11_ + 280)) == 61453)
            {
               _loc8_ = li32(_loc9_);
               if((_loc4_ = li32(_loc11_ + 368)) > _loc8_)
               {
                  si32(_loc8_,_loc11_ + 360);
                  _loc1_ = _loc8_;
                  break;
               ...
               var _loc7_:*;
               si32(_loc7_ = int((_loc7_ = li32(_loc11_ + 364)) + _loc4_),_loc11_ + 368);
               _loc7_ = li8(_loc11_ + 382);
               var _loc6_:*;
               si32(_loc7_ = (_loc6_ = (_loc6_ = li8(_loc11_ + 383)) << 8) | _loc7_,_loc11_ + 280);
               si16(_loc7_ = int((_loc7_ = li16(_loc11_ + 284)) + -1),_loc11_ + 284);
               _loc2_ -= 16;
               si32(240,_loc2_ + 8);
            ...
            {
               si32(_loc7_ = _loc8_ & 65535,_loc11_ + 280);
            }
            else
            {
               si32(L__2E_str8176,_loc11_ + 16);
               si32(_loc7_ = (_loc7_ = int(_loc8_ + 1)) & 65535,_loc11_ + 280);
               _loc1_ += 6;
               si32(_loc1_,_loc11_ + 360);
            }
         }
      ...
      _loc1_ = int((_loc7_ = li32(_loc11_ + 368)) - _loc10_);
      _loc9_ = 0;
      if(_loc1_ >= _loc9_)
      {
         _loc9_ = _loc1_;
      ...
      if((_loc7_ = li32(_loc11_ + 25092)) < _loc10_)
      {
         _loc2_ -= 16;
         si32(_loc10_,_loc2_ + 4);
         si32(_loc7_ = int(_loc11_ + 25072),_loc2_);
         ESP = _loc2_;
         F__ZN6Gb_Apu9run_untilEi();
         _loc2_ += 16;
      }
      if((_loc9_ = li32(_loc11_ + 25088)) < _loc10_)
      {
         _loc2_ -= 16;
         si32(L__2E_str7144,_loc2_ + 12);
         si32(193,_loc2_ + 8);
         si32(L__2E_str2139,_loc2_ + 4);
         si32(__ZZN6Gb_Apu9end_frameEiE8__func__,_loc2_);
         ESP = _loc2_;
         F___assert();
         _loc2_ += 16;
      }
      si32(_loc7_ = int(_loc9_ - _loc10_),_loc11_ + 25088);
      if((_loc9_ = li32(_loc11_ + 25092)) < _loc10_)
      {
         _loc2_ -= 16;
         si32(L__2E_str8145,_loc2_ + 12);
         si32(196,_loc2_ + 8);
         si32(L__2E_str2139,_loc2_ + 4);
         si32(__ZZN6Gb_Apu9end_frameEiE8__func__,_loc2_);
         ESP = _loc2_;
      ...
      si32(_loc7_ = int(_loc9_ - _loc10_),_loc11_ + 25092);
      eax = 0;
      _loc2_ = _loc3_;
      ESP = _loc2_;
   }
