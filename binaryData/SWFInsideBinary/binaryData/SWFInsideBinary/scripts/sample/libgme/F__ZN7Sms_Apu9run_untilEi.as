package sample.libgme
{
   ...
   public function F__ZN7Sms_Apu9run_untilEi() : void
   {
      ...
      {
         _loc2_ -= 16;
         si32(L__2E_str5460,_loc2_ + 12);
         si32(236,_loc2_ + 8);
         si32(L__2E_str2456,_loc2_ + 4);
         si32(__ZZN7Sms_Apu9run_untilEiE8__func__,_loc2_);
         ESP = _loc2_;
         F___assert();
         _loc2_ += 16;
      }
      ...
      {
         var _loc5_:*;
         if((_loc7_ = li32((_loc5_ = li32(_loc1_)) + 16)) != 0)
         {
            si32(1,_loc7_ + 40);
            _loc2_ -= 16;
            si32(_loc6_,_loc2_ + 8);
            si32(li32(_loc1_ + 976),_loc2_ + 4);
            si32(_loc5_ = int(_loc1_ + 16),_loc2_);
            ESP = _loc2_;
            F__ZN10Sms_Square3runEii();
            _loc2_ += 16;
         }
         if((_loc7_ = li32((_loc5_ = li32(_loc1_ + 4)) + 16)) != 0)
         {
            si32(1,_loc7_ + 40);
            _loc2_ -= 16;
            si32(_loc6_,_loc2_ + 8);
            si32(li32(_loc1_ + 976),_loc2_ + 4);
            si32(_loc5_ = int(_loc1_ + 64),_loc2_);
            ESP = _loc2_;
            F__ZN10Sms_Square3runEii();
            _loc2_ += 16;
         }
         if((_loc7_ = li32((_loc5_ = li32(_loc1_ + 8)) + 16)) != 0)
         {
            si32(1,_loc7_ + 40);
            _loc2_ -= 16;
            si32(_loc6_,_loc2_ + 8);
            si32(li32(_loc1_ + 976),_loc2_ + 4);
            si32(_loc5_ = int(_loc1_ + 112),_loc2_);
            ESP = _loc2_;
            F__ZN10Sms_Square3runEii();
            _loc2_ += 16;
         }
         if((_loc7_ = li32((_loc5_ = li32(_loc1_ + 12)) + 16)) != 0)
         {
            si32(1,_loc7_ + 40);
            _loc2_ -= 16;
            si32(_loc6_,_loc2_ + 8);
            si32(li32(_loc1_ + 976),_loc2_ + 4);
            si32(int(_loc1_ + 984),_loc2_);
            ESP = _loc2_;
