package sample.libgme
{
   ...
   public function F__ZN7Nes_Apu9run_untilEi() : void
   {
      ...
      {
         _loc2_ -= 16;
         si32(L__2E_str5308,_loc2_ + 12);
         si32(139,_loc2_ + 8);
         si32(L__2E_str4307,_loc2_ + 4);
         si32(__ZZN7Nes_Apu9run_untilEiE8__func__,_loc2_);
         ESP = _loc2_;
         F___assert();
         _loc2_ += 16;
      }
      ...
      if(_loc7_ != 0)
      {
         var _loc5_:*;
         var _loc4_:*;
         _loc6_ = (_loc5_ = int(li32(_loc1_ + 1320) + li32((_loc4_ = li32(_loc1_ + 1372)) + 1948))) + int((_loc5_ = int((_loc5_ = li32(_loc1_ + 1340)) + -1)) * li32(_loc1_ + 1332));
      }
      if(_loc6_ < _loc8_)
      {
         ...
         si32(_loc7_ = int(_loc1_ + 1304),_loc2_);
         ESP = _loc2_;
