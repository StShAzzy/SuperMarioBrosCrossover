package sample.libgme
{
   ...
   public function F__ZN7Nes_Apu9end_frameEi() : void
   {
      ...
      var _loc18_:* = 0;
      var _loc5_:*;
      _loc22_ = li32((_loc6_ = li32(_loc10_ = _loc5_ = int(ESP))) + 1944);
      ...
      if((_loc22_ = li8(_loc6_ + 1363)) != 0)
      {
         ...
         if(_loc13_ != 0)
         {
            if(_loc12_ != 0)
            {
               ...
               si32(_loc22_ = int((_loc17_ = li32(_loc13_) * _loc18_) + li32(_loc13_ + 4)),_loc5_ + 4);
               si32(_loc22_ = int(_loc6_ + 744),_loc5_);
               ESP = _loc5_;
         ...
         if(_loc4_ != 0)
         {
            if(_loc14_ != 0)
            {
               ...
               si32(_loc22_ = int((_loc17_ = li32(_loc4_) * _loc18_) + li32(_loc4_ + 4)),_loc5_ + 4);
               si32(_loc22_ = int(_loc6_ + 152),_loc5_);
               ESP = _loc5_;
               F__ZNK10Blip_SynthILi8ELi1EE16offset_resampledEjiP11Blip_Buffer();
               _loc5_ += 16;
               _loc18_ = li32(_loc6_ + 1944);
         ...
         if(_loc8_ != 0)
         {
            if(_loc7_ != 0)
            {
               ...
               si32(_loc22_ = int((_loc17_ = li32(_loc8_) * _loc18_) + li32(_loc8_ + 4)),_loc5_ + 4);
               si32(_loc22_ = int(_loc6_ + 1376),_loc5_);
               ESP = _loc5_;
               F__ZNK10Blip_SynthILi8ELi1EE16offset_resampledEjiP11Blip_Buffer();
               _loc5_ += 16;
            }
      ...
      si32(_loc22_ = int((_loc22_ = li32(_loc6_ + 1944)) - _loc21_),_loc6_ + 1944);
      if(_loc22_ <= -1)
      {
         _loc5_ -= 16;
         si32(L__2E_str9312,_loc5_ + 12);
         si32(254,_loc5_ + 8);
         si32(L__2E_str4307,_loc5_ + 4);
         si32(__ZZN7Nes_Apu9end_frameEiE8__func__,_loc5_);
         ESP = _loc5_;
         F___assert();
         _loc5_ += 16;
      }
      si32(_loc22_ = int((_loc22_ = li32(_loc6_ + 1948)) - _loc21_),_loc6_ + 1948);
      if(_loc22_ <= -1)
      {
         _loc5_ -= 16;
         si32(L__2E_str10313,_loc5_ + 12);
         si32(257,_loc5_ + 8);
         si32(L__2E_str4307,_loc5_ + 4);
         si32(__ZZN7Nes_Apu9end_frameEiE8__func__,_loc5_);
         ESP = _loc5_;
      ...
      if((_loc9_ = li32(_loc6_ + 1956)) != 1073741824)
      {
         si32(_loc22_ = int(_loc9_ - _loc21_),_loc6_ + 1956);
      }
      _loc3_ = li32(_loc6_ + 1356);
      if(_loc3_ != 1073741824)
      {
         si32(_loc22_ = int(_loc3_ - _loc21_),_loc6_ + 1356);
      }
      _loc2_ = li32(_loc6_ + 1952);
      if(_loc2_ != 1073741824)
      {
         si32(_loc22_ = int(_loc2_ - _loc21_),_loc6_ + 1952);
         if(_loc22_ <= -1)
         {
            si32(0,_loc6_ + 1952);
         }
