package sample.libgme
{
   ...
   public function F__ZN7Sms_Apu5resetEji() : void
   {
      ...
      si32(_loc6_ = 1 << _loc6_,_loc1_ + 1596);
      si32(0,_loc1_ + 1592);
      if(_loc9_ != 0)
      {
         _loc10_ = 9;
         ...
         do
         {
            _loc6_ = _loc5_ << 1;
            var _loc4_:*;
            _loc5_ = (_loc4_ = _loc10_ & 1) | _loc6_;
            _loc9_ += -1;
            _loc10_ >>>= 1;
         }
         while(_loc9_ != 0);
      ...
      si32(0,_loc1_ + 48);
      si32(3,_loc1_ + 36);
      si32(_loc6_ = li32(_loc1_ + 28),_loc1_ + 32);
      si32(0,_loc1_ + 100);
      si32(0,_loc1_ + 104);
      si32(0,_loc1_ + 88);
      si32(0,_loc1_ + 92);
      si32(0,_loc1_ + 96);
      si32(3,_loc1_ + 84);
      si32(_loc6_ = li32(_loc1_ + 76),_loc1_ + 80);
      si32(0,_loc1_ + 148);
      si32(0,_loc1_ + 152);
      si32(0,_loc1_ + 136);
      si32(0,_loc1_ + 140);
      si32(0,_loc1_ + 144);
      si32(3,_loc1_ + 132);
      si32(_loc6_ = li32(_loc1_ + 124),_loc1_ + 128);
      ...
      si32(0,_loc1_ + 1016);
      si32(3,_loc1_ + 1004);
      si32(_loc6_ = li32(_loc1_ + 996),_loc1_ + 1000);
      _loc2_ = _loc3_;
      ESP = _loc2_;
   }
}
