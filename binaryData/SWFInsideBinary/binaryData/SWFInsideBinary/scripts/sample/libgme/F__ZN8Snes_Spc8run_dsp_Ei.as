package sample.libgme
{
   ...
   public function F__ZN8Snes_Spc8run_dsp_Ei() : void
   {
      var _loc3_:* = 0;
      var _loc1_:* = 0;
      var _loc8_:* = 0;
      ...
      var _loc7_:*;
      _loc6_ = (_loc7_ = (_loc7_ = int((_loc7_ = li32(_loc3_ + 4)) - _loc8_)) >> 5) + 1;
      if((_loc5_ = li32(_loc1_ + 76)) != 0)
      {
         si32(_loc7_ = int(_loc5_ + (_loc6_ << 2)),_loc1_ + 76);
         if(uint(_loc7_) > uint(li32(_loc1_ + 80)))
         {
            _loc2_ -= 16;
      ...
      si32(_loc7_ = int((_loc7_ = _loc6_ << 5) + _loc8_),_loc1_ + 84);
      _loc2_ -= 16;
      si32(_loc5_,_loc2_ + 8);
      si32(_loc6_,_loc2_ + 4);
      si32(_loc7_ = int(_loc1_ + 88),_loc2_);
      ESP = _loc2_;
