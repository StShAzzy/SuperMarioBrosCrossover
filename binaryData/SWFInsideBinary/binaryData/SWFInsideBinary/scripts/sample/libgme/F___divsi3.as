   ...
   public function F___divsi3() : void
   {
      ...
      if(_loc3_ != 0)
      {
         if(_loc14_ != 0)
         {
            ...
            _loc8_ = (_loc11_ = int((_loc11_ = (_loc11_ += int((_loc11_ = int(((_loc12_ = int(_loc11_ - ((_loc12_ = int((_loc11_ = (_loc11_ = _loc12_ | int((_loc12_ = _loc11_ | int((_loc11_ = _loc12_ | int((_loc12_ = _loc11_ | int((_loc11_ = _loc9_ | int((_loc9_ = (_loc11_ = (_loc12_ = _loc14_ >> 31) ^ _loc14_) - _loc12_) >>> 1)) >>> 2)) >>> 4)) >>> 8)) >>> 16)) ^ -1) >>> 1)) & 1431655765))) & 858993459) + ((_loc12_ >>>= 2) & 858993459))) >>> 4)) & 252645135) * 16843009)) >>> 24;
            ...
            if(uint(_loc1_) <= 31)
            {
               ...
               if(_loc1_ != 31)
               {
                  ...
                  if(_loc5_ != 0)
                  {
                     ...
                     {
                        _loc11_ = _loc9_ << 1;
                        _loc11_ = (_loc12_ = int(_loc13_ >>> 31)) | _loc11_;
                        var _loc6_:* = (_loc12_ = (_loc12_ = int(_loc7_ - _loc11_)) >> 31) & _loc10_;
      ...
      eax = _loc11_ = int((_loc11_ = _loc13_ ^ _loc12_) - _loc12_);
      _loc2_ = _loc4_;
      ESP = _loc2_;
   }
}
