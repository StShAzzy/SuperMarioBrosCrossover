package sample.libgme
{
   ...
   public function F__ZN8Snes_Spc8load_spcEPKvl() : void
   {
      ...
      if(_loc9_ >= 65920)
      {
         ...
         {
            var _loc6_:*;
            _loc5_ = li8(_loc6_ = int(_loc8_ - _loc1_));
            _loc6_ = li8(_loc6_ = int(L__2E_str11480 - _loc1_));
            _loc10_ = L__2E_str10479;
            if(_loc5_ == _loc6_)
            {
               if(_loc5_ != 0)
               ...
               var _loc4_:*;
               si32(_loc6_ = (_loc4_ = (_loc4_ = li8(_loc8_ + 38)) << 8) | _loc6_,_loc3_ - 16);
               _loc1_ = _loc3_ - 16;
               _loc4_ = _loc1_ | 4;
               si8(_loc6_ = li8(_loc8_ + 39),_loc4_);
               _loc4_ = _loc1_ | 5;
               si8(_loc6_ = li8(_loc8_ + 40),_loc4_);
               _loc4_ = _loc1_ | 6;
               si8(_loc6_ = li8(_loc8_ + 41),_loc4_);
               _loc6_ = _loc1_ | 7;
               si8(_loc4_ = li8(_loc8_ + 42),_loc6_);
               si8(_loc6_ = li8(_loc8_ + 43),_loc3_ - 8);
               if(uint(_loc9_) >= 66048)
               {
                  _loc2_ -= 16;
                  si32(64,_loc2_ + 8);
                  si32(_loc6_ = int(_loc8_ + 65920),_loc2_ + 4);
                  si32(_loc6_ = int(_loc7_ + 66740),_loc2_);
                  ESP = _loc2_;
                  Fmemcpy();
                  _loc2_ += 16;
               }
               ...
               si32(_loc7_,_loc2_);
               si32(_loc6_ = int(_loc8_ + 65792),_loc2_ + 12);
               si32(_loc6_ = int(_loc8_ + 256),_loc2_ + 8);
               ESP = _loc2_;
               F__ZN8Snes_Spc10load_stateERKN7Spc_Cpu11registers_tEPKvS5_();
               _loc2_ += 16;
               si8(_loc10_ = 0,_loc7_ + 602);
               break;
            }
            break;
         }
