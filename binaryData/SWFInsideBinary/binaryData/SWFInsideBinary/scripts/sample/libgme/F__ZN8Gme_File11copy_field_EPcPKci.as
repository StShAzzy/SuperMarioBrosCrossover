   ...
   public function F__ZN8Gme_File11copy_field_EPcPKci() : void
   {
      ...
      if(_loc1_ != 0)
      {
         ...
         if(li8(_loc1_) != 0)
         {
            ...
            {
               var _loc7_:*;
               if((uint(_loc7_ = int((_loc7_ = si8(li8(_loc7_ = int(_loc1_ + _loc6_)))) + -1))) >= 32)
               {
                  break;
               }
               _loc6_ += 1;
            ...
            _loc9_ = int(_loc1_ + _loc6_);
            _loc4_ = 0;
            while(_loc4_ < _loc5_)
            {
               if((_loc7_ = li8(_loc7_ = int((_loc7_ = int(_loc4_ + _loc1_)) + _loc6_))) == 0)
               {
                  break;
               }
               _loc4_ += 1;
            ...
            while(uint(li8((_loc7_ = int(_loc9_ - _loc1_)) - 1)) < 33);
            
            _loc7_ = int(_loc8_ - _loc1_);
            si8(_loc6_ = 0,_loc7_);
            _loc2_ -= 16;
            si32(_loc7_ = int(0 - _loc1_),_loc2_ + 8);
            ...
            do
            {
               _loc5_ = li8(_loc7_ = int(_loc8_ + _loc6_));
               _loc7_ = li8(_loc7_ = int(L__2E_str6194 + _loc6_));
               _loc9_ = int(L__2E_str7195);
               _loc1_ = _loc8_;
               if(_loc5_ == _loc7_)
               {
                  continue;
