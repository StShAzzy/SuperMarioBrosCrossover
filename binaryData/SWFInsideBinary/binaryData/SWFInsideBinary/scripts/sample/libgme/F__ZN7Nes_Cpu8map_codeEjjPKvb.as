package sample.libgme
{
   ...
   import sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str1315;
   import sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str2316;
   ...
   public function F__ZN7Nes_Cpu8map_codeEjjPKvb() : void
   {
      var _loc3_:* = 0;
      var _loc5_:* = 0;
      var _loc1_:* = 0;
      ...
      var _loc8_:*;
      if((_loc8_ = _loc1_ & 2047) != 0)
      {
         _loc2_ -= 16;
         si32(L__2E_str1315,_loc2_ + 12);
         si32(92,_loc2_ + 8);
      ...
      if((_loc8_ = (_loc7_ = li32(_loc3_ + 8)) & 2047) != 0)
      {
         _loc2_ -= 16;
      ...
      if((uint(_loc8_ = int(_loc7_ + _loc1_))) >= 65537)
      {
         _loc2_ -= 16;
      ...
      if(uint(_loc7_) >= 2048)
      {
         ...
         if(li32(_loc3_ + 16) == 0)
         {
            ...
            while(true)
            {
               _loc8_ = _loc1_ << 2;
               var _loc4_:*;
               _loc8_ = int((_loc4_ = li32(_loc5_ + 2056)) + _loc8_);
               si32(_loc6_,_loc8_);
               _loc1_ += 1;
               _loc6_ += 2048;
               if((_loc7_ += -1) != 0)
