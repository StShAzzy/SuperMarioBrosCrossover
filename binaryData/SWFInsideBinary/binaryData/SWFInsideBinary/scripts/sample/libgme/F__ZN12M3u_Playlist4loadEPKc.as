      ...
      while(true)
      {
         try
         {
            if(!_loc7_)
            {
               ...
               _loc15_ = __ZTV15Std_File_Reader + 8;
               _loc14_ = li32(_loc4_ - 64);
               si32(_loc15_,_loc14_);
               si32(_loc14_ = _loc3_ | 4,_loc4_ - 60);
               _loc14_ = li32(_loc4_ - 60);
               si32(0,_loc14_);
               _loc2_ -= 16;
               si32(L__2E_str3127,_loc2_ + 4);
               si32(_loc14_ = li32(_loc4_ + 4),_loc2_);
               ESP = _loc2_;
               F_fopen();
               _loc2_ += 16;
               _loc13_ = int(eax);
            ...
            if((_loc14_ = int(eax)) == 0)
            {
               ...
               if(_loc13_ != 0)
               {
                  ...
                  _loc2_ += 16;
                  _loc12_ = eax;
                  _loc13_ = li32(_loc14_ = li32(_loc4_ - 60));
               }
               _loc14_ = li32(_loc4_ - 64);
               si32(_loc15_,_loc14_);
               if(_loc13_ != 0)
            ...
            while((_loc14_ = li32(_loc14_ = _loc11_ | 4)) == 0)
            {
               _loc8_ = li32(_loc4_ - 48);
               _loc1_ = li32(_loc4_ - 44);
               _loc14_ = li32(_loc4_ - 64);
               si32(_loc15_,_loc14_);
               if((_loc5_ = li32(_loc14_ = li32(_loc4_ - 60))) != 0)
               {
                  _loc2_ -= 16;
                  si32(_loc5_,_loc2_);
                  ESP = _loc2_;
               ...
               _loc14_ = int(__ZTV11File_Reader + 8);
