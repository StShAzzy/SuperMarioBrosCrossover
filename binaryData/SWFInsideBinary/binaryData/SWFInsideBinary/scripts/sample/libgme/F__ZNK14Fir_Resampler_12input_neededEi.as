package sample.libgme
{
   ...
   public function F__ZNK14Fir_Resampler_12input_neededEi() : void
   {
      ...
      var _loc14_:*;
      _loc13_ = (_loc14_ = li32(_loc4_ + 4)) + -2;
      _loc12_ = 0;
      if(_loc13_ >= 1)
      {
         _loc14_ = li32(_loc3_ + 16);
         _loc10_ = int((_loc11_ = li32(_loc3_ + 28)) >>> _loc14_);
         _loc8_ = int((_loc9_ = li32(_loc3_ + 12)) - _loc14_);
         ...
         do
         {
            ...
            _loc14_ = int(_loc12_ + _loc7_);
            var _loc6_:* = (_loc6_ = _loc10_ << 1) & 2;
            _loc12_ = int(_loc14_ + _loc6_);
            _loc13_ += -4;
            _loc10_ = _loc5_;
         }
         while(_loc13_ > 0);
      ...
      _loc1_ = (_loc6_ = (_loc6_ = li32(_loc3_ + 20)) << 1) + -2;
      ...
      _loc6_ = _loc1_ << 1;
      _loc6_ = int((_loc14_ = li32(_loc3_)) + _loc6_);
      _loc14_ = (_loc14_ = int((_loc14_ = li32(_loc3_ + 8)) - _loc6_)) >> 1;
      _loc3_ = int(_loc12_ - _loc14_);
      _loc12_ = 0;
      if(_loc3_ >= _loc12_)
      {
         _loc12_ = _loc3_;
