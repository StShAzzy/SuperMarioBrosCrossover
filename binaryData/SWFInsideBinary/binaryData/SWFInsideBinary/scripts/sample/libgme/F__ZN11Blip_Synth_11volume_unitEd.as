package sample.libgme
{
   ...
   public function F__ZN11Blip_Synth_11volume_unitEd() : void
   {
      ...
      if(_loc7_ != _loc5_)
      {
         if((_loc13_ = li32(_loc2_ + 32)) == 0)
         {
            var _loc12_:*;
            si32(-1071644672,(_loc12_ = int(_loc3_ - 24)) | 4);
            si32(0,_loc3_ - 24);
            si32(0,_loc3_ - 16);
         ...
         var _loc11_:Number;
         if(!((_loc5_ = Number((_loc11_ = _loc5_ * 1073741824) / _loc7_)) <= 0 | _loc5_ != _loc5_ | false))
         {
            _loc9_ = 0;
            if(!(_loc5_ >= 2 | _loc5_ != _loc5_ | false))
            {
               ...
               if(_loc9_ != 0)
               {
                  si32(_loc12_ = _loc13_ >> _loc9_,_loc2_ + 32);
                  if(_loc12_ <= 0)
                  {
                     _loc1_ -= 16;
                     si32(L__2E_str7109,_loc1_ + 12);
                     si32(367,_loc1_ + 8);
                     si32(L__2E_str104,_loc1_ + 4);
                     si32(__ZZN11Blip_Synth_11volume_unitEdE8__func__,_loc1_);
                     ESP = _loc1_;
                     F___assert();
                     _loc1_ += 16;
                  }
                  _loc12_ = int(_loc9_ + -1);
                  _loc13_ = int(32768 >>> _loc9_);
                  _loc8_ = (_loc12_ = 1 << _loc12_) + 32768;
                  _loc12_ = (_loc12_ = li32(_loc2_ + 28)) << 5;
                  _loc6_ = 0 - _loc12_;
                  do
                  {
                     var _loc4_:* = (_loc12_ = _loc6_) << 1;
                     var _loc10_:*;
                     _loc4_ = si16(li16(_loc10_ = int((_loc10_ = li32(_loc2_ + 24)) - _loc4_)));
                     si16(_loc4_ = int((_loc4_ = (_loc4_ = int(_loc8_ + _loc4_)) >> _loc9_) - _loc13_),_loc10_);
                     _loc6_ = _loc12_ + 1;
                  }
                  while(_loc12_ != 0);
         ...
         _loc1_ -= 16;
         sf64(_loc7_ = Number(_loc5_ + 0.5),_loc1_);
         ESP = _loc1_;
         F_floor();
         _loc1_ += 16;
         si32(_loc12_ = int(_loc7_ = Number(st0)),_loc2_ + 8);
      }
      _loc1_ = _loc3_;
      ESP = _loc1_;
   }
