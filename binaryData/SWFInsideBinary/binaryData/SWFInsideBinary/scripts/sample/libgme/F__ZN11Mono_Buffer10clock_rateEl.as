package sample.libgme
{
   ...
   public function F__ZN11Mono_Buffer10clock_rateEl() : void
   {
      var _loc3_:* = 0;
      var _loc8_:* = 0;
      var _loc6_:int = 0;
      ...
      _loc8_ = li32(_loc3_);
      si32(_loc1_,_loc8_ + 48);
      _loc5_ = _loc1_;
      var _loc4_:Number;
      _loc5_ = (_loc5_ = (_loc5_ = (_loc4_ = _loc7_ = li32(_loc8_ + 44)) / _loc5_) * 65536) + 0.5;
      _loc2_ -= 16;
      sf64(_loc5_,_loc2_);
      ESP = _loc2_;
      F_floor();
      _loc2_ += 16;
      if((_loc6_ = _loc5_ = st0) <= 0)
      {
         if(_loc7_ != 0)
         {
            _loc2_ -= 16;
