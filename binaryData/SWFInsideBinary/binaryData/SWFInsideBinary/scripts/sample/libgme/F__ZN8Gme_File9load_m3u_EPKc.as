package sample.libgme
{
   ...
   public function F__ZN8Gme_File9load_m3u_EPKc() : void
   {
      var _loc3_:* = 0;
      var _loc1_:* = 0;
      var _loc7_:* = 0;
      ...
      _loc1_ = li32(_loc3_);
      var _loc8_:*;
      if((_loc8_ = li32(_loc1_ + 12)) == 0)
      {
         _loc2_ -= 16;
         si32(L__2E_str10257,_loc2_ + 12);
         si32(25,_loc2_ + 8);
         si32(L__2E_str9256,_loc2_ + 4);
         si32(__ZZN8Gme_File9load_m3u_EPKcE8__func__,_loc2_);
         ESP = _loc2_;
         F___assert();
         _loc2_ += 16;
      }
      ...
      {
         if((_loc6_ = li32(_loc1_ + 32)) != 0)
         {
            si32(_loc6_,_loc1_ + 8);
         }
         if((_loc5_ = li32(_loc1_ + 44)) != 0)
         {
            si8(0,_loc1_ + 131);
            _loc6_ = int(_loc1_ + 108);
            do
            {
               var _loc4_:int;
               si8(_loc4_ = (_loc4_ = (_loc8_ = _loc5_) % 10) + 48,_loc6_ + 22);
               _loc6_ += -1;
               _loc5_ = int(_loc8_ / 10);
            }
            while(_loc8_ > 9);
            
            si8(32,_loc6_ + 22);
            si16(25966,_loc6_ + 20);
            si32(1768693876,_loc6_ + 16);
            si32(1629517107,_loc6_ + 12);
            si32(1830841961,_loc6_ + 8);
            si32(544040300,_loc6_ + 4);
            si32(1651470928,_loc6_);
