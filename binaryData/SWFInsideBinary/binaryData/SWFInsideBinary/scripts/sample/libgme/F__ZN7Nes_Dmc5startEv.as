package sample.libgme
{
   ...
   public function F__ZN7Nes_Dmc5startEv() : void
   {
      ...
      _loc3_ = _loc2_;
      _loc1_ = li32(_loc3_);
      si32(_loc12_ = (_loc12_ = (_loc12_ = li8(_loc1_ + 2)) << 6) | 16384,_loc1_ + 24);
      si32(_loc12_ = (_loc12_ = (_loc12_ = li8(_loc1_ + 3)) << 4) | 1,_loc1_ + 12);
      _loc2_ -= 16;
      si32(_loc1_,_loc2_);
      ESP = _loc2_;
      ...
      if(_loc12_ != 0)
      {
         ...
         {
            var _loc9_:*;
            _loc11_ = (_loc12_ = int(int((_loc9_ = li32((_loc9_ = li32(_loc1_ + 68)) + 1948)) + li32(_loc1_ + 16)) + int((int((_loc9_ = int((_loc9_ = _loc10_ << 3) + li32(_loc1_ + 36))) + -9)) * li32(_loc1_ + 28)))) + 1;
         }
      }
