package sample.libgme
{
   ...
   public function F__ZN7Kss_Emu8set_bankEii() : void
   {
      ...
      _loc14_ = int((_loc14_ = li8((_loc12_ = li32(_loc4_)) + 941)) >>> 7);
      if((_loc11_ = 16384 >>> _loc14_) != 8192)
      {
         _loc3_ = 0;
      }
      ...
      _loc3_ = (_loc14_ = li32(_loc4_ + 8)) - _loc10_;
      _loc14_ = li32(_loc12_ + 972);
      if(uint(_loc3_) >= uint(_loc14_))
      {
         if((_loc14_ = _loc11_ & 8191) != 0)
         {
            _loc2_ -= 16;
         ...
         {
            _loc3_ = (_loc14_ = int((_loc10_ = int((_loc10_ = _loc13_ & -8192) >>> 11)) + (int((_loc14_ = _loc11_ & -8192) >>> 11)))) + -4;
            _loc13_ = int((_loc14_ = int((_loc14_ = int(_loc13_ + ((_loc14_ = int(_loc11_ + -8192)) & -8192))) + _loc12_)) + 988);
            _loc9_ = int(0 - (int(_loc11_ >>> 13)));
            _loc11_ = 0;
            while(true)
            {
               _loc10_ = int((_loc14_ = li32(_loc12_ + 788)) + _loc3_);
               _loc14_ = _loc11_ << 2;
               _loc10_ += _loc14_;
               si32(_loc13_,_loc10_ + 36);
               _loc14_ = int((_loc10_ = int((_loc10_ = li32(_loc12_ + 788)) + _loc3_)) + _loc14_);
      ...
      else if(_loc11_ != 0)
      {
         ...
         do
         {
            ...
            {
               _loc2_ -= 16;
               si32(L__2E_str3212,_loc2_ + 12);
               si32(51,_loc2_ + 8);
               si32(L__2E_str2211,_loc2_ + 4);
               si32(__ZZNK13blargg_vectorIhEixEjE8__func__210,_loc2_);
               ESP = _loc2_;
               F___assert();
               _loc2_ += 16;
            }
            _loc14_ = (_loc14_ = int((_loc14_ = int(_loc13_ + _loc7_)) >>> 13)) << 2;
            var _loc5_:int = (_loc10_ = li32(_loc12_ + 788)) + _loc14_;
            var _loc6_:* = li32(_loc12_ + 904);
            si32(_loc10_ = int(_loc12_ + 69132),_loc5_ + 36);
            _loc10_ = int(_loc6_ + _loc1_);
            _loc14_ = int((_loc6_ = li32(_loc12_ + 788)) + _loc14_);
            si32(_loc10_,_loc14_);
         }
         while((uint(_loc7_ += 8192)) < uint(_loc11_));
