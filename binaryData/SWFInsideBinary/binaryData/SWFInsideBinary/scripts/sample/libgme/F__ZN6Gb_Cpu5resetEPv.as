package sample.libgme
{
   ...
   public function F__ZN6Gb_Cpu5resetEPv() : void
   {
      ...
      _loc2_ -= 16;
      _loc1_ = li32(_loc3_);
      si32(_loc4_ = int(_loc1_ + 24),_loc1_ + 20);
      si32(0,_loc1_ + 60);
      si32(_loc4_ = li32(_loc3_ + 4),_loc1_ + 24);
      ...
      {
         _loc2_ -= 16;
         si32(L__2E_str4151,_loc2_ + 12);
         si32(62,_loc2_ + 8);
         si32(L__2E_str3150,_loc2_ + 4);
         si32(__ZZ24blargg_verify_byte_ordervE8__func__,_loc2_);
         ESP = _loc2_;
         F___assert();
         _loc2_ += 16;
      }
