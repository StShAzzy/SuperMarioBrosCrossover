package sample.libgme
{
   ...
   public function F__ZN14Effects_Buffer12read_samplesEPsl() : void
   {
      ...
      var _loc21_:*;
      var _loc4_:*;
      if((_loc21_ = (_loc5_ = li32((_loc9_ = _loc4_ = int(ESP)) + 8)) & 1) != 0)
      {
         _loc4_ -= 16;
         si32(L__2E_str3132,_loc4_ + 12);
         si32(251,_loc4_ + 8);
         si32(L__2E_str2131,_loc4_ + 4);
         si32(__ZZN14Effects_Buffer12read_samplesEPslE8__func__,_loc4_);
         ESP = _loc4_;
         F___assert();
         _loc4_ += 16;
      }
      _loc20_ = li32(_loc9_);
      _loc5_ >>= 1;
      _loc19_ = int((_loc21_ = li32(_loc20_ + 24)) >>> 16);
      if(_loc5_ >= _loc19_)
      {
         _loc5_ = _loc19_;
      }
      if(_loc5_ != 0)
      {
         ...
         {
            _loc19_ = _loc16_;
            if((_loc15_ = li32(_loc20_ + 436)) != 0)
            {
               if(_loc15_ >= _loc19_)
               {
                  _loc15_ = _loc19_;
               }
               if((_loc21_ = li32(_loc20_ + 432)) != 0)
               {
                  _loc4_ -= 16;
            ...
            else if((_loc21_ = li32(_loc20_ + 432)) != 0)
            {
               _loc4_ -= 16;
            ...
            _loc17_ = int((_loc21_ = li32(_loc20_ + 432)) - _loc15_);
            _loc14_ = 0;
            if(_loc17_ >= 0)
            {
               _loc14_ = _loc17_;
            ...
            _loc17_ = int((_loc21_ = li32(_loc20_ + 436)) - _loc15_);
            _loc14_ = 0;
            if(_loc17_ >= 0)
            {
               _loc14_ = _loc17_;
            ...
            if(_loc15_ == 0)
            {
               do
               {
                  ...
                  if((_loc21_ = int((_loc11_ = li32((_loc12_ = _loc20_ + ((_loc21_ = int(_loc10_ * 11)) << 2)) + 24)) >>> 16)) >= _loc15_)
                  {
                     si32(_loc21_ = int(_loc11_ - _loc1_),_loc12_ + 24);
                     continue;
                  }
                  addr615:
                  while(true)
                  {
                     _loc4_ -= 16;
                     si32(L__2E_str2106,_loc4_ + 12);
                     si32(152,_loc4_ + 8);
                     si32(L__2E_str104,_loc4_ + 4);
                     si32(__ZZN11Blip_Buffer14remove_silenceElE8__func__,_loc4_);
                     ESP = _loc4_;
                     F___assert();
                     _loc4_ += 16;
                     addr650:
                     while(true)
                     {
                        si32(_loc21_ = int(_loc3_ - _loc1_),_loc13_ + 24);
                        addr661:
                        do
                        {
                           _loc10_ = _loc11_;
            ...
            while(true)
            {
               _loc21_ = (_loc12_ = _loc10_ * 11) << 2;
               _loc3_ = li32((_loc13_ = _loc20_ + _loc21_) + 24);
               _loc6_ = _loc3_ >>> 16;
               ...
               if(_loc10_ < _loc16_)
               {
                  ...
                  var _loc7_:*;
                  si32(_loc7_ = int(_loc3_ - _loc1_),_loc13_ + 24);
                  _loc21_ = _loc12_ << 2;
                  var _loc8_:*;
                  var _loc2_:int = (_loc8_ = li32((_loc21_ = int(_loc20_ + _loc21_)) + 28)) + _loc14_;
                  _loc4_ -= 16;
                  si32(_loc2_,_loc4_ + 4);
                  si32(_loc8_,_loc4_);
                  si32(_loc7_ = int((_loc7_ = int((_loc7_ &= -65536) >>> 14)) + 72),_loc4_ + 8);
                  ESP = _loc4_;
                  Fmemmove();
                  _loc4_ += 16;
         ...
         while(_loc16_ = int(_loc19_ - _loc15_), _loc18_ += _loc14_, _loc19_ != _loc15_);
