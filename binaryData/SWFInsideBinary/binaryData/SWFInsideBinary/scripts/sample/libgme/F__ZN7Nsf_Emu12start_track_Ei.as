package sample.libgme
{
   ...
   public function F__ZN7Nsf_Emu12start_track_Ei() : void
   {
      ...
      _loc3_ -= 16;
      var _loc46_:*;
      _loc44_ = li32((_loc46_ = li32(_loc48_ = li32((_loc22_ = li32(_loc7_)) + 252))) + 28);
      _loc3_ -= 16;
      si32(_loc48_,_loc3_);
      ESP = _loc3_;
      ptr2fun[_loc44_]();
      ...
      _loc3_ -= 16;
      si32(2048,_loc3_ + 8);
      si32(_loc42_ = 0,_loc3_ + 4);
      si32(_loc40_ = _loc22_ + 272,_loc3_);
      ESP = _loc3_;
      Fmemset();
      _loc3_ += 16;
      _loc3_ -= 16;
      ...
      si32(_loc38_ = _loc22_ + 5512,_loc3_);
      ESP = _loc3_;
      Fmemset();
      _loc3_ += 16;
      si32(_loc36_ = int(_loc22_ + 2332),_loc22_ + 2328);
      si8(4,_loc22_ + 2325);
      si8(-1,_loc22_ + 2326);
      ...
      si32(_loc34_ = _loc22_ + 13704,_loc22_ + 2460);
      ...
      si32(1,_loc7_ - 4);
      if((_loc48_ = li8(_loc7_ - 4)) != 0)
      {
         si32(_loc38_,li32(_loc22_ + 2328) + 48);
         si32(int(_loc22_ + 7560),li32(_loc22_ + 2328) + 52);
         si32(int(_loc22_ + 9608),li32(_loc22_ + 2328) + 56);
         si32(int(_loc22_ + 11656),li32(_loc22_ + 2328) + 60);
         _loc28_ = (_loc46_ = (_loc46_ = li8(_loc22_ + 2484)) << 12) & li32(_loc22_ + 2556);
         if((_loc48_ = li32(_loc22_ + 2560)) <= _loc28_)
         {
            addr470:
            si32(L__2E_str8324,_loc22_ + 16);
         }
         _loc48_ = li32(_loc22_ + 2552);
         _loc30_ = _loc28_ - _loc48_;
         if((uint(_loc48_ = int((_loc32_ = li32(_loc22_ + 2544)) + -4104))) >= uint(_loc30_))
         {
            _loc42_ = _loc30_;
         }
         ...
         {
            _loc3_ -= 16;
            si32(L__2E_str7323,_loc3_ + 12);
            si32(51,_loc3_ + 8);
            si32(L__2E_str6322,_loc3_ + 4);
            si32(__ZZNK13blargg_vectorIhEixEjE8__func__321,_loc3_);
            ESP = _loc3_;
            F___assert();
            _loc3_ += 16;
         }
         _loc48_ = int((_loc48_ = li32(_loc22_ + 2540)) + _loc42_);
         ...
         _loc23_ = (_loc46_ = (_loc46_ = li8(_loc22_ + 2485)) << 12) & _loc48_;
         if((_loc48_ = li32(_loc22_ + 2560)) <= _loc23_)
         {
            si32(L__2E_str8324,_loc22_ + 16);
         }
         _loc48_ = li32(_loc22_ + 2552);
         _loc24_ = _loc23_ - _loc48_;
         _loc48_ = int((_loc25_ = li32(_loc22_ + 2544)) + -4104);
         _loc26_ = 0;
         ...
         _loc48_ = int((_loc48_ = li32(_loc22_ + 2540)) + _loc26_);
         _loc46_ = li32(_loc22_ + 2328);
         si32(_loc48_,_loc46_ + 72);
         _loc46_ = int(_loc48_ + 2048);
         _loc48_ = li32(_loc22_ + 2328);
         si32(_loc46_,_loc48_ + 76);
         _loc48_ = li32(_loc22_ + 2556);
         _loc21_ = (_loc46_ = (_loc46_ = li8(_loc22_ + 2486)) << 12) & _loc48_;
         if((_loc48_ = li32(_loc22_ + 2560)) <= _loc21_)
         {
            si32(L__2E_str8324,_loc22_ + 16);
         }
         _loc48_ = li32(_loc22_ + 2552);
         _loc20_ = _loc21_ - _loc48_;
         _loc48_ = int((_loc16_ = li32(_loc22_ + 2544)) + -4104);
         _loc13_ = 0;
         ...
         _loc46_ = int((_loc48_ = li32(_loc22_ + 2540)) + _loc13_);
         _loc48_ = li32(_loc22_ + 2328);
         ...
         _loc48_ = li32(_loc22_ + 2556);
         _loc14_ = (_loc46_ = (_loc46_ = li8(_loc22_ + 2487)) << 12) & _loc48_;
         if((_loc48_ = li32(_loc22_ + 2560)) <= _loc14_)
         {
            si32(L__2E_str8324,_loc22_ + 16);
         }
         _loc48_ = li32(_loc22_ + 2552);
         _loc9_ = _loc14_ - _loc48_;
         _loc48_ = int((_loc11_ = li32(_loc22_ + 2544)) + -4104);
         _loc5_ = 0;
         ...
         _loc46_ = int((_loc48_ = li32(_loc22_ + 2540)) + _loc5_);
         _loc48_ = li32(_loc22_ + 2328);
         ...
         _loc48_ = li32(_loc22_ + 2556);
         _loc6_ = (_loc46_ = (_loc46_ = li8(_loc22_ + 2488)) << 12) & _loc48_;
         if((_loc48_ = li32(_loc22_ + 2560)) <= _loc6_)
         {
            si32(L__2E_str8324,_loc22_ + 16);
         }
         _loc48_ = li32(_loc22_ + 2552);
         _loc2_ = _loc6_ - _loc48_;
         _loc48_ = int((_loc4_ = li32(_loc22_ + 2544)) + -4104);
         _loc1_ = 0;
         ...
         _loc46_ = int((_loc48_ = li32(_loc22_ + 2540)) + _loc1_);
         _loc48_ = li32(_loc22_ + 2328);
         ...
         _loc48_ = li32(_loc22_ + 2556);
         _loc31_ = (_loc46_ = (_loc46_ = li8(_loc22_ + 2489)) << 12) & _loc48_;
         if((_loc48_ = li32(_loc22_ + 2560)) <= _loc31_)
         {
            si32(L__2E_str8324,_loc22_ + 16);
         }
         _loc48_ = li32(_loc22_ + 2552);
         _loc29_ = _loc31_ - _loc48_;
         _loc48_ = int((_loc35_ = li32(_loc22_ + 2544)) + -4104);
         _loc33_ = 0;
         ...
         _loc46_ = int((_loc48_ = li32(_loc22_ + 2540)) + _loc33_);
         _loc48_ = li32(_loc22_ + 2328);
         ...
         _loc48_ = li32(_loc22_ + 2556);
         _loc39_ = (_loc46_ = (_loc46_ = li8(_loc22_ + 2490)) << 12) & _loc48_;
         if((_loc48_ = li32(_loc22_ + 2560)) <= _loc39_)
         {
            si32(L__2E_str8324,_loc22_ + 16);
         }
         _loc48_ = li32(_loc22_ + 2552);
         _loc37_ = _loc39_ - _loc48_;
         _loc48_ = int((_loc43_ = li32(_loc22_ + 2544)) + -4104);
         _loc41_ = 0;
         ...
         _loc46_ = int((_loc48_ = li32(_loc22_ + 2540)) + _loc41_);
         _loc48_ = li32(_loc22_ + 2328);
         ...
         _loc48_ = li32(_loc22_ + 2556);
         _loc47_ = (_loc46_ = (_loc46_ = li8(_loc22_ + 2491)) << 12) & _loc48_;
         if((_loc48_ = li32(_loc22_ + 2560)) <= _loc47_)
         {
            si32(L__2E_str8324,_loc22_ + 16);
         }
         _loc48_ = li32(_loc22_ + 2552);
         _loc45_ = _loc47_ - _loc48_;
         _loc48_ = int((_loc12_ = li32(_loc22_ + 2544)) + -4104);
         _loc10_ = 0;
         ...
         _loc46_ = int((_loc48_ = li32(_loc22_ + 2540)) + _loc10_);
         _loc48_ = li32(_loc22_ + 2328);
         ...
         var _loc8_:int;
         si32(_loc8_ = _loc22_ + 2576,_loc3_);
         si32(_loc48_ = (_loc48_ = (_loc48_ = _loc46_ << 26) >> 31) & 63,_loc3_ + 8);
         ESP = _loc3_;
         ...
         si32(0,_loc3_ + 4);
         si32(_loc8_,_loc3_);
         si32(_loc48_ = (_loc48_ <<= 3) & 128,_loc3_ + 12);
         ESP = _loc3_;
         F__ZN7Nes_Apu14write_registerEiji();
         _loc3_ += 16;
         if((_loc18_ = li32(_loc22_ + 2564)) != 0)
         {
            si32(0,_loc18_);
            si32(0,_loc18_ + 12);
            si32(0,_loc18_ + 8);
            ...
            si32(140,_loc3_ + 8);
            si32(0,_loc3_ + 4);
            si32(_loc48_ = int(_loc18_ + 92),_loc3_);
            ESP = _loc3_;
            Fmemset();
            _loc3_ += 16;
         }
         if((_loc17_ = li32(_loc22_ + 2568)) != 0)
         {
            si32(0,_loc17_ + 72);
            si8(0,_loc17_ + 2);
            si16(0,_loc17_);
         ...
         if((_loc15_ = li32(_loc22_ + 2572)) != 0)
         {
            si32(0,_loc15_ + 48);
            si32(0,_loc15_ + 28);
            si32(0,_loc15_ + 36);
         ...
         si32(4,_loc22_ + 2536);
         si32(0,_loc22_ + 2532);
         si32(_loc48_ = int((_loc48_ = li32(_loc22_ + 2528)) / 12),_loc22_ + 2524);
         si16(24568,_loc22_ + 2514);
         si8(95,_loc22_ + 783);
         si8(-9,_loc22_ + 782);
         si8(-3,_loc22_ + 2326);
         si16(_loc48_ = li32(_loc22_ + 2492),_loc22_ + 2320);
         si8(_loc27_,_loc22_ + 2322);
         si8(_loc48_ = li8(_loc22_ + 2512),_loc22_ + 2323);
         eax = 0;
         _loc3_ = _loc7_;
         ESP = _loc3_;
         return;
      ...
      _loc3_ -= 16;
      si32(L__2E_str5320,_loc3_ + 12);
      si32(62,_loc3_ + 8);
      si32(L__2E_str4319,_loc3_ + 4);
      si32(__ZZ24blargg_verify_byte_ordervE8__func__318,_loc3_);
      ESP = _loc3_;
      F___assert();
      _loc3_ += 16;
      §§goto(addr470);
