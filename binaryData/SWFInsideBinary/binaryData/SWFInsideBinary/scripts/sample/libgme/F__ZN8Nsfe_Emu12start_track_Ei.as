package sample.libgme
{
   ...
   public function F__ZN8Nsfe_Emu12start_track_Ei() : void
   {
      var _loc3_:* = 0;
      var _loc1_:* = 0;
      var _loc4_:* = 0;
      ...
      _loc3_ = _loc2_;
      _loc1_ = li32(_loc3_);
      _loc6_ = li8(_loc1_ + 16948);
      _loc5_ = li32(_loc3_ + 4);
      if(_loc6_ == 0)
      {
         if((uint(_loc4_ = li32(_loc1_ + 16932))) > uint(_loc5_))
         {
            ...
            _loc5_ = li8(_loc6_ = int((_loc6_ = li32(_loc1_ + 16928)) + _loc5_));
         }
      }
      _loc2_ -= 16;
