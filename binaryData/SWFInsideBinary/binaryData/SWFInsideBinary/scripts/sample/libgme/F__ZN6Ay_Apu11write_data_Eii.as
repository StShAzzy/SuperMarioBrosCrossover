package sample.libgme
{
   ...
   public function F__ZN6Ay_Apu11write_data_Eii() : void
   {
      ...
      {
         _loc2_ -= 16;
         si32(L__2E_str7103,_loc2_ + 12);
         si32(122,_loc2_ + 8);
         si32(L__2E_str298,_loc2_ + 4);
         si32(__ZZN6Ay_Apu11write_data_EiiE8__func__,_loc2_);
         ESP = _loc2_;
         F___assert();
         _loc2_ += 16;
      }
      ...
      if(_loc1_ == 13)
      {
         ...
         var _loc7_:* = int(_loc9_ + 80);
         si32(_loc8_ = int((_loc8_ = int((_loc8_ = int(_loc10_ * 48)) + _loc7_)) + -324),_loc9_ + 84);
         si32(-48,_loc9_ + 88);
         si32(0,_loc9_ + 80);
      }
      _loc8_ = int(_loc9_ + _loc1_);
      si8(_loc10_,_loc8_ + 53);
      if((_loc6_ = _loc1_ >> 1) <= 2)
      {
         _loc4_ = (_loc7_ = (_loc7_ = (_loc7_ = li8(_loc7_ += _loc1_ | 1)) << 8) & 3840) | li8(_loc8_ = int((_loc7_ = int(_loc9_ + 53)) + (_loc1_ & -2)));
         _loc10_ = 16;
         _loc1_ = 0;
         if(_loc4_ != _loc1_)
         {
         ...
         if((_loc6_ = int(_loc8_ + _loc7_)) >= _loc1_)
         {
            _loc1_ = _loc6_;
         }
