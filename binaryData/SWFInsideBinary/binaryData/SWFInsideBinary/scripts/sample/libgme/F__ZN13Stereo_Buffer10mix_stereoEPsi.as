package sample.libgme
{
   ...
   public function F__ZN13Stereo_Buffer10mix_stereoEPsi() : void
   {
      ...
      var _loc17_:* = 0;
      var _loc3_:* = int(ESP);
      _loc18_ = li32((_loc4_ = li32(_loc6_ = _loc3_)) + 36);
      ...
      if((_loc15_ = li32(_loc6_ + 8)) != 0)
      {
         ...
         {
            _loc8_ = _loc18_ >> 14;
            if((_loc13_ = (_loc13_ = (_loc9_ = (_loc13_ = _loc16_ >> 14) + _loc8_) << 16) >> 16) != _loc9_)
            {
               _loc9_ = 32767 - (_loc9_ >> 24);
            }
            _loc8_ = int((_loc13_ = _loc17_ >> 14) + _loc8_);
            _loc10_ = li32(_loc7_);
            ...
            _loc13_ = int(_loc18_ - _loc13_);
            _loc18_ = int(_loc10_ + _loc13_);
            _loc13_ = li32(_loc11_);
            var _loc2_:* = li32(_loc1_);
            si16(_loc9_,_loc12_ - 2);
            si16(_loc8_,_loc12_);
            var _loc5_:* = _loc17_ >> _loc14_;
            _loc5_ = int(_loc17_ - _loc5_);
            _loc17_ = int(_loc2_ + _loc5_);
            _loc2_ = _loc16_ >> _loc14_;
            _loc2_ = int(_loc16_ - _loc2_);
            _loc16_ = int(_loc13_ + _loc2_);
            _loc7_ += 4;
            _loc1_ += 4;
            _loc11_ += 4;
            _loc12_ += 4;
