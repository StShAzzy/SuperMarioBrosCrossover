package sample.libgme
{
   ...
   public function F__ZN7Sap_Emu9load_mem_EPKhl() : void
   {
      ...
      _loc10_ = (_loc11_ = li32(_loc3_ + 4)) + _loc1_;
      _loc9_ = li32(_loc3_);
      ...
      si32(312,_loc9_ + 332);
      _loc2_ -= 16;
      si32(_loc10_ = _loc9_ + 304,_loc2_ + 8);
      ...
      if((_loc8_ = eax) == 0)
      {
         ...
         _loc2_ -= 16;
         var _loc7_:Number;
         sf64(_loc7_ = lf64(_loc9_ + 184) * 0.008333333333333333,_loc2_ + 4);
         si32(int(_loc9_ + 67160),_loc2_);
         ESP = _loc2_;
