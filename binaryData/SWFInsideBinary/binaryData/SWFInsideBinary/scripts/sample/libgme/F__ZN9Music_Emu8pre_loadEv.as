package sample.libgme
{
   ...
   import sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.__ZZN9Music_Emu8pre_loadEvE8__func__;
   
   public function F__ZN9Music_Emu8pre_loadEv() : void
   {
      var _loc3_:* = 0;
      var _loc1_:* = 0;
      var _loc2_:* = int(ESP);
      ...
      if((_loc5_ = li32(_loc1_ + 192)) == 0)
      {
         ...
         si32(__ZZN9Music_Emu8pre_loadEvE8__func__,_loc2_);
         ESP = _loc2_;
         F___assert();
         _loc2_ += 16;
      }
      var _loc4_:* = li32((_loc5_ = li32(_loc1_)) + 8);
      _loc2_ -= 16;
      si32(_loc1_,_loc2_);
      ESP = _loc2_;
      ptr2fun[_loc4_]();
