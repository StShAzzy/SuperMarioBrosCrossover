package com.smbc.level
{
   ...
   public class Level extends Sprite
   {
      ...
      public static const HELPER_HIDE:String = "Hide";
      
      public static const HELPER_SHOW:String = "Show";
      ...
      public const HALF_TILE_SIZE:int = 16.0;
      ...
      private const SCROLL_EDGE_DIST:Number = 256.0;
      
      private const DEFAULT_LEFT_SCROLL_POS:Number = 256.0;
      
      private const DEFAULT_RIGHT_SCROLL_POS:Number = 256.0;
      
      private const DEFAULT_RIGHT_SCROLL_POS_NO_LEFT_SCROLL:Number = 210;
      ...
      public var offScreenScrollShift:Number = 128.0;
      ...
      private var _fullLevStr:String;
      ...
      private const HW_ENEMY_REMOVAL_DIST:Number = 192.0;
      ...
      public function Level(param1:String, param2:LevelData, param3:Array, param4:Boolean)
      {
         ...
         if(param1 == CharacterSelect.FULL_LEVEL_STR && !(this is FakeLevel) && !(this is CharacterSelect))
         {
            param1 = GameSettings.FIRST_LEVEL;
            this.STAT_MNGR.curFullLevStr = param1;
         }
         this._fullLevStr = param1;
         this._newLev = param4;
         this.levData = param2;
         this._worldNum = int(this._fullLevStr.charAt(0));
         this._levNum = int(this._fullLevStr.charAt(2));
         this._areaStr = this._fullLevStr.charAt(3);
      ...
      public static function ExtractLevelDataProperty(param1:String, param2:String, param3:Boolean = false) : String
      {
         ...
         if(param3)
         {
            if((_loc4_ = param1.indexOf(PROP_EQUALS,_loc4_) + 1) == 0)
            {
               throw new Error("Value does not exist");
            }
         }
         var _loc5_:int;
         if((_loc5_ = param1.indexOf(PROP_SEP,_loc4_)) == -1)
         {
      ...
      {
         var _loc2_:int = param1.indexOf(PROP_SEP);
         if(_loc2_ == -1)
         {
            return param1;
         }
      ...
      private function addedListener(param1:Event) : void
      {
         ...
         this.setUpAnimTmrs();
         if(this.levData.curFullLevStr != this._fullLevStr)
         {
            this.levData.getCurrentLevel(this._fullLevStr);
         }
      ...
      private function rebuildLevel() : void
      {
         ...
         var _loc8_:Scenery = null;
         var _loc9_:CustomDictionary = null;
         var _loc10_:EnemySpawner = null;
         ...
         var _loc3_:CustomDictionary = this.areaStatsArr[this.AREA_STATS_ARR_IND_AO_DCT];
         for each(_loc4_ in _loc3_)
         {
            this.AO_DCT.addItem(_loc4_);
            _loc4_.rearm();
            if(_loc4_ is PipeTransporter && (_loc4_ as PipeTransporter).ptType == "globalEnd")
            {
               if(this.pTransVec)
               {
                  this.pTransVec.push(_loc4_);
               }
               else
               {
            ...
            else if(_loc4_ is FlagPole)
            {
               this._flagPole = _loc4_ as FlagPole;
            }
            else if(_loc4_ is LevelExit && this._levNum != 4)
            {
               this.castleFlag = new CastleFlag();
               this.castleFlag.x = _loc4_.x - this.TILE_SIZE * 1.5;
         ...
         _loc5_ = this.areaStatsArr[this.AREA_STATS_ARR_IND_GROUND_DCT];
         for each(_loc6_ in _loc5_)
         {
            this.GROUND_DCT.addItem(_loc6_);
            _loc6_.rearm();
            if(_loc6_ is Platform)
            {
               if(this.platVec)
               {
                  this.platVec.push(_loc6_);
               }
               else
               {
               ...
               if(Platform(_loc6_).platType == Platform.PT_PULLY)
               {
                  if(this.pullyPlatVec)
                  {
                     this.pullyPlatVec.push(_loc6_);
                  }
                  else
                  {
         ...
         _loc7_ = this.areaStatsArr[this.AREA_STATS_ARR_IND_SCENERY_DCT];
         for each(_loc8_ in _loc7_)
         {
            this.SCENERY_DCT.addItem(_loc8_);
            _loc8_.level = this;
            if(_loc8_.mainAnimTmr)
            {
               _loc8_.setUpAnimation();
            }
            addChild(_loc8_);
            if((_loc11_ = _loc8_.currentLabel) != null)
            {
               if(_loc11_.indexOf("flag") != -1 && _loc11_.indexOf("Pole") == -1)
               {
                  this.flag = _loc8_;
               }
               else if(_loc11_.indexOf("bridgeChain") != -1)
               {
                  this.bbChain = _loc8_;
               }
            }
         ...
         _loc9_ = this.areaStatsArr[this.AREA_STATS_ARR_IND_ENEMY_SPAWNER_DCT];
         for each(_loc10_ in _loc9_)
         {
            _loc10_.rearm();
            this.ENEMY_SPAWNER_DCT.addItem(_loc10_);
         }
         ...
         {
            _loc12_ = 0;
            while(_loc12_ < this.numHorzTiles)
            {
               _loc13_ = this.levMap[_loc1_][_loc12_] as String;
               _loc14_ = _loc1_ * this.TILE_SIZE;
               _loc15_ = _loc12_ * this.TILE_SIZE;
               _loc16_ = false;
               _loc19_ = _loc13_.indexOf(PROP_SEP);
               if(_loc13_.indexOf("&&shiftRight") != -1)
               {
                  _loc16_ = true;
               }
               if(_loc13_.indexOf("playerStart") != -1)
               {
                  this.player.x = _loc15_ + this.TILE_SIZE * 0.5;
                  this.player.y = _loc14_ + this.TILE_SIZE;
                  if(_loc16_)
                  {
               ...
               else if(_loc13_.indexOf("pitTransferStart") != -1)
               {
                  _loc21_ = _loc13_.indexOf("&&pTransDest=") + 13;
                  if((_loc22_ = _loc13_.indexOf("&&",_loc21_)) == -1)
                  {
                     _loc22_ = _loc13_.length;
                  }
                  _loc20_ = _loc13_.substring(_loc21_,_loc22_);
                  this.player.getPitTransfer(_loc20_);
               }
               _loc12_++;
            }
            _loc1_++;
      ...
      {
         if(ExtractLevelDataProperty(param1,PROP_CHAR_HORZ,true) == HELPER_HIDE && param2)
         {
            return false;
         }
         if(ExtractLevelDataProperty(param1,PROP_CHAR_VERT,true) == HELPER_HIDE && param3)
         {
            return false;
         }
         var _loc4_:* = ExtractLevelDataProperty(param1,PROP_CHAR_HORZ,true) == HELPER_SHOW;
         var _loc5_:* = ExtractLevelDataProperty(param1,PROP_CHAR_VERT,true) == HELPER_SHOW;
         if(_loc4_ && _loc5_)
         {
      ...
      public function buildLevel() : void
      {
         ...
         while(_loc9_ < this.numVertTiles)
         {
            ...
            {
               _loc12_ = (_loc11_ = this.levMap[_loc9_][_loc10_] as String).split(PROP_OBJECT_SEP);
               ...
               for each(_loc17_ in _loc12_)
               {
                  ...
                  _loc26_ = false;
                  _loc27_ = false;
                  _loc28_ = _loc17_.indexOf(PROP_SEP);
                  _loc29_ = null;
                  ...
                  else if(_loc17_.indexOf("pitTransfer") != -1)
                  {
                     if(_loc17_.indexOf("Start") != -1)
                     {
                        ...
                        if((_loc39_ = _loc17_.indexOf("&&",_loc38_)) == -1)
                        {
                  ...
                  else if(_loc17_.indexOf("spawnBulletBillGrayEnd") != -1)
                  {
                     this.fcEndX = _loc14_;
                  }
                  else if(_loc17_.indexOf("flyingCheepStart") != -1)
                  {
                     ...
                     {
                        this.fcStartX_2 = _loc14_;
                     }
                  }
                  else if(_loc17_.indexOf("flyingCheepEnd") != -1)
                  {
                     if(isNaN(this.fcEndX))
                     {
                        this.fcEndX = _loc14_;
                     }
                     else
                     {
                        this.fcEndX_2 = _loc14_;
                     }
                  }
      ...
      private function piranhaExistsAtLocation(param1:Number, param2:Number, param3:Boolean) : Boolean
      {
         ...
         for each(_loc4_ in this.AO_DCT)
         {
            ...
            {
               if((_loc5_ = _loc4_ as PiranhaGreen).originalX == param1 && _loc5_.originalY == param2 && _loc5_.upsideDown == param3)
               {
                  return true;
               }
            }
      ...
      private function AddSceneryToVec(param1:Scenery) : void
      {
         ...
         var _loc2_:int = this.sceneryVec.length;
         if(_loc2_ == 0 || (_loc3_ = this.sceneryVec[_loc2_ - 1]) == null || _loc3_[0].x != param1.x || _loc3_[0].y != param1.y)
         {
      ...
      public function initiateLevel() : void
      {
         ...
         if(this.bowser && this.bowser.onScreen)
         {
         ...
         if(this.pullyCornerVec && this.pullyPlatVec)
         {
            _loc5_ = this.pullyPlatVec.length;
            _loc4_ = 0;
            while(_loc4_ < _loc5_)
            {
               (_loc6_ = this.pullyPlatVec[_loc4_]).getPartnerStep1();
               _loc4_++;
            }
            _loc4_ = 0;
            while(_loc4_ < _loc5_)
            {
               (_loc6_ = this.pullyPlatVec[_loc4_]).getPartnerStep2();
               _loc4_++;
            }
         ...
         if(!isNaN(this.fcStartX) && !isNaN(this.fcEndX))
         {
            this.ENEMY_SPAWNER_DCT.addItem(new FlyingCheepSpawner(this.fcStartX,this.fcEndX));
         }
         if(!isNaN(this.fcStartX_2) && !isNaN(this.fcEndX_2))
         {
            this.ENEMY_SPAWNER_DCT.addItem(new FlyingCheepSpawner(this.fcStartX_2,this.fcEndX_2));
         }
         if(!isNaN(this.lakSpawnZoneStart) && !isNaN(this.lakSpawnZoneEnd))
         {
            this.ENEMY_SPAWNER_DCT.addItem(new LakituSpawner(this.lakSpawnZoneStart,this.lakSpawnZoneEnd));
         }
         ...
         if(this.pExInt && this.pTransVec)
         {
            this.changePlayerLoc();
         }
         else if(this.hwPnt && this.shouldStartAtCheckPoint)
         {
      ...
      {
         if(this.STAT_MNGR.passedHw && (!this.levData.lockedCheckpoint || Cheats.extraCheckpoints || GameSettings.mapDifficulty == MapDifficulty.HARD))
         {
            return true;
         }
         return false;
      ...
      private function replaceScenery() : void
      {
         ...
         var _loc14_:int = this.sceneryVec.length;
         while(_loc15_ < _loc14_)
         {
            ...
            if(!(_loc17_ == null || this.DESTROY_DCT[_loc17_]))
            {
               ...
               if((_loc19_ = _loc17_[0]) != null && this.getGroundAt(_loc19_.x,_loc19_.y - this.TILE_SIZE) != null)
               {
      ...
      private function autoDetectScenery(param1:Vector.<Scenery>, param2:Vector.<Scenery>, param3:Vector.<Scenery>, param4:String, param5:String, param6:String, param7:String, param8:String) : void
      {
         ...
         {
            if(!(_loc9_ == null || _loc9_.stopFrame != param4 || this.DESTROY_DCT[_loc9_]))
            {
      ...
      private function changePlayerLoc() : void
      {
         ...
         var _loc1_:int = this.pTransVec.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      public function getNearestGrid(param1:Number, param2:int = 0) : int
      {
         ...
         var _loc5_:int;
         var _loc6_:int = (_loc5_ = Math.floor(_loc4_) * this.TILE_SIZE) + this.TILE_SIZE;
         if(param2 == 1)
         {
            return _loc6_;
         }
      ...
      private function setUpTeleporters() : void
      {
         ...
         sortTeleporters = function(param1:Array, param2:Array):int
         {
            ...
            var _loc4_:int;
            if((_loc4_ = sortStrings(param1[1],param2[1])) != 0)
            {
               return _loc4_;
            }
            var _loc5_:int;
            if((_loc5_ = sortNums(param1[2],param2[2])) != 0)
            {
               return _loc5_;
            }
            return int(sortStrings(param1[3],param2[3]));
         };
         var teleDataVecLen:int = this.teleDataVec.length;
         ...
         while(i < teleDataVecLen)
         {
            ...
            if(ctType == "checkPoint" || ctType == "start" || ctType == "startOne")
            {
               if(ntArr && ctType != ntType || ctNum != ntNum || ctx != ntx || !ntArr)
               {
                  ...
                  teleX = this.teleDataVec[teleStartInd][2];
                  teleY = this.teleDataVec[teleEndInd][3];
      ...
      protected function gameLoop(param1:TimerEvent) : void
      {
         ...
         var locTopLeftPt:Point = globalToLocal(this.TOP_LFT_PT);
         var locBottomRightPt:Point = globalToLocal(this.BOTTOM_RHT_PT);
         ...
         if(this._flagPole && (this._flagPole.onScreen || this._flagPole.updateOffScreen))
         {
            this._flagPole.checkPlayerLoc();
         }
         if(!this.STAT_MNGR.passedHw && this.hwPnt && this.player.nx >= this.hwPnt.x && !this.levelToLoad && !this.player.dead)
         {
         ...
         else if(this.levelToLoad)
         {
            this.loadNewLevel(this.levelToLoad);
         }
      ...
      public function checkCollisions(param1:AnimatedObject = null) : void
      {
         ...
         ((_loc4_ = this.player) as Character).curHitDct.clear();
         ...
         {
            if(!(_loc4_ = this.aoVecHt[_loc5_]).stopHit)
            {
               this.maxDist = this.DEFAULT_MAX_HIT_TEST_DISTANCE;
      ...
      private function aoHT(param1:AnimatedObject, param2:int) : void
      {
         ...
         {
            if(!((_loc4_ = this.aoVecHt[_loc3_]).stopHit || param1.stopHit || param2 >= this.aoVecHtLen - 1))
            {
               if(param1.hitDistOver || _loc4_.hitDistOver)
               {
               ...
               if(this.getDistance(param1.hMidX,param1.hMidY,_loc4_.hMidX,_loc4_.hMidY) <= this.maxDist)
               {
                  ...
                  for each(_loc9_ in _loc5_)
                  {
                     ...
                     {
                        if(_loc7_[_loc10_] && _loc8_[_loc9_])
                        {
      ...
      private function groundHT(param1:AnimatedObject) : void
      {
         ...
         {
            if(!(_loc4_.stopHit || param1.stopHit))
            {
               ...
               for each(_loc9_ in _loc6_)
               {
                  ...
                  {
                     if(_loc7_[_loc10_] && _loc12_[_loc9_])
                     {
                        _loc8_ = true;
                        break loop1;
                     }
         ...
         if(this.projHitArr)
         {
            _loc14_ = this.projHitArr.length;
            _loc13_ = 0;
            while(_loc13_ < _loc14_)
            {
               if(this.projHitArr)
               {
                  ...
                  if(!(_loc16_ = Projectile(this.projHitArr[_loc13_][1])).destroyed && !_loc16_.stopHit && !_loc15_.destroyed && !_loc15_.stopHit && (!(_loc15_ is Ground) || !Ground(_loc15_).disabled))
                  {
      ...
      private function checkForceIntoSmallGap(param1:Character) : void
      {
         ...
         var _loc10_:Ground;
         if(!(_loc10_ = this.getGroundAt(_loc9_.x,_loc9_.y)))
         {
            return;
         }
         ...
         else
         {
            ...
            if(_loc11_ == this.TILE_SIZE * 2 && this.getGroundAt(_loc10_.x,_loc10_.y - _loc11_ * _loc6_))
            {
               return;
            }
         }
      ...
      private function checkStgPositionLocal() : void
      {
         ...
         var _loc5_:CustomDictionary = null;
         var _loc6_:Number;
         if((_loc6_ = this.locStgLft - this.lftTilePos) > this.TILE_SIZE)
         {
         ...
         var _loc10_:int;
         var _loc11_:int = (_loc10_ = this.rhtTilePos) + this.TILE_SIZE;
      ...
      protected function setIndexOfStgObjs() : void
      {
         ...
         if(this.flag && this.contains(this.flag))
         {
         ...
         if(this.playerGraphic && this.contains(this.playerGraphic))
         {
      ...
      public function scrollScreen() : void
      {
         ...
         if(!this.keepPlayerOnRight)
         {
            ...
            {
               if((_loc5_ = this.SND_MNGR.curMusicType) != MusicType.BOSS && _loc5_ != MusicType.FINAL_BOSS)
               {
                  if(this.worldNum != 8)
                  {
      ...
      public function changeChar(param1:Class) : void
      {
         ...
         var _loc5_:Number = this.player.vy;
         var _loc6_:Number = this.player.scaleX;
         var _loc7_:int = this.player.pState;
         var _loc8_:Boolean = this.player.upBtn;
         var _loc9_:Boolean = this.player.dwnBtn;
         var _loc10_:Boolean = this.player.lftBtn;
         _loc11_ = this.player.rhtBtn;
      ...
      public function loadArea(param1:String, param2:int) : void
      {
         ...
         if(this.ENEMY_SPAWNER_DCT.length)
         {
            for each(_loc5_ in this.ENEMY_SPAWNER_DCT)
            {
               _loc5_.disarm();
            }
         }
         ...
         this.destroyLevel();
         var _loc4_:String = this._fullLevStr.substr(0,3);
         this.SCRN_MNGR.loadNewArea(_loc4_,this._areaStr,param1,this.areaStatsArr);
      }
      ...
      private function loadNewLevel(param1:String) : void
      {
         var newLevel:String = param1;
         try
         {
         ...
         this.SCRN_MNGR.loadNewLevel(newLevel);
      }
      ...
      protected function completeLevel() : void
      {
         ...
         var _loc3_:String = String(_loc2_ + "-" + _loc1_);
         if(_loc3_ == CharacterSelect.FULL_LEVEL_STR)
         {
            _loc3_ = GameSettings.FIRST_LEVEL;
         }
         this.STAT_MNGR.passedHw = false;
         this.EVENT_MNGR.beatLevel(this._worldNum,this._levNum);
         this.loadNewLevel(_loc3_);
      }
