package com.smbc.level
{
   ...
   public class CharacterSelect extends Level implements IKeyPressable
   {
      ...
      public var levStrForTheme:String;
      ...
      public function CharacterSelect(param1:Boolean)
      {
         ...
         super(FULL_LEVEL_STR,LevelDataManager.getLevelData(MapPack.Smb),[],true);
         instance = this;
      ...
      {
         var _loc1_:String = LevelDataManager.currentLevelData.getMainArea(STAT_MNGR.curFullLevStr);
         this.levStrForTheme = STAT_MNGR.curFullLevStr.substr(0,3) + _loc1_;
         this.levTypeForTheme = LevelDataManager.currentLevelData.getType(this.levStrForTheme);
      ...
      override protected function gameLoop(param1:TimerEvent) : void
      {
         ...
         else if(this.choseChar == SOPHIA_CHAR_NUM)
         {
            ...
            if((_loc4_ = getChildIndex(_loc2_)) < _loc3_)
            {
      ...
      public function chooseCharacter(param1:int) : void
      {
         ...
         var _loc2_:int = player.classObj[END_TMR_DUR_VAR_NAME];
