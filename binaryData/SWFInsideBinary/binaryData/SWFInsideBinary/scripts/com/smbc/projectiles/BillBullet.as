   ...
   public class BillBullet extends Projectile
   {
      ...
      
      {
         function():void
         {
            ...
            OFS_ARR[OFS_CHAR_GB_IND] = [new Point(7,77),new Point(28,60),new Point(33,35),new Point(25,20),new Point(36,10),45,6,25,25,0,68,61,25,26,45];
         }();
      }
      ...
      {
         var _loc4_:Object;
         if(!((_loc4_ = OFS_ARR[param1][param2]) is Point))
         {
            return int(_loc4_);
         }
      ...
      public static function createLaser(param1:Bill) : void
      {
         ...
         (_loc4_ = new BillBullet(param1,TYPE_LASER)).laserActivate();
      ...
      {
         var _loc1_:int = 0;
         _loc1_ = this.bill.getOfsCharInd();
