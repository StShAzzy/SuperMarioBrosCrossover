package com.smbc.ground
{
   ...
   import com.smbc.pickups.Atom;
   import com.smbc.pickups.Clock;
   import com.smbc.pickups.ExplodingRabbitPowerup;
   import com.smbc.pickups.HammerPickup;
   import com.smbc.pickups.HudsonBee;
   import com.smbc.pickups.Mushroom;
   import com.smbc.pickups.Pickup;
   import com.smbc.pickups.Star;
   import com.smbc.pickups.Vine;
   import com.smbc.pickups.Wing;
   ...
   public class Brick extends Ground implements IAttackable
   {
      ...
      override function standingOnGround(param1:AnimatedObject) : void
      {
      ...
      {
         if(disabled || destroyed || param1.doesntHitBricks || param1.getProperty(PR_PASSTHROUGH_ALWAYS))
         {
            return;
         }
      ...
      public function breakBrick(param1:Boolean = false) : void
      {
         ...
         if(player is Ryu)
         {
            if((_loc6_ = player as Ryu).cState == Ryu.ST_CLIMB && (_loc6_.cancelGrappleGroundPos == hRht || _loc6_.cancelGrappleGroundPos == hLft))
            {
      ...
      override public function updateGround() : void
      {
         ...
         if(this.bouncing)
         {
            ...
            if(this.y >= this.yPos)
            {
               ...
               if(this.item && this.item != this.IT_MULTI_COIN)
               {
                  this.doneBouncing();
               }
            }
      ...
      override protected function removeListeners() : void
      {
         ...
         if(this.coinBrickTmr && this.coinBrickTmr.hasEventListener(TimerEvent.TIMER_COMPLETE))
         {
            this.coinBrickTmr.removeEventListener(TimerEvent.TIMER_COMPLETE,this.coinBrickTmrLsr);
         }
      }
      ...
      protected final function $animate(param1:ICustomTimer) : Boolean
      {
         return super.animate(param1);
      }
