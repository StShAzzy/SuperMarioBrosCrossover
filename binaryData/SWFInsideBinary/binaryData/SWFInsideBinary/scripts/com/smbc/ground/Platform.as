package com.smbc.ground
{
   ...
   public class Platform extends Ground
   {
      ...
      protected var fyPully:Number = 6.0E-4;
      ...
      public function Platform(param1:String = null, param2:String = null, param3:int = 0)
      {
         ...
         if(param1)
         {
            ...
            if((_loc7_ = param1.indexOf("&&",_loc6_)) == -1)
            {
         ...
         if(param1 && param1.indexOf("Cloud") == -1)
         {
         ...
         if(numChildren > 0)
         {
            ...
            {
               if((_loc9_ = DisplayObject(getChildAt(_loc8_))) is HRect)
               {
      ...
      private function updateAttachedObjects() : void
      {
         ...
         for(_loc1_ in this.attachedObjectsDct)
         {
            _loc6_;
            _loc2_ = _loc1_ as AnimatedObject;
            _loc3_ = this.attachedObjectsDct[_loc1_];
            _loc2_.ny = y;
            _loc2_.nx = x + _loc3_;
            _loc2_.drawObj();
         }
      ...
      override public function cleanUp() : void
      {
         ...
         if(level.platVec)
         {
            _loc1_ = level.platVec.indexOf(this);
            if(_loc1_ != -1)
            {
         ...
         {
            _loc1_ = level.pullyPlatVec.indexOf(this);
            if(_loc1_ != -1)
            {
