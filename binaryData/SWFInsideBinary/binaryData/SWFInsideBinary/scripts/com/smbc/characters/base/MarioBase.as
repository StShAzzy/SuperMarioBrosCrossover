package com.smbc.characters.base
{
   ...
   public class MarioBase extends Character
   {
      ...
      private const REPL_COLOR_1_1:uint = 4.292356096E9;
      
      private const REPL_COLOR_2_1:uint = 4.286277121E9;
      
      private const REPL_COLOR_3_1:uint = 4.29474412E9;
      
      private const REPL_COLOR_1_2:uint = 4.292356096E9;
      
      private const REPL_COLOR_2_2:uint = 4.286277121E9;
      
      private const REPL_COLOR_3_2:uint = 4.29474412E9;
      
      private const REPL_COLOR_1_3:uint = 4.294760616E9;
      
      private const REPL_COLOR_2_3:uint = 4.292356096E9;
      
      private const REPL_COLOR_3_3:uint = 4.29474412E9;
      ...
      private const RUN_TMR_1_MIN_VX:int = 165.0;
      ...
      private const BLOOPA_NO_HURT_Y:int = 416.0;
      ...
      override public function setCurrentBmdSkin(param1:BmdSkinCont, param2:Boolean = false) : void
      {
         ...
         else
         {
            ...
            if((_loc4_ = currentLabel) == this.convLab(FL_FALL_START) || _loc4_ == this.convLab(FL_FALL_END))
            {
