package com.smbc.characters
{
   ...
   public class Ryu extends Character
   {
      ...
      public static const SKIN_ORDER:Array = [SKIN_RYU_NES,SKIN_RYU_SNES,SKIN_RYU_GB,SKIN_RYU_SMS,SKIN_RYU_X1,SKIN_RYU_ATARI,SKIN_SHADOW_SNES,SKIN_HAGGLE_MAN_NES,SKIN_HAGGLE_MAN_SNES];
      ...
      private const REPL_COLOR_1_1:uint = 4.2838336E9;
      
      private const REPL_COLOR_2_1:uint = 4.287203747E9;
      
      private const REPL_COLOR_3_1:uint = 4.29495217E9;
      
      private const REPL_COLOR_1_2:uint = 4.2838336E9;
      
      private const REPL_COLOR_2_2:uint = 4.287795455E9;
      
      private const REPL_COLOR_3_2:uint = 4.29495217E9;
      
      private const REPL_COLOR_1_3:uint = 4.28114304E9;
      
      private const REPL_COLOR_2_3:uint = 4.28959797E9;
      
      private const REPL_COLOR_3_3:uint = 4.29495217E9;
      ...
      {
         super.initiate();
         var _loc1_:int = this.throwProjectileFramesArr.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      override public function pressJmpBtn() : void
      {
         ...
         var _loc1_:Platform = this.climbPlat;
      ...
      override public function pressAtkBtn() : void
      {
         ...
         {
            if(cState == ST_CLIMB && this.canThrowCurWeapon())
            {
               this.throwStar(PT_STAR_SMALL);
            }
            return;
         }
         super.pressAtkBtn();
      ...
      override public function pressSpcBtn() : void
      {
         ...
         else if(this.canThrowCurWeapon())
         {
            this.throwStar(PT_STAR_SMALL);
         }
      }
      ...
      private function throwStar(param1:String) : void
      {
         if(cState != ST_CLIMB)
         {
            if(onGround)
      ...
      private function canThrowCurWeapon() : String
      {
         if(level.PLAYER_PROJ_DCT.length > MAX_PROJECTILES_ON_SCREEN - 1)
         {
            return null;
         }
      ...
      override public function groundOnSide(param1:Ground, param2:String) : void
      {
         ...
         var _loc4_:Number;
         var _loc5_:Number = (_loc4_ = hBot - CLIMB_BOT_OFS) - CLIMB_BOT_MAX_GRAPPLE_INCREASE;
      ...
      {
         if(hasEnoughAmmo(AMMO_TYPE_NINJITSU,this.curSubWeapon))
         {
            level.addToLevel(new RyuProjectile(this,param1));
            decAmmo(AMMO_TYPE_NINJITSU,this.curSubWeapon);
         }
      }
      ...
      override public function checkFrame() : void
      {
         ...
         {
            _loc3_ = this.canThrowCurWeapon();
            if(_loc3_ && GS_MNGR.gameState == GS_PLAY)
            {
