package com.smbc.characters
{
   ...
   public class Bass extends MegaManBase
   {
      ...
      public static const OBTAINABLE_UPGRADES_ARR:Array = [[MM_SUPER_ARM,MM_HARD_KNUCKLE,MM_PHARAOH_SHOT,MM_CHARGE_KICK,MM_FLAME_BLAST,MM_WATER_SHIELD,MM_SCREW_CRUSHER]];
      
      public static const START_WITH_UPGRADES:Array = [];
      
      public static const MUSHROOM_UPGRADES:Array = [];
      
      public static const NEVER_LOSE_UPGRADES:Array = [MM_ENERGY_BALANCER,MM_SUPER_ARM,MM_METAL_BLADE,MM_HARD_KNUCKLE,MM_PHARAOH_SHOT,MM_CHARGE_KICK,MM_FLAME_BLAST,MM_WATER_SHIELD,MM_SCREW_CRUSHER];
      ...
      public static const AMMO_DEPLETION_ARR:Array = [[MM_SUPER_ARM,8],[MM_METAL_BLADE,2],[MM_HARD_KNUCKLE,8],[MM_PHARAOH_SHOT,4],[MegaManProjectile.TYPE_PHARAOH_BALLOON,8],[MM_CHARGE_KICK,4],[MM_FLAME_BLAST,4],[MM_MAGMA_BAZOOKA,4],[MegaManProjectile.TYPE_MAGMA_BAZOOKA_CHARGE,8],[MM_WATER_SHIELD,16],[MM_SCREW_CRUSHER,2]];
      ...
      public static const SKIN_ORDER:Array = [SKIN_BASS_NES,SKIN_BASS_SNES,SKIN_BASS_GB,SKIN_BASS_X1,SKIN_BASS_ATARI,SKIN_DR_WILY_NES,SKIN_DR_WILY_SNES,SKIN_MR_X_NES,SKIN_MR_X_SNES,SKIN_DR_COSSACK_NES,SKIN_DR_COSSACK_SNES,SKIN_QUICK_MAN_NES,SKIN_QUICK_MAN_SNES,SKIN_GEMINI_MAN_NES,SKIN_GEMINI_MAN_SNES];
