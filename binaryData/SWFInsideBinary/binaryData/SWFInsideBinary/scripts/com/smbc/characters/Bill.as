package com.smbc.characters
{
   ...
   public class Bill extends Character
   {
      ...
      public static const SKIN_ORDER:Array = [SKIN_BILL_NES,SKIN_BILL_SNES,SKIN_BILL_16_BIT,SKIN_BILL_GB,SKIN_BILL_X1,SKIN_BILL_ATARI,SKIN_LANCE_NES,SKIN_LANCE_SNES,SKIN_LANCE_16_BIT,SKIN_LANCE_GB,SKIN_RD_008_NES,SKIN_RD_008_GB,SKIN_RC_011_NES,SKIN_RC_011_GB];
      ...
      private const REPL_COLOR_1_1:uint = 4.279843211E9;
      
      private const REPL_COLOR_2_1:uint = 4.294457344E9;
      
      private const REPL_COLOR_3_1:uint = 4.294954694E9;
      
      private const REPL_COLOR_1_2:uint = 4.278212856E9;
      
      private const REPL_COLOR_2_2:uint = 4.294457344E9;
      
      private const REPL_COLOR_3_2:uint = 4.294954694E9;
      
      private const REPL_COLOR_1_3:uint = 4.29490176E9;
      
      private const REPL_COLOR_2_3:uint = 4.294457344E9;
      
      private const REPL_COLOR_3_3:uint = 4.294954694E9;
      ...
      override protected function mcReplacePrep(param1:MovieClip) : void
      {
         ...
         while(_loc4_ < param1.numChildren)
         {
            ...
            {
               if((_loc7_ = (_loc6_ = _loc5_ as MovieClip).totalFrames) == this.legs.totalFrames)
               {
                  _loc2_ = _loc6_;
               }
      ...
      override public function pressAtkBtn() : void
      {
         ...
         else if(upgradeIsActive(BILL_SPREAD))
         {
            ...
            _loc1_ = BillBullet.TYPE_SPREAD;
            this.shoot();
            _loc2_ = new BillBullet(this,_loc1_);
            _loc3_ = new BillBullet(this,_loc1_);
            _loc4_ = new BillBullet(this,_loc1_);
            _loc5_ = new BillBullet(this,_loc1_);
            _loc6_ = new BillBullet(this,_loc1_);
      ...
      public function moveTorsoUp(param1:Boolean = true) : void
      {
         ...
         if(currentLabel == "main")
         {
            _loc2_ = this._torso.currentLabel.indexOf(STR_SHOOT);
      ...
      override protected function removeListeners() : void
      {
         ...
         if(this.mGunTmr && this.mGunTmr.hasEventListener(TimerEvent.TIMER))
         {
