package com.smbc.characters
{
   ...
   public class Simon extends Character
   {
      ...
      public static const SKIN_CHRIS_GB:int = 2;
      ...
      override public function chooseCharacter() : void
      {
         ...
         var _loc5_:CharacterSequencer;
         (_loc5_ = new CharacterSequencer()).startNewSequence(this.CHOOSE_CHAR_SEQ);
      }
      ...
      override public function hitPickup(param1:Pickup, param2:Boolean = true) : void
      {
         ...
         {
            if(_loc3_ == SIMON_HEART_BIG || _loc3_ == SIMON_HEART_SMALL)
            {
      ...
      private function canThrow() : String
      {
         if(!this.curSubWeapon || !hasEnoughAmmo(AMMO_TYPE_HEARTS,this.curSubWeapon))
         {
            return null;
         }
         var _loc1_:int = 1;
         ...
         if(level.PLAYER_PROJ_DCT.length >= _loc1_)
         {
            return null;
         }
      ...
      override public function checkFrame() : void
      {
         ...
         else if(cState == ST_ATTACK)
         {
            ...
            if(_loc1_ == convLab(FL_THROW_END) || _loc1_ == convLab(FL_CROUCH_THROW_END))
            {
               ...
               if(_loc3_)
               {
                  decAmmo(AMMO_TYPE_HEARTS,this.curSubWeapon);
