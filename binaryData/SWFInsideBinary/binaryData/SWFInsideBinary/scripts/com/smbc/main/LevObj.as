package com.smbc.main
{
   ...
   public class LevObj extends SkinObj implements IInitiater, IHitTestable, IAnimated
   {
      ...
      protected function stopAllEnemiesPropActivateHandler(param1:Event) : void
      {
         ...
         if(this.hitTestTypesDct[HT_ENEMY] || this.hitTestTypesDct[HT_PROJECTILE_ENEMY])
         {
      ...
      override public function initiate() : void
      {
         ...
         if(player)
         {
            ...
            if(_loc1_ && this.isSusceptibleToProperty(_loc1_))
            {
      ...
      {
         var _loc2_:int = this.fLabVec.length;
         var _loc3_:uint = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      public function addReasonOvRd(param1:String, param2:*, param3:String) : void
      {
         ...
         if((_loc4_ = this.reasonOvRdObj[param1])[param2] == undefined)
         {
            _loc4_[param2] = new CustomDictionary();
         }
         var _loc5_:CustomDictionary;
         (_loc5_ = _loc4_[param2]).addItem(param3);
         var _loc6_:Function;
         if((_loc6_ = this[param1]) is Function)
         {
            _loc6_();
         }
      }
      ...
      public function removeReasonOvRd(param1:String, param2:*, param3:String) : void
      {
         ...
         var _loc4_:Function;
         if((_loc4_ = this[param1]) is Function)
         {
            _loc4_();
         }
      }
      ...
      private function updPropOrderVec() : void
      {
         ...
         this.propAggOrderVec.fixed = false;
         this.propAggOrderVec.length = 0;
         var _loc1_:int = PROP_ORDER_REFERENCE.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
