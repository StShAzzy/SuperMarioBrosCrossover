package com.smbc.enemies
{
   ...
   public class HammerBro extends Enemy
   {
      ...
      public function HammerBro(param1:String = null, param2:Boolean = false)
      {
         ...
         if(param1 && param1.indexOf("enemyHamBroBlue") != -1)
         {
            colorNum = 2;
         }
         else
      ...
      override protected function removeListeners() : void
      {
         ...
         if(this.JUMP_TMR && this.JUMP_TMR.hasEventListener(TimerEvent.TIMER_COMPLETE))
         {
            this.JUMP_TMR.removeEventListener(TimerEvent.TIMER_COMPLETE,this.jumpTmrLsr);
         }
         if(this.HAMMER_TMR && this.HAMMER_TMR.hasEventListener(TimerEvent.TIMER_COMPLETE))
         {
            this.HAMMER_TMR.removeEventListener(TimerEvent.TIMER_COMPLETE,this.hammerTmrLsr);
         }
         if(this.HAMMER_DEL_TMR && this.HAMMER_DEL_TMR.hasEventListener(TimerEvent.TIMER_COMPLETE))
         {
