package com.smbc.graphics.skins
{
   ...
   public class BmdInfo
   {
      ...
      public static const NUM_SKIN_SETS:int = 16;
      ...
      public static const SKIN_NUM_ATARI:int = 8;
      ...
      
      {
         ...
         BMC_VEC.push(new BmdSkinCont(new Map007(),7,ST_MAP,null,null,CT_8B,[Mario.CHAR_NUM],[Games.superMarioBros,Games.superMarioBrosSnes,Games.superMarioBrosDeluxe,Games.superMarioBros]));
         BMC_VEC.push(new BmdSkinCont(new Map008(),8,ST_MAP,null,null,CT_8B,[Mario.CHAR_NUM],[Games.superMarioBrosAtari,Games.superMarioBrosAtari,Games.superMarioBrosAtari,Games.superMarioBros]));
         ...
         BMC_VEC.push(new BmdSkinCont(new Map011(),11,ST_MAP,null,null,CT_8B,[Mario.CHAR_NUM],[Games.superMarioBros,Games.superMarioBrosSnes,Games.superMarioBrosDeluxe,Games.superMarioBros]));
         BMC_VEC.push(new BmdSkinCont(new Map012(),12,ST_MAP,null,null,CT_8B,[Mario.CHAR_NUM],[Games.superMarioBros2,Games.superMarioBros2Snes,Games.superMarioLand2,Games.superMarioBros2]));
         BMC_VEC.push(new BmdSkinCont(new Map013(),13,ST_MAP,null,null,CT_16B,[Mario.CHAR_NUM],[Games.superMarioBros2,Games.superMarioBros2Snes,Games.superMarioLand2,Games.superMarioBros2Snes]));
         BMC_VEC.push(new BmdSkinCont(new Map014(),14,ST_MAP,null,null,CT_8B,[Mario.CHAR_NUM],[Games.superMarioBrosSpecial,Games.superMarioBrosSnes,Games.superMarioBrosDeluxe,Games.superMarioBrosSpecial]));
         ...
         BMC_VEC.push(new BmdSkinCont(new Bass003(),3,ST_CHAR,null,null,CT_8B,[Bass.CHAR_NUM],[Games.megaMan2,Games.megaManAndBass,Games.megaMan5Gb,Games.megaMan],["Dr. Wily","Dr. Wily","Bass"],null));
         BMC_VEC.push(new BmdSkinCont(new Bass004(),4,ST_CHAR,null,null,CT_16B,[Bass.CHAR_NUM],[Games.megaMan2,Games.megaManAndBass,Games.megaMan5Gb,Games.megaMan],["Dr. Wily","Dr. Wily","Bass"],null));
         BMC_VEC.push(new BmdSkinCont(new Bass005(),5,ST_CHAR,null,null,CT_8B,[Bass.CHAR_NUM],[Games.megaMan6,Games.megaMan7,Games.megaMan5Gb,Games.megaMan6],["Mr. X","Mr. X","Bass"],null));
         BMC_VEC.push(new BmdSkinCont(new Bass006(),6,ST_CHAR,null,null,CT_16B,[Bass.CHAR_NUM],[Games.megaMan6,Games.megaMan7,Games.megaMan5Gb,Games.megaMan6],["Mr. X","Mr. X","Bass"],null));
         BMC_VEC.push(new BmdSkinCont(new Bass007(),7,ST_CHAR,null,null,CT_8B,[Bass.CHAR_NUM],[Games.megaMan2,Games.megaMan7,Games.megaManGb,Games.megaMan2],["Quick Man","Quick Man","Dr. Wily"],null,null,SkinDescriptions.QUICK_MAN));
         BMC_VEC.push(new BmdSkinCont(new Bass008(),8,ST_CHAR,null,null,CT_16B,[Bass.CHAR_NUM],[Games.megaMan2,Games.megaMan7,Games.megaManGb,Games.megaManWilyWars],["Quick Man","Quick Man","Dr. Wily"],null,null,SkinDescriptions.QUICK_MAN));
         ...
         BMC_VEC.push(new BmdSkinCont(new Bass012(),12,ST_CHAR,null,null,CT_8B,[Bass.CHAR_NUM],[Games.megaMan10,Games.megaMan7,Games.megaManGb,Games.megaMan10],[null,null,"Dr. Wily"],null));
         BMC_VEC.push(new BmdSkinCont(new Bass013(),13,ST_CHAR,null,null,CT_8B,[Bass.CHAR_NUM],[Games.megaMan3,Games.megaMan7,Games.megaManGb,Games.megaMan3],["Gemini Man","Gemini Man","Dr. Wily"],null));
         BMC_VEC.push(new BmdSkinCont(new Bass014(),14,ST_CHAR,null,null,CT_16B,[Bass.CHAR_NUM],[Games.megaMan3,Games.megaMan7,Games.megaManGb,Games.megaManWilyWars],["Gemini Man","Gemini Man","Dr. Wily"],null));
         addCharPalette(bill_palette,Bill.CHAR_NUM);
         BMC_VEC.push(new BmdSkinCont(new Bill000(),0,ST_CHAR,null,null,CT_8B,[Bill.CHAR_NUM],[Games.contra,Games.contra3Snes,Games.operationC,Games.contra],[null,null,"your buddy"],null));
         BMC_VEC.push(new BmdSkinCont(new Bill001(),1,ST_CHAR,null,null,CT_16B,[Bill.CHAR_NUM],[Games.contra,Games.contra3Snes,Games.operationC,Games.contra],[null,null,"your buddy"],null));
         BMC_VEC.push(new BmdSkinCont(new Bill002(),2,ST_CHAR,null,null,CT_GB,[Bill.CHAR_NUM],[Games.contra,Games.contra3Snes,Games.operationC,Games.operationC],[null,null,"your buddy"],null));
         BMC_VEC.push(new BmdSkinCont(new Bill003(),3,ST_CHAR,null,null,CT_8B,[Bill.CHAR_NUM],[Games.superC,Games.contra3Snes,Games.operationC,Games.contra],["Lance Bean","Lance","your buddy"],null));
         BMC_VEC.push(new BmdSkinCont(new Bill004(),4,ST_CHAR,null,null,CT_16B,[Bill.CHAR_NUM],[Games.superC,Games.contra3Snes,Games.operationC,Games.contra],["Lance Bean","Lance","your buddy"],null));
         BMC_VEC.push(new BmdSkinCont(new Bill005(),5,ST_CHAR,null,null,CT_GB,[Bill.CHAR_NUM],[Games.superC,Games.contra3Snes,Games.operationC,Games.operationC],["Lance Bean","Lance","your buddy"],null));
         BMC_VEC.push(new BmdSkinCont(new Bill006(),6,ST_CHAR,null,null,CT_8B,[Bill.CHAR_NUM],[Games.contra,Games.contra3Snes,Games.operationC,Games.probotector],["RD-008","RD-008","your buddy"],null));
         BMC_VEC.push(new BmdSkinCont(new Bill007(),7,ST_CHAR,null,null,CT_8B,[Bill.CHAR_NUM],[Games.contra,Games.contra3Snes,Games.operationC,Games.probotector],["RC-011","RC-011","your buddy"],null));
         BMC_VEC.push(new BmdSkinCont(new Bill008(),8,ST_CHAR,null,null,CT_16B,[Bill.CHAR_NUM],[Games.contra,Games.contra3Snes,Games.operationC,Games.contra],[null,null,"your buddy"],null));
         BMC_VEC.push(new BmdSkinCont(new Bill009(),9,ST_CHAR,null,null,CT_16B,[Bill.CHAR_NUM],[Games.contra,Games.contra3Snes,Games.operationC,Games.contra],["Lance Bean","Lance","your buddy"],null));
         BMC_VEC.push(new BmdSkinCont(new Bill010(),10,ST_CHAR,null,null,CT_8B,[Bill.CHAR_NUM],[Games.superMarioBrosAtari,Games.superMarioBrosAtari,Games.superMarioBrosAtari,Games.contra],[null,null,"your buddy"],null));
         BMC_VEC.push(new BmdSkinCont(new Bill011(),11,ST_CHAR,null,null,CT_8B,[Bill.CHAR_NUM],[Games.contra,Games.contra3Snes,Games.operationC,Games.contra],[null,null,"your buddy"],null));
         BMC_VEC.push(new BmdSkinCont(new Bill012(),12,ST_CHAR,null,null,CT_GB,[Bill.CHAR_NUM],[Games.contra,Games.contra3Snes,Games.operationC,Games.probotectorGb],["RD-008","RD-008","your buddy"],null));
         BMC_VEC.push(new BmdSkinCont(new Bill013(),13,ST_CHAR,null,null,CT_GB,[Bill.CHAR_NUM],[Games.contra,Games.contra3Snes,Games.operationC,Games.probotectorGb],["RC-011","RC-011","your buddy"],null));
         ...
         BMC_VEC.push(new BmdSkinCont(new Link005(),5,ST_CHAR,null,null,CT_GB,[Link.CHAR_NUM],[Games.zeldaAdventureOfLink,Games.zeldaBs,Games.zeldaLinksAwakening,Games.zeldaAdventureOfLink],["Dark Link","Dark Link","Nightmare Ganon"],null));
         BMC_VEC.push(new BmdSkinCont(new Link006(),6,ST_CHAR,null,null,CT_8B,[Link.CHAR_NUM],[Games.zelda,Games.zeldaLinkToThePast,Games.zeldaLinksAwakening,Games.zelda],["Old Man","Old Man","your wife"],null));
         BMC_VEC.push(new BmdSkinCont(new Link007(),7,ST_CHAR,null,null,CT_8B,[Link.CHAR_NUM],[Games.zelda,Games.zeldaLinkToThePast,Games.zeldaLinksAwakening,Games.zelda],["Princess Zelda","Zelda","Link"],null));
         ...
         BMC_VEC.push(new BmdSkinCont(new Link013(),13,ST_CHAR,null,null,CT_8B,[Link.CHAR_NUM],[Games.dragonWarrior,Games.dragonWarriorSnes,Games.zeldaLinksAwakening,Games.dragonWarrior],["Erdrick","Erdrick","Princess Gwaelin"],null));
         ...
         BMC_VEC.push(new BmdSkinCont(new Link015(),15,ST_CHAR,null,null,CT_16B,[Link.CHAR_NUM],[Games.zelda,Games.zeldaLinkToThePast,Games.zeldaLinksAwakening,Games.zeldaBs],["Princess Zelda","Zelda","Link"],null));
         ...
         BMC_VEC.push(new BmdSkinCont(new Link017(),17,ST_CHAR,null,null,CT_GB,[Link.CHAR_NUM],[Games.zelda,Games.zeldaLinkToThePast,Games.zeldaOracleOfSeasons,Games.zeldaOracleOfSeasons],["Princess Zelda","Zelda","Link"],null));
         BMC_VEC.push(new BmdSkinCont(new Link018(),18,ST_CHAR,null,null,CT_GB,[Link.CHAR_NUM],[Games.dragonWarrior,Games.dragonWarriorSnes,Games.dragonWarrior,Games.dragonWarriorGb],["Loto","Loto","Lady Laura"],null));
         BMC_VEC.push(new BmdSkinCont(new Link019(),19,ST_CHAR,null,null,CT_16B,[Link.CHAR_NUM],[Games.dragonWarrior,Games.dragonWarriorSnes,Games.dragonWarrior,Games.dragonWarriorSnes],["Roto","Roto","Lady Lora"],null));
         addCharPalette(luigi_palette,Luigi.CHAR_NUM);
         BMC_VEC.push(new BmdSkinCont(new Luigi000(),0,ST_CHAR,null,null,CT_8B,[Luigi.CHAR_NUM],[Games.superMarioBrosLostLevels,Games.superMarioBrosSnes,Games.superMarioBrosDeluxe,Games.superMarioBrosDeluxe]));
         BMC_VEC.push(new BmdSkinCont(new Luigi001(),1,ST_CHAR,null,null,CT_16B,[Luigi.CHAR_NUM],[Games.superMarioBrosLostLevels,Games.superMarioBrosSnes,Games.superMarioBrosDeluxe,Games.superMarioBrosSnes]));
         BMC_VEC.push(new BmdSkinCont(new Luigi002(),2,ST_CHAR,null,null,CT_GB,[Luigi.CHAR_NUM],[Games.superMarioBrosLostLevels,Games.superMarioBrosSnes,Games.superMarioLand2,Games.superMarioLand2]));
         BMC_VEC.push(new BmdSkinCont(new Luigi003(),3,ST_CHAR,null,null,CT_8B,[Luigi.CHAR_NUM],[Games.superMarioBros3,Games.superMarioBrosSnes,Games.superMarioLand2,Games.superMarioBros3]));
         BMC_VEC.push(new BmdSkinCont(new Luigi004(),4,ST_CHAR,null,null,CT_8B,[Luigi.CHAR_NUM],[Games.superMarioBros2,Games.superMarioBros2Snes,Games.superMarioLand2,Games.superMarioBros2],[null,null,"the Subcon"],null));
         BMC_VEC.push(new BmdSkinCont(new Luigi005(),5,ST_CHAR,null,null,CT_16B,[Luigi.CHAR_NUM],[Games.superMarioBros2,Games.superMarioBros2Snes,Games.superMarioLand2,Games.superMarioBros2Snes],[null,null,"the Subcon"],null));
         BMC_VEC.push(new BmdSkinCont(new Luigi006(),6,ST_CHAR,null,null,CT_16B,[Luigi.CHAR_NUM],[Games.superMarioBros2,Games.superMarioWorld,Games.superMarioLand2,Games.superMarioWorld]));
         BMC_VEC.push(new BmdSkinCont(new Luigi007(),7,ST_CHAR,null,null,CT_16B,[Luigi.CHAR_NUM],[Games.superMarioBros3,Games.superMarioBros3Snes,Games.superMarioLand2,Games.superMarioBros3Snes]));
         BMC_VEC.push(new BmdSkinCont(new Luigi008(),8,ST_CHAR,null,null,CT_8B,[Luigi.CHAR_NUM],[Games.superMarioBros2,Games.superMarioBros2Snes,Games.superMarioLand2,Games.superMarioBros2],["Princess Toadstool","Toadstool","the Subcon"],null));
         BMC_VEC.push(new BmdSkinCont(new Luigi009(),9,ST_CHAR,null,null,CT_8B,[Luigi.CHAR_NUM],[Games.superMarioBrosAtari,Games.superMarioBrosAtari,Games.superMarioBrosAtari,Games.superMarioBros],[null,null,null],null));
         BMC_VEC.push(new BmdSkinCont(new Luigi010(),10,ST_CHAR,null,null,CT_16B,[Luigi.CHAR_NUM],[Games.superMarioBros2,Games.superMarioBros2Snes,Games.superMarioLand2,Games.superMarioBros2Snes],["Princess Toadstool","Toadstool","the Subcon"],null));
         BMC_VEC.push(new BmdSkinCont(new Luigi011(),11,ST_CHAR,null,null,CT_8B,[Luigi.CHAR_NUM],[Games.superMarioBrosLostLevels,Games.superMarioBros2Snes,Games.superMarioBrosDeluxe,Games.superMarioBros],[null,null,null],null));
         BMC_VEC.push(new BmdSkinCont(new Luigi012(),12,ST_CHAR,null,null,CT_GB,[Luigi.CHAR_NUM],[Games.superMarioBrosLostLevels,Games.superMarioBrosSnes,Games.superMarioLand2,Games.superMarioLand2],["Space Luigi",null,null],null));
         ...
         BMC_VEC.push(new BmdSkinCont(new Mario007(),7,ST_CHAR,null,null,CT_8B,[Mario.CHAR_NUM],[Games.superMarioBros2,Games.superMarioBros2Snes,Games.superMarioLand2,Games.superMarioBros2],[null,null,"the Subcon"],null));
         BMC_VEC.push(new BmdSkinCont(new Mario008(),8,ST_CHAR,null,null,CT_16B,[Mario.CHAR_NUM],[Games.superMarioBros2,Games.superMarioBros2Snes,Games.superMarioLand2,Games.superMarioBros2Snes],[null,null,"the Subcon"],null));
         ...
         BMC_VEC.push(new BmdSkinCont(new Mario010(),10,ST_CHAR,null,null,CT_8B,[Mario.CHAR_NUM],[Games.superMarioBros2,Games.superMarioBros2Snes,Games.superMarioLand2,Games.superMarioBros2],["Toad","Toad","the Subcon"]));
         ...
         BMC_VEC.push(new BmdSkinCont(new Mario012(),12,ST_CHAR,null,null,CT_16B,[Mario.CHAR_NUM],[Games.superMarioBros2,Games.superMarioBros2Snes,Games.superMarioLand2,Games.superMarioBros2Snes],["Toad","Toad","the Subcon"]));
         BMC_VEC.push(new BmdSkinCont(new Mario013(),13,ST_CHAR,null,null,CT_8B,[Mario.CHAR_NUM],[Games.superMarioBros,Games.superMarioBrosSnes,Games.superMarioBrosDeluxe,Games.superMarioBrosSpecial],[null,null,null]));
         ...
         BMC_VEC.push(new BmdSkinCont(new MegaMan000(),0,ST_CHAR,null,null,CT_8B,[MegaMan.CHAR_NUM],[Games.megaMan,Games.megaMan7,Games.megaMan3Gb,Games.megaMan],[null,null,"Dr. Light"],null));
         BMC_VEC.push(new BmdSkinCont(new MegaMan001(),1,ST_CHAR,null,null,CT_16B,[MegaMan.CHAR_NUM],[Games.megaMan,Games.megaMan7,Games.megaMan3Gb,Games.megaMan],[null,null,"Dr. Light"],null));
         BMC_VEC.push(new BmdSkinCont(new MegaMan002(),2,ST_CHAR,null,null,CT_GB,[MegaMan.CHAR_NUM],[Games.megaMan,Games.megaMan7,Games.megaMan3Gb,Games.rockManBattleAndFighters],[null,null,"Dr. Light"],null));
         BMC_VEC.push(new BmdSkinCont(new MegaMan003(),3,ST_CHAR,null,null,CT_8B,[MegaMan.CHAR_NUM],[Games.megaMan5,Games.megaMan7,Games.megaMan4Gb,Games.megaMan3],[MegaManBase.PROTO_MAN_NAME,MegaManBase.PROTO_MAN_NAME,"Roll"],null,null,SkinDescriptions.PROTO_MAN));
         BMC_VEC.push(new BmdSkinCont(new MegaMan004(),4,ST_CHAR,null,null,CT_16B,[MegaMan.CHAR_NUM],[Games.megaMan5,Games.megaMan7,Games.megaMan4Gb,Games.megaMan3],[MegaManBase.PROTO_MAN_NAME,MegaManBase.PROTO_MAN_NAME,"Roll"],null,null,SkinDescriptions.PROTO_MAN));
         BMC_VEC.push(new BmdSkinCont(new MegaMan005(),5,ST_CHAR,null,null,CT_GB,[MegaMan.CHAR_NUM],[Games.megaMan5,Games.megaMan7,Games.megaMan4Gb,Games.rockManBattleAndFighters],[MegaManBase.PROTO_MAN_NAME,MegaManBase.PROTO_MAN_NAME,"Roll"],null,null,SkinDescriptions.PROTO_MAN));
         BMC_VEC.push(new BmdSkinCont(new MegaMan006(),6,ST_CHAR,null,null,CT_8B,[MegaMan.CHAR_NUM],[Games.megaMan9,Games.megaMan7,Games.megaMan3Gb,Games.megaMan9],[null,null,"Dr. Light"],null));
         BMC_VEC.push(new BmdSkinCont(new MegaMan007(),7,ST_CHAR,null,null,CT_16B,[MegaMan.CHAR_NUM],[Games.megaMan9,Games.megaMan7,Games.megaMan3Gb,Games.megaMan9],[null,null,"Dr. Light"],null));
         BMC_VEC.push(new BmdSkinCont(new MegaMan008(),8,ST_CHAR,null,null,CT_8B,[MegaMan.CHAR_NUM],[Games.megaMan3,Games.megaMan7,Games.megaMan4Gb,Games.megaMan3],["Break Man","Break Man","Roll"],null,null,SkinDescriptions.PROTO_MAN));
         BMC_VEC.push(new BmdSkinCont(new MegaMan009(),9,ST_CHAR,null,null,CT_16B,[MegaMan.CHAR_NUM],[Games.megaMan3,Games.megaMan7,Games.megaMan4Gb,Games.megaMan3],["Break Man","Break Man","Roll"],null,null,SkinDescriptions.PROTO_MAN));
         BMC_VEC.push(new BmdSkinCont(new MegaMan010(),10,ST_CHAR,null,null,CT_8B,[MegaMan.CHAR_NUM],[Games.megaMan,Games.megaMan7,Games.megaMan3Gb,Games.rockManMobile],["Roll","Roll","your brother"],null));
         BMC_VEC.push(new BmdSkinCont(new MegaMan011(),11,ST_CHAR,null,null,CT_8B,[MegaMan.CHAR_NUM],[Games.megaMan10,Games.megaManAndBass,Games.megaMan5Gb,Games.rokkoChan],["Rokko Chan","Rokko Chan","Professor Thane"],null,null,SkinDescriptions.ROKKO_CHAN));
         BMC_VEC.push(new BmdSkinCont(new MegaMan012(),12,ST_CHAR,null,null,CT_8B,[MegaMan.CHAR_NUM],[Games.megaMan9,Games.megaMan7,Games.megaMan3Gb,Games.megaMan],["Dr. Light","Dr. Light","Rock"],null));
         BMC_VEC.push(new BmdSkinCont(new MegaMan013(),13,ST_CHAR,null,null,CT_8B,[MegaMan.CHAR_NUM],[Games.megaMan,Games.megaMan7,Games.megaMan3Gb,Games.megaMan],["Cut Man","Cut Man","Dr. Light"],null,null,SkinDescriptions.CUT_MAN));
         BMC_VEC.push(new BmdSkinCont(new MegaMan014(),14,ST_CHAR,null,null,CT_8B,[MegaMan.CHAR_NUM],[Games.megaMan,Games.megaMan7,Games.megaMan3Gb,Games.megaMan],["Ice Man","Ice Man","Dr. Light"],null,null,SkinDescriptions.ICE_MAN));
         ...
         BMC_VEC.push(new BmdSkinCont(new MegaMan016(),16,ST_CHAR,null,null,CT_8B,[MegaMan.CHAR_NUM],[Games.megaMan,Games.megaMan7,Games.megaMan3Gb,Games.megaMan],["Rock","Rock","Dr. Light"],null,null,SkinDescriptions.ROCK));
         BMC_VEC.push(new BmdSkinCont(new MegaMan017(),17,ST_CHAR,null,null,CT_16B,[MegaMan.CHAR_NUM],[Games.megaMan,Games.megaMan7,Games.megaMan3Gb,Games.megaMan],["Rock","Rock","Dr. Light"],null,null,SkinDescriptions.ROCK));
         BMC_VEC.push(new BmdSkinCont(new MegaMan018(),18,ST_CHAR,null,null,CT_8B,[MegaMan.CHAR_NUM],[Games.megaMan,Games.megaMan7,Games.megaMan3Gb,Games.megaMan],[null,null,"Dr. Light"],null));
         BMC_VEC.push(new BmdSkinCont(new MegaMan019(),19,ST_CHAR,null,null,CT_GB,[MegaMan.CHAR_NUM],[Games.megaMan3,Games.megaMan7,Games.megaMan4Gb,Games.rockManBattleAndFighters],["Break Man","Break Man","Roll"],null,null,SkinDescriptions.PROTO_MAN));
         BMC_VEC.push(new BmdSkinCont(new MegaMan020(),20,ST_CHAR,null,null,CT_GB,[MegaMan.CHAR_NUM],[Games.megaMan,Games.megaMan7,Games.megaMan3Gb,Games.rockManBattleAndFighters],[null,null,"Dr. Light"],null));
         addCharPalette(ryu_palette,Ryu.CHAR_NUM);
         BMC_VEC.push(new BmdSkinCont(new Ryu000(),0,ST_CHAR,null,null,CT_8B,[Ryu.CHAR_NUM],[Games.ninjaGaiden,Games.ninjaGaidenSnes,Games.ninjaGaidenShadow,Games.ninjaGaiden],[null,null,"the Dragon Sword"]));
         BMC_VEC.push(new BmdSkinCont(new Ryu001(),1,ST_CHAR,null,null,CT_16B,[Ryu.CHAR_NUM],[Games.ninjaGaiden,Games.ninjaGaidenSnes,Games.ninjaGaidenShadow,Games.ninjaGaiden],[null,null,"the Dragon Sword"]));
         BMC_VEC.push(new BmdSkinCont(new Ryu002(),2,ST_CHAR,null,null,CT_GB,[Ryu.CHAR_NUM],[Games.ninjaGaiden,Games.ninjaGaidenSnes,Games.ninjaGaidenShadow,Games.ninjaGaidenShadow],[null,null,"the Dragon Sword"]));
         BMC_VEC.push(new BmdSkinCont(new Ryu003(),3,ST_CHAR,null,null,CT_8B,[Ryu.CHAR_NUM],[Games.ninjaGaidenSms,Games.ninjaGaidenSms,Games.ninjaGaidenShadow,Games.haggleMan3],["Haggle Man","Haggle Man","Koume"],null,null,SkinDescriptions.HAGGLE_MAN));
         BMC_VEC.push(new BmdSkinCont(new Ryu004(),4,ST_CHAR,null,null,CT_16B,[Ryu.CHAR_NUM],[Games.ninjaGaidenSms,Games.ninjaGaidenSms,Games.ninjaGaidenShadow,Games.haggleMan3],["Haggle Man","Haggle Man","Koume"],null,null,SkinDescriptions.HAGGLE_MAN));
         ...
         BMC_VEC.push(new BmdSkinCont(new Ryu006(),6,ST_CHAR,null,null,CT_8B,[Ryu.CHAR_NUM],[Games.ninjaGaiden,Games.ninjaGaidenSnes,Games.ninjaGaidenShadow,Games.ninjaGaiden],[null,null,"the Dragon Sword"]));
         BMC_VEC.push(new BmdSkinCont(new Ryu007(),7,ST_CHAR,null,null,CT_8B,[Ryu.CHAR_NUM],[Games.superMarioBrosAtari,Games.superMarioBrosAtari,Games.superMarioBrosAtari,Games.ninjaGaiden],[null,null,"the Dragon Sword"],null));
         BMC_VEC.push(new BmdSkinCont(new Ryu008(),8,ST_CHAR,null,null,CT_8B,[Ryu.CHAR_NUM],[Games.ninjaGaidenSms,Games.ninjaGaidenSnes,Games.ninjaGaidenShadow,Games.ninjaGaidenSms],[null,null,"the Dragon Sword"],null));
         ...
         BMC_VEC.push(new BmdSkinCont(new Samus006(),6,ST_CHAR,null,null,CT_8B,[Samus.CHAR_NUM],[Games.kidIcarus,Games.kidIcarus,Games.kidIcarus,Games.kidIcarus],["Pit","Pit","Palutena"],Samus.skinSettingsWrite(22,true,false,true,false,SoundNames.SFX_PIT_SHOOT,SoundNames.SFX_PIT_JUMP),null,SkinDescriptions.PIT));
         ...
         BMC_VEC.push(new BmdSkinCont(new Sophia008(),8,ST_CHAR,null,null,CT_8B,[Sophia.CHAR_NUM],[Games.blasterMaster,Games.blasterMasterSnes,Games.blasterMasterEnemyBelow,Games.blasterMaster],[null,null,"your frog"],null));
      ...
      public static function initiate() : void
      {
         ...
         {
            _loc2_ = HIDE_TOP_CASTLES[_loc1_];
      ...
      private static function addMainPalette(param1:Class) : void
      {
         ...
         var _loc4_:int = _loc3_[StringUtils.IND_DATA_SKIN];
      ...
      public static function getMapSkinPreviews() : Vector.<CustomMovieClip>
      {
         ...
         if(mapSkinPreviews == null)
         {
            ...
            while(_loc2_ < _loc1_.length)
            {
               ...
               (_loc4_ = new BitmapData(MAP_SKIN_PREVIEW_RECTANGLE.width,MAP_SKIN_PREVIEW_RECTANGLE.height,true,0)).copyPixels(_loc3_,MAP_SKIN_PREVIEW_RECTANGLE,GlobVars.ZERO_PT);
               (_loc5_ = new CustomMovieClip()).setNumFrames(1);
