package com.smbc.graphics
{
   ...
   public class TopScreenText extends Sprite
   {
      ...
      private static const UPG_ICONS_START_PNT:Point = new Point(48 + HUD_X_OFS,THIRD_ROW_Y);
      ...
      {
         this.WORLD_DISP_TFC.text = this.STAT_MNGR.curFullLevStr.substr(0,3);
      }
      ...
      public function initiateBlackScreen() : void
      {
         this.updWorldDispTxt();
         x = 0;
         this.updTimeDispTxt(LevelDataManager.currentLevelData.gettimeLeftTot(this.STAT_MNGR.curFullLevStr).toString());
         if(!Cheats.infiniteTime && !(this.level is CharacterSelect) && !(this.level is TitleLevel))
         {
            this.showTime();
         }
