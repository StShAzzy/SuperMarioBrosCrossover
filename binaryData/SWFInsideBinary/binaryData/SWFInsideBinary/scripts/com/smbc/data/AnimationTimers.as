package com.smbc.data
{
   ...
   public class AnimationTimers
   {
      ...
      public static const ANIM_SLOWEST_TMR:CustomTimer = new CustomTimer(DEL_SLOWEST,0,"animSlowestTmr");
      
      public static const ANIM_SUPER_SLOWEST_TMR:CustomTimer = new CustomTimer(DEL_SUPER_SLOWEST,0,"animSuperSlowestTmr");
      
      public static const ANIM_VERY_SLOW_TMR:CustomTimer = new CustomTimer(DEL_VERY_SLOW,0,"animVerySlowTmr");
      
      public static const ANIM_SLOW_TMR:CustomTimer = new CustomTimer(DEL_SLOW,0,"animSlowTmr");
      
      public static const ANIM_MODERATE_TMR:CustomTimer = new CustomTimer(DEL_MODERATE,0,"animModerateTmr");
      
      public static const ANIM_MIN_FAST_TMR:CustomTimer = new CustomTimer(DEL_MIN_FAST,0,"animMinFastTmr");
      
      public static const ANIM_FAST_TMR:CustomTimer = new CustomTimer(DEL_FAST,0,"animFastTmr");
       
      
      public function AnimationTimers()
      {
         super();
      }
   }
