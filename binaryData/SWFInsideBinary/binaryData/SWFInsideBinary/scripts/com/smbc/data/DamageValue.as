package com.smbc.data
{
   public final class DamageValue
   {
      ...
      public static const MEGA_MAN_FLAME_BLAST_BULLET:int = 300;
      
      public static const MEGA_MAN_FLAME_BLAST_FLAME:int = 300;
      
      public static const MEGA_MAN_METAL_BLADE:int = 150;
      
      public static const MEGA_MAN_HARD_KNUCKLE:int = 800;
      
      public static const MEGA_MAN_MAGMA_BAZOOKA:int = 200;
      
      public static const MEGA_MAN_MAGMA_BAZOOKA_CHARGE:int = 400;
      ...
      public static const MEGA_MAN_WATER_SHIELD:int = 250;
      ...
      public static const PIT_SHORT_ARROW:int = 300;
      
      public static const PIT_LONG_ARROW:int = 300;
      
      public static const PIT_FIRE_ARROW:int = 300;
      
      public static const PIT_FIREBALL:int = 300;
      
      public static const PIT_SHIELD:int = 300;
      ...
      public static const SAMUS_ICE_BEAM:int = 150;
      
      public static const SAMUS_LONG_BEAM:int = 150;
      
      public static const SAMUS_MISSILE:int = 400;
      
      public static const SAMUS_WAVE_BEAM:int = 150;
      ...
      public static const SOPHIA_BULLET_CRUSER:int = 300;
