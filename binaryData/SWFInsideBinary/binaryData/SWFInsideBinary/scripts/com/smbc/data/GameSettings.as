package com.smbc.data
{
   ...
   public class GameSettings
   {
      ...
      public static const VERSION_NUMBER:Number = Versions.V_3_01;
      
      public static const VERSION_SAVE_FILE_COMPAT_MIN:Number = Versions.V_3_0;
      
      public static var DEF_CHAR_SKIN_NUM:int = 0;
      
      public static const DEF_MAP_SKIN_NUM:int = BmdInfo.SKIN_NUM_ZELDA_2;
      
      public static const INACTIVE_SKIN_NUMS:Array = GameSettingsValues.calcSkinMaxValue(BmdInfo.SKIN_NUM_SMB_LL);
      
      public static const TITLE_SKINS:Array = [0,1,2,3,4,5,6,9,10,12,13,14,15];
      ...
      public static var skipLogos:Boolean = true;
      
      public static var skipTitleScreen:Boolean = true;
      
      public static var noLoading:Boolean = true;
      ...
      private static var _campaignMode:int = CampaignModes.SINGLE_CHARACTER;
      
      private static var _tutorials:Boolean = false;
      
      private static var _muteSfx:Boolean = false;
      
      private static var _muteMusic:Boolean = true;
      
      public static var coinSoundType:CoinSoundType = CoinSoundType.Normal;
      
      private static var _musicQuality:int = MusicQuality.HIGH;
      
      private static var _musicType:int = ConsoleType.MAP;
      
      private static var _musicSet:int = MusicSets.MAP;
      ...
      public static var goombaReplacementType:GoombaReplacementType = GoombaReplacementType.BuzzyBeetle;
      ...
      {
         return [[mapDifficulty,changeMapDifficulty],[mapPack,"mapPack"],[campaignMode,changeCampaignMode],[cheatNotify,"cheatNotify"],[tutorials,changeTutorials],[lockFrameRate,changeLockFrameRate],[initialLivesCount,"initialLivesCount"],[attackStrength,"attackStrength"],[enemySpeed,"enemySpeed"],[goombaReplacementType,"goombaReplacementType"],[damageResponse,"damageResponse"],[startWithMushroom,"startWithMushroom"],[itemDropRate,"itemDropRate"],[muteSfx,changeMuteSfx],[muteMusic,changeMuteMusic],[coinSoundType,"coinSoundType"],[musicType,changeMusicType],[musicSet,changeMusicSet],[activeSkins,changeActiveSkins],[gameBoyFilter,changeGameBoyFilter],[mapSkin,changeMapSkin],[randomMapSkin,"randomMapSkin"],[enemySkin,changeEnemySkin],[interfaceSkin,changeInterfaceSkin]];
      }
      ...
      public static function loadData(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc6_ = (_loc5_ = _loc2_[_loc4_])[IND_LOAD_SAVE_ARR_REFERENCE]) is Function)
            {
               _loc6_(param1.shift());
            }
      ...
      private static function incSkin(param1:int, param2:int, param3:int, param4:int) : int
      {
         var _loc6_:int;
         var _loc5_:Array;
         var _loc7_:int = (_loc6_ = (_loc5_ = BmdInfo.MAIN_SKIN_ORDER).indexOf(param1)) + param2;
         if(_loc6_ == -1)
         {
            _loc7_ = (_loc6_ = param1) + param2;
            if(param2 < 0)
            {
               if(_loc7_ <= param3)
               {
