package com.smbc.data
{
   ...
   public class RandomDropGenerator extends PickupInfo
   {
      ...
      public static function checkDropItem(param1:String, param2:LevObj) : Boolean
      {
         ...
         var _loc6_:Number;
         if((_loc6_ = Math.random()) > _loc5_ || _loc3_ is CharacterSelect || _loc3_ is TitleLevel)
         {
            return false;
         }
         var _loc7_:Array;
         if(!(_loc7_ = _loc4_.dropArr) || !_loc7_.length)
         {
            return false;
         }
         ...
         var _loc12_:Pickup;
         var _loc11_:Class;
         (_loc12_ = new (_loc11_ = getPickupClass(StatManager.STAT_MNGR.curCharNum))(_loc9_)).appearFromObject(param2);
