package com.explodingRabbit.cross.games
{
   ...
   public class GameZeldaAdventureOfLink extends Game
   {
      ...
      private const TG_GRASS_WITH_PILLARS:ThemeGroup = addThemeGroup(1,2);
      ...
      override protected function setUpLevelThemes() : void
      {
         ...
         addToThemeInfoGeneral(this.TG_SEA,"1-2d","2-2c","4-2e","7-2c");
         ...
         addToThemeInfoWorld(4,this.TG_GRASS_WITH_PILLARS,LT_NORMAL,LT_INTRO);
         addToThemeInfoWorld(4,this.TG_SEA,LT_COIN_HEAVEN);
         ...
         addToThemeInfoGeneral(this.TG_GRASS_WITH_PILLARS,"4-2a");
      ...
      override protected function createPlayList() : void
      {
         ...
         addToThemePlayList(this.TG_GRASS_WITH_PILLARS,this.SngAction2,[LT_NORMAL]);
