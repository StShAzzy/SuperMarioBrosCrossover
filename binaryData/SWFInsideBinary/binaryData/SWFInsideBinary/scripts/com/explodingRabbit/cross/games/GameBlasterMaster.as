package com.explodingRabbit.cross.games
{
   ...
   public class GameBlasterMaster extends Game
   {
      ...
      {
         addToThemeInfoGeneral(this.TG_AREA_1_1,LT_NORMAL,LT_INTRO,LT_PLATFORM,LT_CHEEP_CHEEP);
         addToThemeInfoGeneral(this.TG_AREA_1_1,LT_UNDER_GROUND,LT_PIPE_BONUS);
         addToThemeInfoGeneral(this.TG_AREA_1_1,LT_COIN_HEAVEN);
         addToThemeInfoGeneral(this.TG_AREA_1_1,LT_CASTLE);
         addToThemeInfoGeneral(this.TG_AREA_1_1,LT_WATER);
         addToThemeInfoGeneral(this.TG_AREA_3_3,"3-1b","3-2a");
         addToThemeInfoGeneral(this.TG_AREA_4_3,"4-1b");
         addToThemeInfoGeneral(this.TG_AREA_7_2,"5-1b","5-2a");
         addToThemeInfoGeneral(this.TG_AREA_6_2,"6-2a");
         addToThemeInfoGeneral(this.TG_AREA_8_4,"8-1b");
         addToThemeInfoGeneral(this.TG_AREA_8_2,"8-2a");
         addToThemeInfoGeneral(this.TG_AREA_8_3,"8-2b","8-3a");
         addToThemeInfoWorld(1,this.TG_AREA_1_1,LT_NORMAL,LT_INTRO);
         addToThemeInfoWorld(1,this.TG_AREA_1_2,LT_UNDER_GROUND,LT_PIPE_BONUS);
         addToThemeInfoWorld(1,this.TG_AREA_1_3,LT_PLATFORM);
         addToThemeInfoWorld(1,this.TG_AREA_1_4,LT_CASTLE);
         addToThemeInfoWorld(2,this.TG_AREA_2_1,LT_NORMAL,LT_INTRO);
         addToThemeInfoWorld(2,this.TG_AREA_2_2,LT_WATER);
         addToThemeInfoWorld(2,this.TG_AREA_2_3,LT_CHEEP_CHEEP,LT_PIPE_BONUS,LT_COIN_HEAVEN);
         addToThemeInfoWorld(2,this.TG_AREA_2_4,LT_CASTLE);
         addToThemeInfoWorld(3,this.TG_AREA_3_1,LT_NORMAL);
         addToThemeInfoWorld(3,this.TG_AREA_3_2,LT_PLATFORM);
         addToThemeInfoWorld(3,this.TG_AREA_3_4,LT_CASTLE,LT_COIN_HEAVEN);
         addToThemeInfoWorld(4,this.TG_AREA_4_1,LT_NORMAL,LT_INTRO,LT_COIN_HEAVEN);
         addToThemeInfoWorld(4,this.TG_AREA_4_2,LT_UNDER_GROUND,LT_PIPE_BONUS);
         addToThemeInfoWorld(4,this.TG_AREA_4_3,LT_PLATFORM);
         addToThemeInfoWorld(4,this.TG_AREA_4_4,LT_CASTLE);
         addToThemeInfoWorld(5,this.TG_AREA_7_1,LT_NORMAL);
         addToThemeInfoWorld(5,this.TG_AREA_7_3,LT_PLATFORM);
         addToThemeInfoWorld(5,this.TG_AREA_7_4,LT_CASTLE);
         addToThemeInfoWorld(5,this.TG_AREA_5_2,LT_WATER);
         addToThemeInfoWorld(6,this.TG_AREA_6_1,LT_NORMAL);
         addToThemeInfoWorld(6,this.TG_AREA_6_3,LT_PLATFORM,LT_PIPE_BONUS);
         ...
         addToThemeInfoWorld(7,this.TG_AREA_5_3,LT_CHEEP_CHEEP,LT_PIPE_BONUS);
         addToThemeInfoWorld(7,this.TG_AREA_5_4,LT_CASTLE);
         addToThemeInfoWorld(8,this.TG_AREA_8_1,LT_NORMAL,LT_PLATFORM);
         ...
         addToThemeInfoGeneral(this.TG_AREA_2_2,"3-1b");
         addToThemeInfoGeneral(this.TG_AREA_7_3,"5-3b");
         addToThemeInfoGeneral(this.TG_AREA_8_2,"8-2c","8-3a","8-3b");
         addToThemeInfoGeneral(this.TG_AREA_8_3,"8-3c");
