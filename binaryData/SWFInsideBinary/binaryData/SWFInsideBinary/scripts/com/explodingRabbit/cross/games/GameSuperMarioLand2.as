package com.explodingRabbit.cross.games
{
   ...
   public class GameSuperMarioLand2 extends Game
   {
      ...
      private const TG_OVERWORLD_TREES_NIGHT:ThemeGroup = addThemeGroup(1,4,MT_DARK_EPIC);
      
      private const TG_UNDER_GROUND:ThemeGroup = addThemeGroup(2,1);
      ...
      override protected function setUpLevelThemes() : void
      {
         ...
         addToThemeInfoWorld(4,this.TG_OVERWORLD_TREES_NIGHT,LT_PLATFORM);
         ...
         addToThemeInfoWorld(8,this.TG_MOON,LT_NORMAL);
         ...
         addToThemeInfoWorld(8,this.TG_MOON,LT_PLATFORM);
      ...
      override protected function createPlayList() : void
      {
         ...
         addToThemePlayList(this.TG_OVERWORLD_TREES_NIGHT,this.SngStarMaze,[LT_NORMAL,LT_PLATFORM]);
