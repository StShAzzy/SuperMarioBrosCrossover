package com.explodingRabbit.cross.games
{
   ...
   public class GameFinalFantasyMysticQuest extends Game
   {
      ...
      private const FossilLabyrinthData:Class = GameFinalFantasyMysticQuest_FossilLabyrinthData;
      
      public const SngFossilLabyrinth:Song = addSong(this.FossilLabyrinthData,-1,null,this.VOLUME);
      ...
      private const DungeonAndWaterfalData:Class = GameFinalFantasyMysticQuest_DungeonAndWaterfalData;
      
      public const SngDungeonAndWaterfal:Song = addSong(this.DungeonAndWaterfalData,-1,null,this.VOLUME);
      ...
      private const RockNRollData:Class = GameFinalFantasyMysticQuest_RockNRollData;
      
      public const SngRockNRoll:Song = addSong(this.RockNRollData,-1,null,this.VOLUME);
      ...
      private const CityOfWindData:Class = GameFinalFantasyMysticQuest_CityOfWindData;
      
      public const SngCityOfWind:Song = addSong(this.CityOfWindData,-1,null,this.VOLUME);
      ...
      private const TheCrystalData:Class = GameFinalFantasyMysticQuest_TheCrystalData;
      
      public const SngTheCrystal:Song = addSong(this.TheCrystalData,-1,null,this.VOLUME);
      ...
      private const Battle3Data:Class = GameFinalFantasyMysticQuest_Battle3Data;
      
      public const SngBattle3:Song = addSong(this.Battle3Data,-1,null,this.VOLUME);
      
      private const MysticBalladData:Class = GameFinalFantasyMysticQuest_MysticBalladData;
      
      public const SngMysticBallad:Song = addSong(this.MysticBalladData,-1,null,this.VOLUME);
