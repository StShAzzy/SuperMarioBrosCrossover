package com.explodingRabbit.cross.games
{
   ...
   public class GameSuperMarioWorld extends Game
   {
      ...
      private const InvincibleCave:Class = GameSuperMarioWorld_InvincibleCave;
      
      public const SngInvincibleCave:Song = addSong(this.InvincibleCave,-1,null,this.VOLUME);
      
      private const InvincibleCaveFastData:Class = GameSuperMarioWorld_InvincibleCaveFastData;
      
      public const SngInvincibleCaveFast:Song = addSong(this.InvincibleCaveFastData,-1,null,this.VOLUME);
      ...
      private const TimeUpWarningData:Class = GameSuperMarioWorld_TimeUpWarningData;
      ...
      override protected function setUpLevelThemes() : void
      {
         ...
         addToThemeInfoWorld(7,this.TG_GHOST_HOUSE_BROWN_BLACK,LT_CHEEP_CHEEP);
         ...
         addToThemeInfoGeneral(this.TG_TREES_AND_STARS,"3-3a");
      ...
      {
         addOverridableMusicTypes(LT_NORMAL,LT_CHEEP_CHEEP);
         ...
         addHurryVersionOfSong(this.SngKingBowser,this.SngKingBowser);
         addHurryVersionOfSong(this.SngBonus,this.SngBonusFast);
         addHurryVersionOfSong(this.SngInvincible,this.SngInvincibleFast);
         addHurryVersionOfSong(this.SngInvincibleCave,this.SngInvincibleCaveFast);
         ...
         addToThemePlayList(this.TG_GHOST_HOUSE_BROWN_DARK,this.SngGhostHouse,[LT_NORMAL,LT_INTRO,LT_PIPE_BONUS]);
         ...
         addToThemePlayList(this.TG_GHOST_HOUSE_DARK,this.SngGhostHouse,[LT_CASTLE]);
