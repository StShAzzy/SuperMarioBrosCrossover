package com.explodingRabbit.cross.games
{
   ...
   public class Games
   {
      ...
      public static const megaManGb:Game = storeGame(new Game("Mega Man Gb","Capcom",GB,ctr = ctr + 1));
      
      public static const megaMan2Gb:Game = storeGame(new Game("Mega Man Gb","Capcom",GB,ctr = ctr + 1));
      ...
      public static const ninjaGaiden2:Game = storeGame(new Game("Ninja Gaiden 2","Tecmo",NES,ctr = ctr + 1));
      ...
      public static const superMarioLand:Game = storeGame(new Game("Super Mario Land","Nintendo",GB,ctr = ctr + 1));
      ...
      {
         return [blasterMasterBlastingAgain,castlevaniaAdventureRebirth,castlevaniaPortraitOfRuin,castlevaniaSymphonyOfTheNight,doubleDragon2,gimmick,megaMan4,megaMan5,megaMan6,megaManWilyWars,metroidPrime3Corruption,metroidZeroMission,ninjaGaiden2,ninjaGaiden3,probotector,rockManBattleAndFighters,rockManMobile,rokkoChan,retroGameChallenge,superMarioBrosDeluxe,zeldaBs,zeldaOracleOfAges,zeldaOcarinaOfTime];
      }
      ...
      private static function generateGamesList() : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            _loc10_ = (_loc8_ = _loc5_[_loc4_]).fullName;
