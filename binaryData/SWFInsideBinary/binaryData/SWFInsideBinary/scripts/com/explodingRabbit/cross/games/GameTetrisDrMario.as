package com.explodingRabbit.cross.games
{
   ...
   public class GameTetrisDrMario extends Game
   {
      ...
      private const MainTitleData:Class = GameTetrisDrMario_MainTitleData;
      
      public const SngMainTitle:Song = addSong(this.MainTitleData,-1,null,this.VOLUME);
      
      private const GameSelectData:Class = GameTetrisDrMario_GameSelectData;
      
      public const SngGameSelect:Song = addSong(this.GameSelectData,-1,null,this.VOLUME);
      ...
      override protected function createPlayList() : void
      {
         ...
         addHurryVersionOfSong(this.SngMixedMusic2,this.SngMixedMusic1Hurry);
         addHurryVersionOfSong(this.SngMixedMusic3,this.SngMixedMusic1Hurry);
      }
   }
}
