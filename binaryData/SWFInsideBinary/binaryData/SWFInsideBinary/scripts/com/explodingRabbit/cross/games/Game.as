package com.explodingRabbit.cross.games
{
   ...
   public class Game
   {
      ...
      protected final function addSong(param1:Class, param2:int = -1, param3:Game = null, param4:int = 100, param5:int = 0, param6:int = 0, param7:int = 0, param8:int = 0) : Song
      {
         if(!this.songDct)
         {
      ...
      public function initiate() : void
      {
         ...
         this.createPlayList();
         if(this.typePlayListDct && !this.gameToUseAsPlayList)
         {
      ...
      {
         if(this.typePlayListDct && this.typePlayListDct[param1])
         {
      ...
      public function getSongFromThemePlayList(param1:int, param2:int, param3:String) : Song
      {
         ...
         var _loc4_:Array;
         if(!(_loc4_ = ArrayUtils.readNestedArr(this.themePlayListArr,param1,param2)))
         {
            return null;
         }
         var _loc5_:Dictionary;
         if(!(_loc5_ = _loc4_[IND_THEME_PL_LEVEL_TYPES])[param3])
         {
            return null;
         }
      ...
      {
         var _loc7_:String = null;
         if(param1 < 0 || param1 > GameSuperMarioBros.NUM_WORLDS)
         {
