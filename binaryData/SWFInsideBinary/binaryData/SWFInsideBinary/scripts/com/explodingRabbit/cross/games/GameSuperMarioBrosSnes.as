package com.explodingRabbit.cross.games
{
   ...
   public class GameSuperMarioBrosSnes extends Game
   {
      ...
      private const TG_SNOW:ThemeGroup = addThemeGroup(2,1);
      
      private const TG_SNOW_NIGHT:ThemeGroup = addThemeGroup(2,2,MT_DARK_EPIC);
      
      private const TG_UNDERGROUND:ThemeGroup = addThemeGroup(3,1);
      
      private const TG_UNDERGROUND_BLACK:ThemeGroup = addThemeGroup(3,2);
      ...
      override protected function setUpLevelThemes() : void
      {
         ...
         addToThemeInfoGeneral(this.TG_UNDERGROUND_BLACK,LT_PIPE_BONUS);
         ...
         addToThemeInfoGeneral(this.TG_MUSHROOM_PLATFORMS,"4-2c","4-3a");
