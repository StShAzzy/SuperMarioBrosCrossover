package com.explodingRabbit.display
{
   ...
   public class CustomMovieClip extends Sprite
   {
      ...
      public function recolorBmps(param1:Palette, param2:Palette, param3:int = 0, param4:int = 0, param5:Palette = null) : void
      {
         ...
         var _loc8_:Boolean;
         if(_loc8_ = Boolean(_loc6_.getPalNumFromType(this.masterBmdSkinCont.type)))
         {
            if(_loc8_ = _loc6_.shouldBeRecoloredToGb(this.masterBmdSkinCont))
            {
      ...
      public function getBmpsFromFrame(param1:int = -1) : Vector.<Bitmap>
      {
         ...
         {
            if((_loc5_ = getChildAt(_loc4_)) is Bitmap)
            {
      ...
      protected function getNumPalRows(param1:String) : int
      {
         ...
         var _loc2_:int = this.palLenArr.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = this.palLenArr[_loc3_])[PAL_LEN_ARR_IND_TYPE]) == param1)
            {
      ...
      protected function getPalRowOfs(param1:String) : int
      {
         ...
         while(_loc4_ < _loc2_)
         {
            if((_loc6_ = (_loc5_ = this.palLenArr[_loc4_])[PAL_LEN_ARR_IND_TYPE]) == param1)
            {
               return _loc3_;
            }
      ...
      protected function copySingleFrameFromOtherCmc(param1:CustomMovieClip, param2:int, param3:int) : void
      {
         ...
         var _loc6_:Vector.<DisplayObject>;
         if(!(_loc6_ = param1.FRAME_VEC[param2]))
         {
         ...
         {
            if((_loc13_ = _loc6_[_loc12_]) is Bitmap)
            {
      ...
      public function relinkBmdToMasterSingleFrame(param1:Object = null) : void
      {
         ...
         var _loc5_:int = (_loc4_ = this.FRAME_VEC[_loc2_]).length;
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
            if((_loc7_ = _loc3_[_loc6_]) is Bitmap)
            {
      ...
      protected function draw() : void
      {
         ...
         while(_loc2_ <= this.numFrames)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               if((_loc8_ = _loc3_[_loc7_]) is DisplayObjectContainer && !(_loc8_ is HRect || _loc8_ is CustomMovieClip))
               {
                  if((_loc9_ = _loc8_ as DisplayObjectContainer).numChildren && _loc9_.getChildAt(0) is Bitmap)
                  {
                     ...
                     (_loc16_ = _loc8_.transform.matrix).scale(_loc1_,_loc1_);
      ...
      protected function trimBmp(param1:BitmapData, param2:Rectangle, param3:Array) : Array
      {
         ...
         if(!(_loc4_ = param1.getColorBoundsRect(4294967295,0,false)).height || !_loc4_.width)
         {
            _loc4_ = new Rectangle(0,0,1,1);
         }
         var _loc6_:Number = 0;
         var _loc7_:Number = 0;
         (_loc5_ = new BitmapData(_loc4_.width,_loc4_.height,true,0)).copyPixels(param1,_loc4_,ZERO_PNT);
         ...
         var _loc9_:Number;
         if((_loc9_ = param3[IND_ROTATION_SRC]) != 0)
         {
            _loc12_ = _loc6_;
            if(_loc9_ == 180)
            {
      ...
      public function redraw(param1:int = -1, param2:BitmapData = null) : void
      {
         ...
         while(_loc4_ <= _loc3_)
         {
            ...
            {
               _loc10_ = (_loc9_ = _loc6_[_loc8_])[IND_MASK_RECT_SRC];
               ...
               if((_loc13_ = _loc7_[_loc8_]) && this.trim)
               {
                  if(_loc16_ = this.trimBmp(_loc12_,_loc10_,_loc13_))
                  {
      ...
      protected function removeObjsFromFrames(param1:Object, param2:Array, param3:Boolean = false, param4:int = -1) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            _loc10_ = (_loc9_ = this.FRAME_VEC[_loc7_]).length;
            _loc11_ = 0;
            while(_loc11_ < _loc10_)
            {
               if((_loc12_ = _loc9_[_loc11_]) == param1 || param1 is Class && _loc12_ is Class(param1) || param1 is String && _loc12_.name == String(param1))
               {
                  if(param4 != -1)
                  {
                     if(param4 == 0)
                  ...
                  else
                  {
                     ...
                     _loc11_--;
                     _loc10_--;
                     delete (_loc13_ = this.STAT_VEC[_loc7_])[_loc12_];
                     if(contains(_loc12_))
                     {
                        removeChild(_loc12_);
                     }
      ...
      protected function createMasterFromMc(param1:DisplayObjectContainer) : void
      {
         ...
         while(_loc3_ <= this.numFrames)
         {
            ...
            while(_loc8_ < _loc7_)
            {
               if((_loc10_ = param1.getChildAt(_loc8_)) is SkinMask)
               {
      ...
      public function frameIsEmpty(param1:Object) : Boolean
      {
         ...
         for each(_loc7_ in _loc6_)
         {
            if(_loc7_.visible)
            {
               if((_loc9_ = (_loc8_ = _loc7_.bitmapData).getColorBoundsRect(4278190080,4278190080)).width != 0 || _loc9_.height != 0)
               {
                  return false;
               }
            }
      ...
      public function replaceSubMovieClips() : void
      {
         ...
         var _loc1_:int = this.STAT_VEC.length;
         var _loc2_:int = 0;
         ...
         while(_loc4_ < _loc1_)
         {
            ...
            for(_loc9_ in _loc5_)
            {
               ...
               _loc14_ = this.mcReplaceArr.length;
               _loc15_ = 0;
               while(_loc15_ < _loc14_)
               {
                  ...
                  if(_loc12_ == _loc16_)
                  {
                     ...
                     {
                        if((_loc20_ = _loc6_[_loc19_]) == _loc16_)
                        {
      ...
      public function setChildPoperty(param1:DisplayObject, param2:String, param3:Number, param4:Object = null) : void
      {
         ...
         while(_loc8_ <= _loc7_)
         {
            (_loc11_ = (_loc10_ = this.STAT_VEC[_loc8_])[param1])[IND_MATRIX_SRC] = _loc9_;
            _loc8_++;
         }
      }
      ...
      public function gotoAndStop(param1:Object, param2:String = null) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            addChild(_loc7_);
            if(!(_loc9_ = (_loc8_ = _loc4_[_loc7_])[IND_MATRIX_TEMP]))
            {
