package sample.libgme
{
   ...
   public function F__ZN9Sms_Noise3runEii() : void
   {
      ...
      if(_loc13_ != _loc12_)
      {
         ...
         var _loc10_:*;
         si32(_loc10_ = _loc13_ - _loc12_,_loc2_ + 8);
         _loc10_ = li32(_loc3_ + 16);
         var _loc9_:int;
         si32(_loc14_ = (_loc9_ = li32(_loc10_) * _loc11_) + li32(_loc10_ + 4),_loc2_ + 4);
         _loc14_ = _loc3_ + 48;
         si32(_loc14_,_loc2_);
         ESP = _loc2_;
      ...
      if(_loc15_ != 0)
      {
         ...
         _loc8_ = _loc14_ + _loc11_;
      }
      if(_loc8_ < _loc12_)
      {
         _loc14_ = li32(_loc3_ + 36);
         _loc15_ = (_loc14_ = li32(_loc14_)) << 1;
         _loc11_ = 16;
         if(_loc15_ != 0)
         {
            _loc11_ = _loc15_;
         ...
         while(true)
         {
            ...
            _loc14_ = _loc5_ + 1;
            if((_loc14_ = _loc14_ & 2) != 0)
            {
               _loc2_ -= 16;
               si32(_loc13_,_loc2_ + 12);
               _loc1_ = 0 - _loc1_;
               si32(_loc1_,_loc2_ + 8);
               _loc14_ = (_loc9_ = li32(_loc13_) * _loc8_) + li32(_loc13_ + 4);
         ...
         _loc14_ = _loc1_ >> 1;
         si32(_loc14_,_loc3_ + 28);
         _loc8_ = _loc7_;
      }
      _loc14_ = _loc8_ - _loc12_;
      si32(_loc14_,_loc3_ + 24);
      _loc2_ = _loc4_;
      ESP = _loc2_;
   }
}
