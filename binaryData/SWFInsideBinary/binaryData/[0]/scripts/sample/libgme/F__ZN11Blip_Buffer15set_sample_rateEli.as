package sample.libgme
{
   ...
   public function F__ZN11Blip_Buffer15set_sample_rateEli() : void
   {
      ...
      if(_loc12_ == 1)
      {
         ...
         si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.__ZZN11Blip_Buffer15set_sample_rateEliE8__func__,_loc2_);
         ESP = _loc2_;
         F___assert();
         _loc2_ += 16;
      }
      ...
      if(_loc11_ != 0)
      {
         var _loc8_:* = _loc11_ + 1;
         if((_loc9_ = (_loc8_ = _loc8_ * _loc10_) + 999) <= 65452999)
         {
            _loc9_ /= 1000;
         }
         else
      ...
      if(_loc12_ != _loc9_)
      {
         _loc2_ -= 16;
         var _loc6_:*;
         si32(_loc6_ = (_loc6_ = _loc9_ << 2) + 72,_loc2_ + 4);
         si32(li32(_loc1_ + 8),_loc2_);
         ESP = _loc2_;
         F_realloc();
         _loc12_ = sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str9111;
         _loc2_ += 16;
         ...
         if(_loc4_ != 0)
         {
            ...
            {
               _loc2_ -= 16;
               si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str10112,_loc2_ + 12);
               si32(107,_loc2_ + 8);
               si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str104,_loc2_ + 4);
               si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.__ZZN11Blip_Buffer15set_sample_rateEliE8__func__,_loc2_);
               ESP = _loc2_;
            ...
            _loc8_ = _loc9_ * 1000;
            si32(_loc12_ = (_loc8_ = _loc8_ / _loc10_) + -1,_loc1_ + 36);
            if(_loc11_ != 0)
            {
               if(_loc12_ != _loc11_)
               {
                  _loc2_ -= 16;
                  si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str11113,_loc2_ + 12);
                  si32(113,_loc2_ + 8);
                  si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str104,_loc2_ + 4);
                  si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.__ZZN11Blip_Buffer15set_sample_rateEliE8__func__,_loc2_);
                  ESP = _loc2_;
            ...
            _loc11_ = li32(_loc1_ + 28);
            if(_loc11_ != 0)
            {
               si32(_loc11_,_loc1_ + 28);
               _loc2_ -= 16;
               var _loc5_:Number = (_loc5_ = _loc10_) / _loc11_;
               sf64((_loc5_ = _loc5_ * 65536) + 0.5,_loc2_);
               ESP = _loc2_;
               F_floor();
               _loc2_ += 16;
               _loc11_ = _loc5_ = sample.libgme.st0;
               if(_loc11_ <= 0)
               {
                  if(_loc10_ != 0)
                  {
            ...
            if(_loc1_ != 0)
            {
               ...
               si32(_loc1_,_loc2_);
               _loc8_ = _loc9_ << 2;
               si32(_loc8_ = _loc8_ + 72,_loc2_ + 8);
               ESP = _loc2_;
               Fmemset();
               _loc2_ += 16;
            }
