package sample.libgme
{
   ...
   public function F__ZN6Gb_Apu13read_registerEij() : void
   {
      ...
      if((uint(_loc5_ = _loc6_ + -65296)) >= 48)
      {
         _loc2_ -= 16;
         si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str6143,_loc2_ + 12);
         si32(291,_loc2_ + 8);
         ...
         si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.__ZZN6Gb_Apu13read_registerEijE8__func__,_loc2_);
         ESP = _loc2_;
         F___assert();
         _loc2_ += 16;
      }
      ...
      if(_loc6_ == 65318)
      {
         ...
         if(li32(_loc4_ + 44) != 0)
         {
            if(li32(_loc4_ + 40) == 0)
            {
               if((li8(li32(_loc4_ + 24) + 4) & 0x40) == 0)
               {
               }
               §§goto(addr158);
            }
         ...
         if(_loc1_ != 0)
         {
            if(li32(_loc6_ + 40) == 0)
            {
               if((li8(li32(_loc6_ + 24) + 4) & 0x40) != 0)
               {
               }
               §§goto(addr185);
            }
         ...
         _loc1_ = li32(_loc7_ + 44);
         if(_loc1_ != 0)
         {
            if(li32(_loc7_ + 40) == 0)
            {
               if((li8(li32(_loc7_ + 24) + 4) & 0x40) != 0)
               {
               }
               §§goto(addr173);
            }
