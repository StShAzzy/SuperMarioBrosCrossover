package sample.libgme
{
   ...
   public function F__ZN7Nes_Dmc3runEii() : void
   {
      ...
      _loc2_ = _loc1_;
      _loc11_ = li32(_loc2_);
      _loc27_ = li32(_loc11_ + 20);
      _loc26_ = li32(_loc11_ + 48);
      si32(_loc26_,_loc11_ + 20);
      ...
      else
      {
         ...
         if(_loc26_ != _loc27_)
         {
            ...
            si32(_loc26_ - _loc27_,_loc1_ + 8);
            var _loc22_:int = _loc8_ * _loc23_;
            si32(_loc20_ = _loc22_ + _loc20_,_loc1_ + 4);
            _loc20_ = _loc11_ + 72;
            si32(_loc20_,_loc1_);
            ESP = _loc1_;
      ...
      _loc16_ = li32(_loc11_ + 16);
      if((_loc17_ = _loc16_ + _loc23_) < _loc24_)
      {
         _loc18_ = li8(_loc11_ + 45);
         _loc19_ = li32(_loc11_ + 36);
         if(_loc18_ != 0)
         {
            _loc20_ = li8(_loc11_ + 44);
            if(_loc20_ == 0)
            {
               _loc20_ = _loc24_ + -1;
               _loc19_ = (_loc21_ -= (_loc8_ = _loc21_ + ((_loc8_ = (_loc21_ = (_loc21_ = _loc19_ + 7) - (_loc22_ - ((_loc21_ = _loc22_ + ((_loc21_ = (_loc22_ = (_loc22_ = _loc20_ - _loc17_ + (_loc20_ = li32(_loc11_ + 28))) / _loc20_) >> 31) >>> 29)) & -8))) >> 31) >>> 29)) & -8) + 1;
            ...
            else
            {
               ...
               if(_loc10_ == 0)
               {
                  ...
                  while(true)
                  {
                     _loc20_ = _loc18_ & 0xFF;
                     if(_loc20_ == 0)
                     {
                        _loc20_ = _loc14_ << 2;
                        _loc6_ = (_loc5_ = (_loc20_ = _loc20_ & 4) + -2) + _loc13_;
                        _loc14_ >>= 1;
                        if(uint(_loc6_) <= 127)
                        {
                           _loc1_ -= 16;
                           ...
                           _loc20_ = (_loc22_ = li32(_loc10_) * _loc9_) + li32(_loc10_ + 4);
                  ...
                  while(true)
                  {
                     ...
                     if(_loc20_ == 0)
                     {
                        ...
                        if(uint(_loc4_) <= 127)
                        {
                           ...
                           _loc20_ = (_loc22_ = li32(_loc10_) * _loc7_) + li32(_loc10_ + 4);
                           si32(_loc20_,_loc1_ + 4);
                           si32(_loc12_,_loc1_);
                           ESP = _loc1_;
                           F__ZNK10Blip_SynthILi8ELi1EE16offset_resampledEjiP11Blip_Buffer();
      ...
      addr715:
      _loc20_ = _loc17_ - _loc24_;
      si32(_loc20_,_loc11_ + 16);
      _loc1_ = _loc2_;
      ESP = _loc1_;
   }
}
