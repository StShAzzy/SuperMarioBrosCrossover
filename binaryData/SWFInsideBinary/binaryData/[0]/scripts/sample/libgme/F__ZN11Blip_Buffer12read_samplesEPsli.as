      ...
      if(_loc11_ != 0)
      {
         ...
         if(li32(_loc4_ + 12) == 0)
         {
            ...
            while(true)
            {
               _loc12_ = _loc8_ >> 14;
               _loc10_ = _loc8_ << 2;
               if((_loc10_ = _loc10_ >> 16) != _loc12_)
               {
                  _loc12_ = 32767 - (_loc8_ >> 31);
               }
               si16(_loc12_,_loc9_);
               _loc10_ = _loc8_ >> _loc13_;
               _loc10_ = _loc8_ - _loc10_;
               var _loc1_:* = li32(_loc7_);
               _loc8_ = _loc1_ + _loc10_;
               _loc7_ += 4;
               _loc9_ += 2;
               _loc14_ += -1;
               if(_loc14_ += -1 != 0)
         ...
         else
         {
            ...
            do
            {
               _loc14_ = _loc8_ >> 14;
               _loc10_ = _loc8_ << 2;
               if((_loc10_ = _loc10_ >> 16) != _loc14_)
               {
                  _loc14_ = 32767 - (_loc8_ >> 31);
               }
               si16(_loc14_,_loc9_);
               _loc10_ = _loc8_ >> _loc13_;
               _loc10_ = _loc8_ - _loc10_;
         ...
         if(_loc11_ != 0)
         {
            ...
            _loc10_ = _loc11_ << 16;
            var _loc5_:int = _loc13_ - _loc10_;
            si32(_loc5_,_loc3_ + 4);
            _loc10_ = _loc11_ << 2;
            var _loc6_:* = li32(_loc3_ + 8);
            _loc1_ = _loc6_ + _loc10_;
            _loc2_ -= 16;
