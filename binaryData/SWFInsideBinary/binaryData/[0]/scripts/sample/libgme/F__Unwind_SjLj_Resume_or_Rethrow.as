package sample.libgme
{
   ...
   public function F__Unwind_SjLj_Resume_or_Rethrow() : void
   {
      ...
      if(_loc7_ == 0)
      {
         ...
         _loc2_ += 16;
         eax = _loc7_ = sample.libgme.eax;
         _loc2_ = _loc3_;
         ESP = _loc2_;
         return;
      }
      _loc6_ = li32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2._use_fc_key);
      if(_loc6_ <= -1)
      {
         ESP = _loc2_;
         F_fc_key_init_once();
