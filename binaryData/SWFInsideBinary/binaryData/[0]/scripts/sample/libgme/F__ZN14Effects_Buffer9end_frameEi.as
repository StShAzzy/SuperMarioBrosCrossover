package sample.libgme
{
   ...
   public function F__ZN14Effects_Buffer9end_frameEi() : void
   {
      ...
      if(_loc11_ >= 1)
      {
         do
         {
            var _loc7_:* = _loc9_ * 11;
            _loc7_ = _loc7_ << 2;
            _loc7_ = _loc1_ + _loc7_;
            _loc6_ = li32(_loc7_ + 60);
            si32(0,_loc7_ + 60);
            var _loc5_:* = li32(_loc7_ + 20);
            var _loc4_:int = _loc5_ * _loc10_;
      ...
      if(_loc7_ != 0)
      {
         if(_loc11_ == 7)
         {
            _loc7_ = li16(_loc1_ + 26);
            si32(_loc7_ = _loc7_ + 8,_loc1_ + 432);
         }
      }
      _loc8_ = 1;
      if(_loc6_ == 0)
      ...
      if(_loc7_ == 0)
      {
         ...
         if(_loc7_ != 0)
         {
            addr224:
            _loc7_ = li16(_loc1_ + 26);
            si32(_loc7_ = _loc7_ + 8,_loc1_ + 436);
         }
