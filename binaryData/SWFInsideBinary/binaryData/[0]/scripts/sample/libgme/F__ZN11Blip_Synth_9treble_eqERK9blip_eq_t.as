package sample.libgme
{
   ...
   public function F__ZN11Blip_Synth_9treble_eqERK9blip_eq_t() : void
   {
      ...
      _loc2_ -= 16;
      _loc16_ = _loc4_ - 2432;
      si32(_loc14_ = _loc16_ + 256,_loc2_ + 4);
      var _loc12_:* = li32(_loc4_ + 4);
      si32(_loc12_,_loc2_);
      _loc12_ = _loc18_ << 5;
      si32(_loc9_ = _loc12_ + -32,_loc2_ + 8);
      _loc18_ <<= 7;
      ...
      do
      {
         ...
         var _loc1_:* = lf32(_loc12_);
         sf32(_loc1_,_loc18_ + 252);
      }
      while(_loc6_ += 1, _loc6_ += 1 != 32);
      ...
      if(_loc9_ >= 1)
      {
         ...
         do
         {
            var _loc8_:* = lf32(_loc14_);
            _loc10_ = _loc8_ + _loc10_;
            _loc14_ += 4;
         }
         while(_loc9_ += -1, _loc9_ += -1 != 0);
         
      }
      si32(32768,_loc3_ + 32);
      _loc18_ = li32(_loc3_ + 28);
      if((_loc18_ = (_loc14_ = _loc18_ << 5) | 1) >= 1)
      {
         ...
         do
         {
            ...
            var _loc17_:* = (_loc8_ = _loc8_ * _loc13_) + 0.5;
            ...
            F_floor();
            _loc2_ += 16;
            _loc12_ = _loc17_ = sample.libgme.st0;
            si16(_loc12_,_loc18_);
            _loc18_ = _loc7_ << 2;
            _loc18_ = _loc16_ - _loc18_;
            _loc10_ = (_loc17_ = lf32(_loc18_ + 256)) + _loc10_;
            _loc8_ = lf32(_loc18_);
