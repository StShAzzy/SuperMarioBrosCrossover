package sample.libgme
{
   ...
   public function F__ZN7Nsf_EmuD0Ev() : void
   {
      var _loc7_:* = 0;
      var _loc12_:int = 0;
      var _loc40_:* = 0;
      ...
      while(true)
      {
         try
         {
            if(!_loc12_)
            {
               ...
               _loc3_ -= 80;
               _loc17_ = li32(_loc7_);
               si32(_loc17_,_loc7_ - 72);
               _loc17_ = li32(_loc7_ - 72);
               si32(_loc17_,_loc7_ - 68);
               _loc41_ = __ZTV7Nsf_Emu + 8;
               _loc17_ = li32(_loc7_ - 68);
               si32(_loc41_,_loc17_);
               _loc40_ = li32(_loc7_ - 72);
               _loc39_ = li32(_loc40_ + 2568);
               si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L_LSDA_489,_loc7_ - 28);
            ...
            if(_loc17_ == 0)
            {
               ...
               si32(0,_loc40_ + 2568);
               _loc33_ = li32(_loc7_ - 72);
               if((_loc31_ = li32(_loc33_ + 2564)) != 0)
               {
                  _loc3_ -= 16;
                  si32(_loc31_,_loc3_);
                  ESP = _loc3_;
               ...
               si32(0,_loc33_ + 2564);
               _loc29_ = li32(_loc7_ - 72);
               if((_loc14_ = li32(_loc29_ + 2572)) != 0)
               {
                  _loc3_ -= 16;
                  si32(_loc14_,_loc3_);
                  ESP = _loc3_;
               ...
               si32(0,_loc29_ + 2572);
               _loc17_ = li32(_loc7_ - 72);
               si32(_loc17_ = _loc17_ + 2540,_loc7_ - 64);
               _loc17_ = li32(_loc7_ - 64);
               _loc22_ = li32(_loc17_);
               _loc17_ = li32(_loc7_ - 64);
               si32(0,_loc17_);
               _loc17_ = li32(_loc7_ - 72);
               si32(0,_loc17_ + 2544);
            ...
            else
            {
               while(true)
               {
                  ...
                  _loc41_ = __ZTV11Classic_Emu + 8;
                  _loc17_ = li32(_loc7_ - 68);
                  si32(_loc41_,_loc17_);
                  _loc17_ = li32(_loc7_ - 72);
                  if((_loc4_ = li32(_loc17_ + 256)) != 0)
                  {
                     _loc17_ = li32(_loc4_);
                     _loc1_ = li32(_loc17_ + 4);
                     _loc17_ = _loc37_ | 4;
                     si32(4,_loc17_);
                     _loc3_ -= 16;
                     si32(_loc4_,_loc3_);
                  ...
                  break;
                  _loc32_ = li32(_loc7_ - 48);
                  _loc38_ = li32(_loc7_ - 44);
                  ESP = _loc3_;
                  F__ZSt9terminatev();
               }
               _loc27_ = _loc37_ | 4;
            ...
            _loc17_ = __ZTV11Classic_Emu + 8;
            _loc41_ = li32(_loc7_ - 68);
            si32(_loc17_,_loc41_);
            _loc17_ = li32(_loc7_ - 72);
            if((_loc20_ = li32(_loc17_ + 256)) != 0)
            {
               _loc17_ = li32(_loc20_);
               _loc21_ = li32(_loc17_ + 4);
               si32(2,_loc23_);
               _loc3_ -= 16;
               si32(_loc20_,_loc3_);
               ESP = _loc3_;
