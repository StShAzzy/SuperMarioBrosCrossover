package sample.libgme
{
   ...
   public function F__ZN7Nsf_Emu10set_tempo_Ed() : void
   {
      ...
      if(_loc7_ == _loc8_)
      {
         ...
         {
            addr135:
            var _loc11_:Number = uint(_loc7_);
            var _loc9_:Number = _loc11_ * _loc6_;
            _loc11_ = _loc4_ * 83333.33333333333;
            _loc13_ = _loc11_ = _loc9_ / _loc11_;
            si32(_loc13_,_loc2_ + 2528);
         }
         ...
         {
            _loc11_ = _loc5_;
            _loc5_ = (_loc13_ = _loc11_ = _loc11_ / _loc4_) & -2;
         }
