package sample.libgme
{
   ...
   public function F__ZN13Stereo_Buffer10clock_rateEl() : void
   {
      ...
      _loc5_ = _loc1_;
      _loc4_ = _loc8_ = li32(_loc9_ + 44);
      _loc4_ = (_loc4_ = (_loc4_ = _loc4_ / _loc5_) * 65536) + 0.5;
      _loc2_ -= 16;
      sf64(_loc4_,_loc2_);
      ESP = _loc2_;
      F_floor();
      _loc2_ += 16;
      _loc7_ = _loc4_ = sample.libgme.st0;
      if(_loc7_ <= 0)
      {
         if(_loc8_ != 0)
         {
      ...
      F_floor();
      _loc2_ += 16;
      _loc6_ = _loc4_ = sample.libgme.st0;
      if(_loc6_ <= 0)
      {
         if(_loc1_ != 0)
         {
