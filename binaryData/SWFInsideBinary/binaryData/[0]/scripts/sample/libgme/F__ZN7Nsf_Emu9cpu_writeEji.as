package sample.libgme
{
   ...
   public function F__ZN7Nsf_Emu9cpu_writeEji() : void
   {
      ...
      _loc14_ = _loc3_ ^ 0x6000;
      _loc13_ = li32(_loc4_ + 8);
      _loc12_ = li32(_loc4_);
      if(uint(_loc14_) <= 8191)
      {
         si8(_loc13_,_loc12_ + _loc14_ + 5512);
      }
      else
      {
         var _loc11_:* = _loc3_ & 0xE000;
         if(_loc11_ == 0)
         {
            si8(_loc13_,_loc12_ + (_loc3_ & 0x07FF) + 272);
         }
         else
         {
            _loc11_ = _loc3_ + -16384;
            if((uint(_loc11_)) <= 23)
            {
               _loc2_ -= 16;
               si32(_loc13_,_loc2_ + 12);
               si32(_loc3_,_loc2_ + 8);
               var _loc10_:* = li32(_loc12_ + 2328);
               si32(_loc11_ = li32(_loc10_ + 132) + li32(_loc10_ + 136),_loc2_ + 4);
               _loc11_ = _loc12_ + 2576;
               si32(_loc11_,_loc2_);
               ESP = _loc2_;
            ...
            else
            {
               ...
               if((uint(_loc9_)) <= 7)
               {
                  ...
                  _loc11_ = li32(_loc12_ + 2560);
                  if(_loc11_ <= _loc8_)
                  {
                     si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str8324,_loc12_ + 16);
                  }
                  ...
                  {
                     _loc2_ -= 16;
                     si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str7323,_loc2_ + 12);
                     si32(51,_loc2_ + 8);
                     si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str6322,_loc2_ + 4);
                     si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.__ZZNK13blargg_vectorIhEixEjE8__func__321,_loc2_);
                     ESP = _loc2_;
                     F___assert();
                     _loc2_ += 16;
                  }
                  _loc11_ = _loc9_ << 12;
                  if((uint(_loc11_ = _loc11_ + 36864)) >= 65537)
                  {
                     _loc2_ -= 16;
                     si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str3317,_loc2_ + 12);
                     si32(94,_loc2_ + 8);
                     si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str314,_loc2_ + 4);
                     si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.__ZZN7Nes_Cpu8map_codeEjjPKvbE8__func__,_loc2_);
                     ESP = _loc2_;
                     F___assert();
                     _loc2_ += 16;
                  }
                  _loc11_ = li32(_loc12_ + 2540);
                  _loc11_ = _loc11_ + _loc5_;
                  _loc10_ = li32(_loc12_ + 2328);
                  var _loc6_:* = _loc3_ << 12;
                  _loc6_ = (_loc6_ = _loc6_ + -100597760) >>> 9;
                  _loc10_ += _loc6_;
                  si32(_loc11_,_loc10_);
                  _loc10_ = _loc6_ | 4;
                  _loc6_ = li32(_loc12_ + 2328);
