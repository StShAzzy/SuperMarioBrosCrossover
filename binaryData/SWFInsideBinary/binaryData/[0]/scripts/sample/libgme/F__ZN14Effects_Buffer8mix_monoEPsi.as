package sample.libgme
{
   ...
   public function F__ZN14Effects_Buffer8mix_monoEPsi() : void
   {
      ...
      _loc6_ = _loc3_;
      _loc18_ = (_loc4_ = li32(_loc6_ + 8)) >> 1;
      _loc17_ = li32(_loc6_);
      _loc16_ = li32(_loc17_ + 36);
      ...
      if(_loc18_ != 0)
      {
         ...
         do
         {
            ...
            if(_loc1_ != _loc8_)
            {
               _loc8_ = 32767 - (_loc16_ >> 31);
            }
            _loc2_ = _loc16_ >> _loc14_;
            _loc1_ = _loc16_ + _loc9_;
            _loc16_ = _loc1_ - _loc2_;
            _loc1_ = _loc8_ << 16;
            _loc2_ = _loc8_ & 0xFFFF;
            _loc1_ = _loc2_ | _loc1_;
            si32(_loc1_,_loc11_);
            _loc12_ += 8;
            _loc11_ += 8;
         }
         while(_loc18_ += -1, _loc18_ += -1 != 0);
         
         _loc13_ += _loc7_ << 1;
         _loc15_ += (_loc4_ & 0x3FFFFFFE) << 2;
      }
      _loc1_ = _loc4_ & 1;
      _loc7_ = _loc16_;
      if(_loc1_ != 0)
      {
         ...
         _loc7_ = li32(_loc15_) - (_loc16_ >> _loc14_) + _loc16_;
         if(_loc16_ << 2 >> 16 != _loc1_)
         {
            si16(32767 - (_loc16_ >> 31),_loc13_);
            si16(32767 - (_loc16_ >> 31),_loc13_ + 2);
         }
      }
