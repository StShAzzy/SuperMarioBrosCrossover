package sample.libgme
{
   ...
   public function F__ZN7Kss_Emu10run_clocksERii() : void
   {
      ...
      _loc4_ = _loc2_;
      _loc3_ = li32(_loc4_);
      _loc15_ = li32(_loc3_ + 788);
      _loc14_ = li32(_loc15_ + 76);
      _loc15_ = li32(_loc15_ + 72);
      ...
      if(_loc13_ < _loc10_)
      {
         ...
         do
         {
            ...
            F__ZN7Kss_Cpu3runEi();
            _loc2_ += 16;
            _loc14_ = li16(_loc3_ + 872);
            if(_loc14_ == 65535)
            {
               _loc14_ = li32(_loc3_ + 788);
               si32(_loc15_ = _loc10_ - li32(_loc14_ + 72),_loc14_ + 76);
            }
            _loc10_ = li32(_loc3_ + 788);
            _loc14_ = li32(_loc10_ + 76);
            _loc15_ = li32(_loc10_ + 72);
            _loc14_ = _loc15_ + _loc14_;
            _loc13_ = li32(_loc3_ + 980);
            if(_loc14_ >= _loc13_)
            {
               _loc14_ = li32(_loc3_ + 976);
               si32(_loc14_ = _loc14_ + _loc13_,_loc3_ + 980);
               _loc14_ = li16(_loc3_ + 872);
               if(_loc14_ == 65535)
               {
                  _loc14_ = li8(_loc3_ + 961);
                  if(_loc14_ == 0)
                  {
                     si8(1,_loc3_ + 961);
                     _loc14_ = li8(_loc3_ + 960);
                     if(_loc14_ != 0)
                     {
                        _loc2_ -= 16;
                        si32(_loc6_,_loc2_);
                        var _loc11_:Number = lf64(_loc3_ + 184) * 1.4;
                        sf64(_loc11_ = (_loc8_ = _loc11_ * 1.5) * 0.000915032679738562,_loc2_ + 4);
                        ESP = _loc2_;
                        F__ZN11Blip_Synth_11volume_unitEd();
                        _loc2_ += 16;
                        _loc2_ -= 16;
                        _loc11_ = _loc8_ * 0.00000262451171875;
                  ...
                  _loc14_ = li16(_loc3_ + 874);
                  si16(_loc15_ = _loc14_ + -1,_loc3_ + 874);
                  _loc14_ = _loc3_ + 988;
                  _loc15_ &= 65535;
                  _loc15_ = _loc14_ + _loc15_;
                  si8(-1,_loc15_);
                  _loc15_ = li16(_loc3_ + 874);
                  si16(_loc15_ = _loc15_ + -1,_loc3_ + 874);
                  _loc15_ &= 65535;
                  _loc14_ += _loc15_;
                  si8(-1,_loc14_);
                  _loc14_ = li8(_loc3_ + 938);
                  _loc15_ = li8(_loc3_ + 939);
                  si16(_loc14_ = (_loc15_ = _loc15_ << 8) | _loc14_,_loc3_ + 872);
                  _loc10_ = li32(_loc3_ + 788);
               }
            }
            _loc15_ = li32(_loc10_ + 76);
            _loc14_ = li32(_loc10_ + 72);
      ...
      _loc14_ = li32(_loc3_ + 980);
      si32(_loc14_ = _loc14_ - _loc13_,_loc3_ + 980);
      var _loc5_:* = li32(_loc12_);
      _loc14_ = li32(_loc3_ + 788);
      si32(_loc15_ = (_loc15_ = li32(_loc14_ + 76)) - _loc5_,_loc14_ + 76);
      _loc6_ = _loc3_ + 66832;
      ...
      {
         _loc2_ -= 16;
         si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str14224,_loc2_ + 12);
         si32(103,_loc2_ + 8);
         si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str6215,_loc2_ + 4);
         si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.__ZZN7Scc_Apu9end_frameEiE8__func__,_loc2_);
         ESP = _loc2_;
         F___assert();
         _loc2_ += 16;
      }
      _loc14_ = _loc7_ - _loc1_;
      si32(_loc14_,_loc6_);
      _loc7_ = _loc3_ + 68160;
      ...
      {
         _loc2_ -= 16;
         si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str15225,_loc2_ + 12);
         si32(82,_loc2_ + 8);
         si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str4213,_loc2_ + 4);
         si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.__ZZN7Scc_Apu9end_frameEiE8__func__,_loc2_);
         ESP = _loc2_;
         F___assert();
         _loc2_ += 16;
      ...
      if(_loc1_ != 0)
      {
         ...
         {
            _loc2_ -= 16;
            si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str7462,_loc2_ + 12);
            si32(263,_loc2_ + 8);
            ...
            si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.__ZZN7Sms_Apu9end_frameEiE8__func__,_loc2_);
            ESP = _loc2_;
            F___assert();
            _loc2_ += 16;
         }
         _loc14_ = _loc3_ - _loc12_;
         si32(_loc14_,_loc1_ + 976);
      }
      eax = 0;
      _loc2_ = _loc4_;
      ESP = _loc2_;
