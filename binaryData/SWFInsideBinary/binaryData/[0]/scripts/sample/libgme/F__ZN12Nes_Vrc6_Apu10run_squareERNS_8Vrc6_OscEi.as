package sample.libgme
{
   ...
   public function F__ZN12Nes_Vrc6_Apu10run_squareERNS_8Vrc6_OscEi() : void
   {
      ...
      if(_loc15_ != 0)
      {
         ...
         if(_loc14_ <= -1)
         {
            _loc12_ = _loc13_ & 0x0F;
         }
         _loc11_ = _loc13_ & 0x80;
         var _loc10_:* = _loc13_ >>> 4;
         _loc13_ = (_loc10_ = _loc10_ & 7) + 1;
         _loc9_ = _loc12_;
         if(_loc11_ == 0)
         {
            _loc9_ = _loc12_;
         ...
         if(_loc9_ != _loc5_)
         {
            ...
            var _loc6_:int;
            _loc10_ = (_loc6_ = li32(_loc15_) * _loc1_) + li32(_loc15_ + 4);
         ...
         if(_loc12_ != 0)
         {
            ...
            {
               _loc10_ = _loc14_ << 8;
               if((uint(_loc14_ = (_loc10_ = _loc10_ & 0x0F00 | li8(_loc3_ + 1)) + 1)) >= 5)
               {
                  _loc9_ = li32(_loc4_ + 8);
                  _loc11_ = _loc5_ + _loc1_;
                  if(_loc11_ < _loc9_)
                  {
                     _loc11_ = _loc5_ + _loc1_;
                     _loc1_ = 0 - _loc12_;
                     ...
                     do
                     {
                        ...
                        if(_loc8_ += 1 == 16)
                        {
                           ...
                           _loc10_ = (_loc6_ = li32(_loc15_) * _loc11_) + li32(_loc15_ + 4);
                           si32(_loc10_,_loc2_ + 4);
                           si32(_loc5_,_loc2_);
                           ESP = _loc2_;
                           F__ZNK10Blip_SynthILi12ELi1EE16offset_resampledEjiP11Blip_Buffer();
                     ...
                     while(_loc11_ += _loc14_, _loc11_ += _loc14_ < _loc9_);
