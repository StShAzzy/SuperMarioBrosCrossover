package sample.libgme
{
   ...
   public function F__ZN13Stereo_Buffer9end_frameEi() : void
   {
      var _loc3_:* = 0;
      var _loc1_:* = 0;
      var _loc5_:* = 0;
      ...
      si32(0,_loc1_ + 60);
      si32(_loc7_,_loc1_ + 164);
      _loc6_ = li32(_loc1_ + 20);
      _loc5_ = li32(_loc3_ + 4);
      _loc4_ = _loc6_ * _loc5_;
      _loc6_ = li32(_loc1_ + 24);
      _loc6_ = _loc4_ + _loc6_;
      si32(_loc6_,_loc1_ + 24);
      _loc4_ = _loc6_ >>> 16;
      _loc6_ = li32(_loc1_ + 32);
      if(_loc4_ > _loc6_)
      {
         _loc2_ -= 16;
         si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str3107,_loc2_ + 12);
         si32(147,_loc2_ + 8);
         ...
         si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.__ZZN11Blip_Buffer9end_frameEiE8__func__,_loc2_);
         ESP = _loc2_;
         F___assert();
         _loc2_ += 16;
      }
      _loc6_ = li32(_loc1_ + 104);
      si32(0,_loc1_ + 104);
      _loc6_ <<= 1;
      si32(_loc7_ = _loc6_ <<= 1 | _loc7_,_loc1_ + 164);
      _loc6_ = li32(_loc1_ + 64);
      _loc4_ = _loc6_ * _loc5_;
      _loc6_ = li32(_loc1_ + 68);
      _loc6_ = _loc4_ + _loc6_;
      si32(_loc6_,_loc1_ + 68);
      _loc4_ = _loc6_ >>> 16;
      ...
      _loc6_ = li32(_loc1_ + 148);
      si32(0,_loc1_ + 148);
      _loc6_ <<= 2;
      si32(_loc6_ = _loc6_ <<= 2 | _loc7_,_loc1_ + 164);
      _loc6_ = li32(_loc1_ + 108);
      _loc6_ = _loc6_ * _loc5_;
      _loc4_ = li32(_loc1_ + 112);
      _loc6_ += _loc4_;
      si32(_loc6_ += _loc4_,_loc1_ + 112);
      _loc4_ = _loc6_ >>> 16;
      _loc6_ = li32(_loc1_ + 120);
      if(_loc4_ > _loc6_)
      {
         _loc2_ -= 16;
         si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str3107,_loc2_ + 12);
