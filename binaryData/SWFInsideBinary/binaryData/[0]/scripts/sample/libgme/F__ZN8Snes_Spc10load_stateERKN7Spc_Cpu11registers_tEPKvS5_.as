package sample.libgme
{
   ...
   public function F__ZN8Snes_Spc10load_stateERKN7Spc_Cpu11registers_tEPKvS5_() : void
   {
      ...
      _loc11_ = li8(_loc1_ + 4);
      si8(_loc11_,_loc10_ + 612);
      _loc11_ = li8(_loc1_ + 5);
      si8(_loc11_,_loc10_ + 613);
      _loc11_ = li8(_loc1_ + 6);
      si8(_loc11_,_loc10_ + 614);
      _loc11_ = li8(_loc1_ + 7);
      si8(_loc11_,_loc10_ + 615);
      _loc1_ = li8(_loc1_ + 8);
      ...
      do
      {
         ...
         if(_loc5_ != 15)
         {
            if(uint(_loc5_) <= 1)
            {
               _loc5_ = si8(li8(_loc9_ + (_loc7_ | 1)));
               _loc6_ = _loc10_ + (_loc4_ << 5);
               _loc4_ = si8(li8(_loc9_ + (_loc7_ & -2)));
               si16(_loc4_,_loc6_ + 336);
               si16(_loc5_,_loc6_ + 338);
               if(_loc5_ * _loc4_ < li32(_loc10_ + 332))
               {
                  if(_loc4_ <= -1)
                  {
                     si16(0 - _loc4_,_loc6_ + 336);
                  }
                  else
                  {
                     si16(0 - _loc5_,_loc6_ + 338);
                  }
               }
            }
         }
         ...
         {
            si16(_loc11_ = (_loc11_ = _loc6_ << 24) >> 24,_loc10_ + (_loc4_ << 1) + 220);
         }
      }
      while(_loc7_ += 1, _loc7_ += 1 != 128);
      
      si32(0,_loc10_);
      _loc7_ = li8(_loc10_ + 1189);
      si32(_loc7_ & 1,_loc10_ + 16);
      _loc7_;
      if((_loc7_ & 1) == 0)
      {
         si32(127,_loc10_);
