package sample.libgme
{
   ...
   public function F__ZN14Effects_Buffer15set_sample_rateEli() : void
   {
      ...
      if(_loc14_ == 0)
      {
         ...
         ESP = _loc2_;
         F_realloc();
         _loc13_ = sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str4133;
         _loc2_ += 16;
         _loc12_ = eax;
         if(_loc12_ != 0)
         {
            ...
            while(true)
            {
               _loc14_ = li32(_loc3_ + 440);
               if(_loc14_ <= _loc7_)
               {
                  _loc14_ = li32(_loc3_);
                  var _loc1_:* = li32(_loc14_ + 44);
                  _loc2_ -= 16;
                  _loc14_ = _loc3_ + 368;
