package sample.libgme
{
   ...
   public function F__ZNK10__cxxabiv121__vmi_class_type_info12__do_dyncastEiNS_17__class_type_info10__sub_kindEPKS1_PKvS4_S6_RNS1_16__dyncast_resultE() : void
   {
      ...
      _loc40_ = (_loc40_ = li8(_loc16_ + 16)) & 0x10;
      _loc39_ = li32(_loc7_);
      if(_loc40_ != 0)
      {
         _loc40_ = li32(_loc39_ + 8);
         si32(_loc40_,_loc16_ + 16);
      }
            ...
            if(_loc30_ != _loc40_)
            {
               ...
               while(true)
               {
                  ...
                  if(_loc13_ == -2)
                  {
                     while(true)
                     {
                        if(_loc24_ != 0)
                        {
                           ...
                           _loc40_ = _loc39_ + (_loc24_ << 3);
                           _loc31_ = (_loc35_ = li32(_loc40_ + 12)) & 1;
                           _loc37_ = _loc35_ >> 8;
                           if(_loc31_ != 0)
                           {
                              _loc40_ = li32(_loc34_);
                              _loc37_ = li32(_loc40_ = _loc40_ + _loc37_);
                           }
                           ...
                           addr342:
                           _loc40_ = _loc24_ << 3;
                           _loc40_ = _loc39_ + _loc40_;
                           var _loc17_:*;
                           var _loc10_:* = li32((_loc40_ = li32(_loc17_ = li32(_loc40_ + 16))) + 28);
                           _loc3_ -= 32;
                           _loc11_ = _loc7_ - 24;
                           si32(_loc11_,_loc3_ + 28);
                           ...
                           _loc40_ = li32(_loc7_ - 16);
                           si32(_loc8_ = _loc40_ | _loc17_,_loc16_ + 8);
                           _loc9_ = li32(_loc7_ - 12);
                           if((_loc40_ = _loc9_ | 4) == 6)
                           {
                              _loc40_ = li32(_loc7_ - 24);
                              si32(_loc40_,_loc16_);
                              _loc40_ = _loc11_ | 4;
                              si32(_loc40_ = li32(_loc40_),_loc16_ + 4);
                           ...
                           else
                           {
                              ...
                              if(_loc40_ == 0)
                              {
                                 if(_loc5_ == 0)
                                 {
                                    ...
                                    si32(_loc40_,_loc16_);
                                    _loc17_ = _loc11_ | 4;
                                    si32(_loc17_ = li32(_loc17_),_loc16_ + 4);
                                    if(_loc40_ != 0)
                                    {
                                       if(_loc8_ != 0)
                                       {
                                          _loc21_ = _loc26_;
                                          _loc40_ = li8(_loc39_ + 8);
                                          if((_loc40_ & 1) != 0)
                                          {
                                          }
                                          §§goto(addr1120);
                                 ...
                                 else
                                 {
                                    ...
                                    if(_loc5_ == _loc4_)
                                    {
                                       _loc40_ = (_loc17_ = li32(_loc17_ = _loc11_ | 4)) | li32(_loc16_ + 4);
                                       si32(_loc40_,_loc16_ + 4);
                                       _loc26_ = _loc21_;
                                    }
                                    else
                                    {
                                       ...
                                       {
                                          addr613:
                                          _loc40_ = _loc26_ & _loc2_;
                                          if(_loc40_ == 0)
                                          {
                                             _loc26_ = _loc21_;
                                             _loc40_ = _loc6_ & _loc21_;
                                             if((_loc40_ & 1) != 0)
                                             {
                                             }
                                             addr988:
                                       ...
                                       if(_loc8_ >= 4)
                                       {
                                          ...
                                          if(_loc40_ != 0)
                                          {
                                             _loc40_ = li8(_loc16_ + 16);
                                             if((_loc40_ = _loc40_ & 2) != 0)
                                             {
                                                addr663:
                                                if(_loc1_ < 1)
                                                {
                                                      ...
                                                      if((_loc9_ & 1) != 0)
                                                      {
                                                         ...
                                                         if(_loc9_ <= 0)
                                                         {
                                                            ...
                                                            else
                                                            {
                                                               ...
                                                               if(_loc13_ != -2)
                                                               {
                                                                  _loc40_ = li32(_loc28_);
                                                                  var _loc27_:* = li32(_loc40_ + 32);
                                                                  _loc3_ -= 32;
                  ...
                  else if(_loc24_ != 0)
                  {
                     ...
                     _loc40_ = _loc39_ + (_loc24_ << 1 << 2);
                     _loc20_ = (_loc19_ = li32(_loc40_ + 12)) & 1;
                     _loc15_ = _loc19_ >> 8;
                     if(_loc20_ != 0)
                     {
                        _loc40_ = li32(_loc34_);
                        _loc15_ = li32(_loc40_ = _loc40_ + _loc15_);
                     }
                     _loc24_ += -1;
