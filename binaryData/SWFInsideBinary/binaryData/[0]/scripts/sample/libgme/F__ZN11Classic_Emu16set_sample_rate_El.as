package sample.libgme
{
   ...
   public function F__ZN11Classic_Emu16set_sample_rate_El() : void
   {
      ...
      _loc3_ = _loc2_;
      _loc1_ = li32(_loc3_);
      _loc8_ = li32(_loc1_ + 252);
      if(_loc8_ == 0)
      {
         _loc8_ = li32(_loc1_ + 256);
         if(_loc8_ == 0)
         {
            _loc2_ -= 16;
            si32(172,_loc2_);
            ...
            si32(0,_loc8_ + 8);
            si32(1,_loc8_ + 4);
            var _loc7_:* = __ZTV13Stereo_Buffer + 8;
            si32(_loc7_,_loc8_);
            ...
            si32(0,_loc8_ + 144);
            _loc7_ = _loc8_ + 20;
            si32(_loc7_,_loc8_ + 152);
            _loc7_ = _loc8_ + 64;
            si32(_loc7_,_loc8_ + 156);
            _loc7_ = _loc8_ + 108;
            si32(_loc7_,_loc8_ + 160);
            si32(_loc8_,_loc1_ + 256);
            _loc6_ = sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str6122;
            if(_loc8_ != 0)
            {
               addr279:
