      ...
      if(_loc12_ != 0)
      {
         ...
         if(_loc9_ <= 128)
         {
            ...
            if(_loc12_ != 0)
            {
               ...
               var _loc8_:*;
               si32(_loc8_ = 0 - _loc12_,_loc2_ + 8);
               var _loc7_:*;
               var _loc6_:*;
               si32(_loc7_ = (_loc6_ = li32(_loc8_) * _loc10_) + li32((_loc8_ = li32(_loc1_ + 16)) + 4),_loc2_ + 4);
            ...
            if(_loc5_ != 0)
            {
               ...
               if((_loc12_ = _loc9_ + _loc10_) < _loc11_)
               {
                  _loc9_ = _loc11_ + -1;
                  _loc9_ = (_loc9_ = (_loc9_ = _loc9_ - _loc12_) + _loc5_) / _loc5_;
                  _loc7_ = li32(_loc1_ + 40);
                  si32(_loc7_ = (_loc7_ = _loc7_ + _loc9_) & 1,_loc1_ + 40);
                  _loc9_ *= _loc5_;
                  _loc12_ = _loc9_ *= _loc5_ + _loc12_;
               }
            }
         }
         else
         {
            ...
            if(_loc5_ != _loc12_)
            {
               ...
               _loc2_ -= 16;
               si32(_loc8_,_loc2_ + 12);
               si32(_loc8_ = _loc5_ - _loc12_,_loc2_ + 8);
               si32(_loc7_ = (_loc6_ = li32(_loc8_) * _loc10_) + li32((_loc8_ = li32(_loc1_ + 16)) + 4),_loc2_ + 4);
               si32(li32(_loc1_ + 44),_loc2_);
               ESP = _loc2_;
               F__ZNK10Blip_SynthILi12ELi1EE16offset_resampledEjiP11Blip_Buffer();
            ...
            if((_loc12_ = _loc9_ + _loc10_) < _loc11_)
            {
               ...
               do
               {
                  ...
                  _loc6_ *= _loc12_;
                  si32(_loc7_ = _loc6_ *= _loc12_ + _loc7_,_loc2_ + 4);
                  si32(_loc9_,_loc2_);
                  ESP = _loc2_;
                  F__ZNK10Blip_SynthILi12ELi1EE16offset_resampledEjiP11Blip_Buffer();
                  _loc2_ += 16;
                  ...
                  si32(_loc9_ = _loc10_ ^ 1,_loc1_ + 40);
               }
               while(_loc12_ = _loc7_ + _loc12_, _loc12_ < _loc11_);
