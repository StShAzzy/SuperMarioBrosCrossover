package sample.libgme
{
   ...
   public function F__ZN8Gb_Noise3runEiii() : void
   {
      ...
      _loc16_ = (_loc16_ = li8(_loc16_ + 3)) & 8;
      _loc15_ = 13 - _loc16_;
      _loc14_ = 2 << _loc15_;
      ...
      if(_loc12_ != _loc11_)
      {
         ...
         var _loc9_:*;
         si32(_loc9_ = _loc12_ - _loc11_,_loc2_ + 8);
         si32(_loc14_ = li32(_loc9_) * _loc10_ + li32((_loc9_ = li32(_loc3_ + 16)) + 4),_loc2_ + 4);
      ...
      if(_loc13_ != 0)
      {
         ...
         _loc11_ = _loc16_ + _loc10_;
      }
      if(_loc11_ < _loc5_)
      {
         _loc10_ = li32(_loc3_ + 16);
         _loc16_ = li32(_loc10_);
         _loc6_ = (_loc14_ = li32(_loc10_ + 4)) + _loc11_ * _loc16_;
         _loc14_ = li32(_loc3_ + 24);
         _loc13_ = li8(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.__ZZN8Gb_Noise3runEiiiE5table + ((_loc14_ = li8(_loc14_ + 3)) & 7)) << (_loc14_ >>> 4);
         ...
         do
         {
            ...
            _loc16_ = (_loc16_ = _loc16_ + 1) & 2;
            _loc8_ <<= 1;
            if(_loc16_ != 0)
            {
               _loc2_ -= 16;
               si32(_loc10_,_loc2_ + 12);
               si32(_loc12_ = 0 - _loc12_,_loc2_ + 8);
         ...
         _loc16_ = _loc12_ >> 1;
         si32(_loc16_,_loc3_ + 32);
      }
      _loc16_ = _loc11_ - _loc5_;
      si32(_loc16_,_loc3_ + 28);
      _loc2_ = _loc4_;
      ESP = _loc2_;
   }
}
