package sample.libgme
{
   ...
   public function F__ZN7Spc_Emu9load_mem_EPKhl() : void
   {
      ...
      si32(_loc6_,_loc7_ + 256);
      si32(8,_loc7_ + 168);
      _loc5_ = 0;
      _loc4_ = sample.libgme._gme_wrong_file_type;
      if(_loc6_ >= 65920)
      {
         do
         {
            _loc7_ = sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str495 - _loc5_;
            _loc7_ = li8(_loc7_);
