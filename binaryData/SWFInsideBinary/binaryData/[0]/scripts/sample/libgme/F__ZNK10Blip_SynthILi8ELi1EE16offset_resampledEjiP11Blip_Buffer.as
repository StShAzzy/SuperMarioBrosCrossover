package sample.libgme
{
   ...
   public function F__ZNK10Blip_SynthILi8ELi1EE16offset_resampledEjiP11Blip_Buffer() : void
   {
      ...
      {
         _loc2_ -= 16;
         si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str1138,_loc2_ + 12);
         si32(343,_loc2_ + 8);
         si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str137,_loc2_ + 4);
         si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.__ZZNK10Blip_SynthILi8ELi1EE16offset_resampledEjiP11Blip_BufferE8__func__,_loc2_);
         ESP = _loc2_;
         F___assert();
         _loc2_ += 16;
      }
      ...
      var _loc10_:*;
      _loc12_ = (_loc10_ = li32(_loc11_ + 8)) * _loc12_;
      _loc11_ += 40;
      _loc10_ = _loc3_ >>> 10;
      var _loc9_:* = _loc10_ & 0x3F;
      var _loc8_:* = 64 - _loc9_;
      _loc10_ = _loc8_ << 1;
      var _loc7_:* = _loc11_ + _loc10_;
      var _loc1_:* = (_loc10_ = si16(li16(_loc7_))) * _loc12_;
      _loc10_ = li32(_loc13_ + 8);
      var _loc5_:* = _loc14_ << 2;
      _loc5_ = li32((_loc10_ = _loc5_ + _loc10_) + 16);
      _loc1_ += _loc5_;
      _loc8_ |= 128;
      _loc8_ = _loc8_ |= 128 << 1;
      _loc8_ = _loc11_ + _loc8_;
      _loc8_ = si16(li16(_loc8_));
      ...
      _loc7_ *= _loc12_;
      si32(_loc7_ = _loc7_ *= _loc12_ + _loc5_,_loc10_ + 28);
      _loc1_ = _loc8_ * _loc12_;
      ...
      si32(_loc7_ = _loc7_ + _loc8_,_loc10_ + 36);
      ...
      si32(_loc12_ = _loc12_ + _loc7_,_loc10_ + 44);
      _loc2_ = _loc4_;
      ESP = _loc2_;
   }
}
