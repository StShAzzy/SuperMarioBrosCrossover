package sample.libgme
{
   ...
   public function F__ZN7Kss_EmuD2Ev() : void
   {
      var _loc7_:* = 0;
      var _loc12_:int = 0;
      var _loc34_:* = 0;
      ...
      while(true)
      {
         try
         {
            if(!_loc12_)
            {
               ...
               si32(_loc17_,_loc7_ - 64);
               _loc36_ = __ZTV7Kss_Emu + 8;
               _loc17_ = li32(_loc7_ - 64);
               si32(_loc36_,_loc17_);
               _loc35_ = li32(_loc7_ - 68);
               _loc34_ = li32(_loc35_ + 68872);
               si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L_LSDA_322,_loc7_ - 28);
            ...
            else
            {
               while(true)
               {
                  ...
                  _loc36_ = __ZTV11Classic_Emu + 8;
                  _loc17_ = li32(_loc7_ - 64);
                  si32(_loc36_,_loc17_);
                  _loc17_ = li32(_loc7_ - 68);
                  if((_loc8_ = li32(_loc17_ + 256)) != 0)
                  {
                     _loc17_ = li32(_loc8_);
                     _loc9_ = li32(_loc17_ + 4);
                     _loc17_ = _loc33_ | 4;
                     si32(4,_loc17_);
                     _loc3_ -= 16;
                     si32(_loc8_,_loc3_);
                  ...
                  break;
                  _loc26_ = li32(_loc7_ - 48);
                  _loc24_ = li32(_loc7_ - 44);
                  ESP = _loc3_;
                  F__ZSt9terminatev();
               }
               _loc28_ = _loc33_ | 4;
            ...
            _loc17_ = li32(_loc7_ - 68);
            if((_loc23_ = li32(_loc17_ + 256)) != 0)
            {
               _loc17_ = li32(_loc23_);
               _loc25_ = li32(_loc17_ + 4);
               si32(2,_loc31_);
               _loc3_ -= 16;
               si32(_loc23_,_loc3_);
               ESP = _loc3_;
