   ...
   public function F__ZN9Music_Emu5skip_El() : void
   {
      ...
      if(_loc3_ <= 30000)
      {
         ...
         do
         {
            ...
            var _loc11_:* = li32(_loc13_);
            _loc1_ = li32(_loc11_ + 60);
            _loc2_ -= 16;
         ...
         while(_loc7_ = eax, _loc7_ == 0);
         
      }
      else
      {
         _loc11_ = li32(_loc13_ + 192);
         if(_loc11_ == 0)
         {
            _loc2_ -= 16;
