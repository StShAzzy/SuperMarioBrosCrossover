package sample.libgme
{
   ...
   public function F__ZN7Sms_Apu14write_ggstereoEii() : void
   {
      ...
      if(uint(_loc1_) >= 256)
      {
         ...
         si32(sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.__ZZN7Sms_Apu14write_ggstereoEiiE8__func__,_loc2_);
         ESP = _loc2_;
         F___assert();
         _loc2_ += 16;
      }
      ...
      si32(_loc9_ = li32(_loc9_),_loc7_ + 16);
      _loc5_ = _loc10_ + 160;
      if(_loc9_ != _loc6_)
      {
         _loc9_ = li32(_loc7_ + 28);
         if(_loc9_ != 0)
         {
            if(_loc6_ != 0)
            {
               ...
               _loc9_ = (_loc8_ = li32(_loc6_) * _loc11_) + li32(_loc6_ + 4);
      ...
      si32(_loc9_ = li32(_loc9_),_loc1_ + 16);
      if(_loc9_ != _loc10_)
      {
         ...
         if(_loc9_ != 0)
         {
            if(_loc10_ != 0)
            {
               ...
               _loc9_ = (_loc8_ = li32(_loc10_) * _loc11_) + li32(_loc10_ + 4);
               si32(_loc9_,_loc2_ + 4);
               si32(_loc5_,_loc2_);
               ESP = _loc2_;
               F__ZNK10Blip_SynthILi12ELi1EE16offset_resampledEjiP11Blip_Buffer();
