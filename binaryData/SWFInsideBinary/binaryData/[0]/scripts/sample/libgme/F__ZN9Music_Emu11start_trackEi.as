package sample.libgme
{
   ...
   public function F__ZN9Music_Emu11start_trackEi() : void
   {
      ...
      _loc13_ = sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str2189;
      ...
      if(uint(_loc14_) > uint(_loc12_))
      {
         ...
         if(uint(_loc11_) > uint(_loc12_))
         {
            ...
            _loc14_ = _loc12_ * 40;
            var _loc9_:* = li32(_loc3_ + 28);
            _loc7_ = li32((_loc8_ = _loc9_ + _loc14_) + 16);
            _loc10_ = 0;
            if(_loc7_ >= 0)
            {
               _loc10_ = _loc7_;
               _loc14_ = li32(_loc3_ + 4);
               if(((_loc14_ = li8(_loc14_ + 20)) & 2) == 0)
               {
                  _loc10_ = _loc7_ - li8(_loc8_ + 12);
               }
            }
            _loc14_ = li32(_loc3_ + 12);
            _loc13_ = sample.libgme_2F_var_2F_folders_2F_9m_2F_bnph4mbj1gq2gp7ccy_vg60h0000gn_2F_T_2F__2F_ccY8M7iW_2E_lto_2E_bc_3A_4CB129AA_2D_159F_2D_42A5_2D_8B7B_2D_F551332DADE2.L__2E_str3190;
            if(_loc10_ < _loc14_)
            {
            }
            §§goto(addr410);
         ...
         if(_loc13_ == 0)
         {
            si8(0,_loc3_ + 208);
            si8(0,_loc3_ + 209);
            _loc14_ = li8(_loc3_ + 224);
            if(_loc14_ == 0)
            {
               _loc14_ = (_loc14_ = li32(_loc3_ + 160)) * li32(_loc3_ + 192);
               _loc5_ = _loc14_ << 1;
               do
               {
                  _loc14_ = li32(_loc3_ + 204);
                  if(_loc14_ >= _loc5_)
                  {
               ...
               while(_loc14_ = li8(_loc3_ + 208), (_loc14_ = _loc14_ | _loc6_) == 0);
