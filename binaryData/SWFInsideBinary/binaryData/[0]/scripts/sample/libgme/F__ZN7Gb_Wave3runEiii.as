package sample.libgme
{
   ...
   public function F__ZN7Gb_Wave3runEiii() : void
   {
      ...
      _loc15_ = _loc3_ + _loc15_;
      _loc15_ = li8(_loc15_ + 56);
      _loc14_ = li32(_loc3_ + 36);
      _loc13_ = (_loc14_ = _loc14_ + 7) & 7;
      _loc15_ >>>= _loc13_;
      _loc12_ = li32(_loc4_ + 12);
      _loc15_ &= _loc12_;
      _loc11_ = _loc15_ &= _loc12_ << 1;
      _loc14_ = li32(_loc3_ + 24);
      _loc15_ = li8(_loc14_ + 3);
      _loc14_ = li8(_loc14_ + 4);
      if((uint(_loc15_ = (_loc10_ = (_loc14_ = (_loc14_ = _loc14_ << 8) & 0x0700) | _loc15_) + -1)) >= 2045)
      {
         _loc15_ = 30 >>> _loc13_;
         _loc11_ = _loc15_ & _loc12_;
         _loc12_ = 0;
      }
      ...
      if(_loc11_ != _loc8_)
      {
         ...
         si32(_loc11_ - _loc8_,_loc2_ + 8);
         si32(_loc14_ = (_loc5_ *= _loc9_) + _loc14_,_loc2_ + 4);
      ...
      if(_loc12_ != 0)
      {
         ...
         _loc11_ = _loc15_ + _loc9_;
      }
      if(_loc11_ < _loc8_)
      {
         _loc12_ = li32(_loc3_ + 52);
         _loc9_ = li32(_loc3_ + 16);
         _loc10_ = 4096 - (_loc10_ << 1);
         while(true)
         {
            _loc15_ = _loc12_ + 1;
            _loc12_ = _loc15_ & 0x1F;
            _loc15_ = _loc3_ + _loc12_;
            _loc6_ = (_loc15_ = (_loc15_ = li8(_loc15_ + 56)) >>> _loc13_) << 1;
            ...
            if(_loc6_ != _loc7_)
            {
               ...
               si32(_loc6_ - _loc7_,_loc2_ + 8);
               si32(_loc14_ = (_loc5_ = li32(_loc9_) * _loc11_) + li32(_loc9_ + 4),_loc2_ + 4);
               si32(li32(_loc3_ + 48),_loc2_);
               ESP = _loc2_;
               F__ZNK10Blip_SynthILi8ELi1EE16offset_resampledEjiP11Blip_Buffer();
               _loc2_ += 16;
