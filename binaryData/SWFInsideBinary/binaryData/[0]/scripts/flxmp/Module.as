   ...
   public class Module
   {
      ...
      public function Module(param1:Class)
      {
         ...
         while(_loc2_ < _loc7_)
         {
            ...
            {
               _loc12_ = _loc5_.readUnsignedByte();
               if((_loc12_ & 0x80) > 0)
               {
                  _loc13_ = 1;
                  _loc4_ = 0;
         ...
         while(_loc2_ < _loc8_)
         {
            ...
            {
               _loc16_ = int(_loc5_.readUnsignedInt());
               _loc3_ = 0;
               while(_loc3_ < 96)
               {
               ...
               _loc28_ = int(_loc5_.readUnsignedByte());
               if((_loc28_ & 1) > 0)
               {
               ...
               _loc29_ = _loc5_.readUnsignedByte();
               if((_loc29_ & 1) > 0)
               {
               ...
               while(_loc3_ < this.instruments[_loc2_].numSamples)
               {
                  ...
                  if((this.instruments[_loc2_].waves[_loc3_].type & 0x10) > 0)
                  {
