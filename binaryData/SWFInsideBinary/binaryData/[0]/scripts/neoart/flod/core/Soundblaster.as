package neoart.flod.core
{
   ...
   public final class Soundblaster
   {
      ...
      internal function setup(param1:int) : void
      {
         var _loc2_:int = 0;
      ...
      internal function mix(param1:SampleDataEvent) : void
      {
         ...
         _loc7_ = int(this.channels.length);
         while(_loc8_ < _loc13_)
         {
            if(!this.samplesLeft)
            {
               ...
               if(this.completed)
               {
                  _loc13_ = _loc8_ + this.samplesTick;
                  if(_loc13_ > BUFFER_SIZE)
                  {
