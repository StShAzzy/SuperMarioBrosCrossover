package neoart.flod.xm
{
   ...
   public final class XMLoader
   {
      ...
      public static function load(param1:ByteArray, param2:Soundblaster) : void
      {
         ...
         _loc9_ = int(_loc11_.patterns.length);
         _loc12_ = int(param1.position);
         _loc4_ = 0;
         while(_loc4_ < _loc9_)
         {
            _loc3_ = int(param1.readUnsignedInt());
            ...
            _loc10_.size = _loc14_ = _loc10_.length * _loc11_.channels;
            _loc10_.rows = new Vector.<XMRow>(_loc14_,true);
            _loc16_ = int(param1.readUnsignedShort());
            ...
            if(_loc16_ > 0)
            {
               ...
               {
                  _loc13_ = new XMRow();
                  _loc16_ = int(param1.readUnsignedByte());
                  if(_loc16_ & 0x80)
                  {
                     if(_loc16_ & 1)
                     {
         ...
         _loc9_ = int(_loc11_.instruments.length);
         ...
         while(_loc4_ < _loc9_)
         {
            ...
            if(_loc16_ > 0)
            {
               ...
               while(_loc8_ < _loc16_)
               {
                  _loc15_ = _loc6_.samples[_loc8_];
                  if(_loc15_.length)
                  {
                     _loc12_ = param1.position + _loc15_.length;
                     if(_loc15_.loopMode & 0x10)
                     {
                        _loc15_.bits = 16;
                        _loc15_.loopMode ^= 16;
                        _loc15_.length >>= 1;
