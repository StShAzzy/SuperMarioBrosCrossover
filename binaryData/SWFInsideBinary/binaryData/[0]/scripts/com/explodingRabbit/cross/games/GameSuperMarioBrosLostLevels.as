package com.explodingRabbit.cross.games
{
   ...
   public class GameSuperMarioBrosLostLevels extends Game
   {
      ...
      {
         super("SMB: Lost Levels","Nintendo",Consoles.nintendo,param1,null,param2);
         if(instance)
         {
      ...
      override protected function setUpLevelThemes() : void
      {
         ...
         addToThemeInfoWorld(3,this.TG_OVERWORLD_SNOW_NIGHT,LT_NORMAL,LT_PLATFORM);
         addToThemeInfoWorld(3,this.TG_COIN_HEAVEN_NIGHT,LT_COIN_HEAVEN);
         addToThemeInfoWorld(4,this.TG_CLOUDS_OVERWORLD,LT_NORMAL);
         addToThemeInfoWorld(4,this.TG_CLOUDS,LT_PLATFORM);
         ...
         addToThemeInfoWorld(8,this.TG_OVERWORLD,LT_NORMAL);
         ...
         addToThemeInfoGeneral(this.TG_CLOUDS,"3-2b","8-3c");
         ...
         addToThemeInfoWorld(5,this.TG_OVERWORLD_SNOW,LT_NORMAL);
         addToThemeInfoWorld(5,this.TG_UNDERGROUND,LT_PIPE_BONUS);
         ...
         addToThemeInfoWorld(8,this.TG_CLOUDS,LT_NORMAL,LT_PLATFORM);
         addToThemeInfoWorld(9,this.TG_OVERWORLD_WATER,LT_WATER);
         addToThemeInfoWorld(9,this.TG_COIN_HEAVEN_GRAY,LT_COIN_HEAVEN);
         addToThemeInfoWorld(10,this.TG_CLOUDS,LT_NORMAL,LT_PLATFORM);
         ...
         addToThemeInfoGeneral(this.TG_OVERWORLD,"3-2a","3-2c","4-3a","5-2a","5-2c","5-2d","5-3a","10-2a","13-4b");
