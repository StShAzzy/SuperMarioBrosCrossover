package com.explodingRabbit.cross.games
{
   ...
   public class GameCastlevania extends Game
   {
      ...
      override protected function setUpLevelThemes() : void
      {
         ...
         addToThemeInfoWorld(2,this.TG_ENTRYWAY,LT_NORMAL,LT_INTRO);
         addToThemeInfoWorld(3,this.TG_RED_PILLARS_1,LT_NORMAL,LT_INTRO);
         addToThemeInfoWorld(4,this.TG_BLUE_WALLS,LT_NORMAL,LT_INTRO,LT_PLATFORM);
         addToThemeInfoWorld(4,this.TG_CATACOMBS,LT_CASTLE);
         addToThemeInfoWorld(5,this.TG_GARDEN,LT_NORMAL,LT_PLATFORM,LT_INTRO);
         addToThemeInfoWorld(5,this.TG_BLUE_PILLARS,LT_CASTLE);
         addToThemeInfoWorld(6,this.TG_SEWER,LT_NORMAL,LT_PLATFORM,LT_INTRO);
         addToThemeInfoWorld(6,this.TG_GARDEN,LT_CHEEP_CHEEP,LT_COIN_HEAVEN);
         addToThemeInfoWorld(6,this.TG_BLUE_PILLARS,LT_CASTLE);
         addToThemeInfoWorld(7,this.TG_PRISON,LT_NORMAL,LT_INTRO,LT_CHEEP_CHEEP,LT_PLATFORM);
         ...
         addToThemeInfoWorld(11,this.TG_ENTRYWAY,LT_NORMAL,LT_INTRO,LT_PLATFORM);
         addToThemeInfoWorld(12,this.TG_SEWER,LT_NORMAL);
         addToThemeInfoWorld(12,this.TG_GARDEN,LT_CHEEP_CHEEP,LT_PLATFORM);
         addToThemeInfoWorld(12,this.TG_BLUE_PILLARS,LT_CASTLE);
         addToThemeInfoWorld(13,this.TG_FINAL,LT_CASTLE);
         addToThemeInfoGeneral(this.TG_BLUE_WALLS,"8-2b","8-3a","10-3a");
         addToThemeInfoGeneral(this.TG_RUINS,"9-3a","13-3a","13-4b");
         addToThemeInfoGeneral(this.TG_PRISON,"13-1a");
         addToThemeInfoGeneral(this.TG_GREAT_HALL,"13-2a");
      }
