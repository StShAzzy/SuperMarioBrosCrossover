package com.explodingRabbit.cross.games
{
   ...
   public class GameSuperMarioBros3Snes extends Game
   {
      ...
      override protected function setUpLevelThemes() : void
      {
         ...
         addToThemeInfoWorld(6,this.TG_PIPES,LT_NORMAL,LT_PLATFORM,LT_INTRO,LT_CHEEP_CHEEP);
         ...
         addToThemeInfoWorld(7,this.TG_SKY_HILLS,LT_CHEEP_CHEEP,LT_PLATFORM);
         ...
         addToThemeInfoGeneral(this.TG_CAVE_BONUS,"1-2c","4-2d");
         addToThemeInfoGeneral(this.TG_SKY,"4-3b");
         ...
         addToThemeInfoWorld(2,this.TG_DESERT_PYRAMIDS,LT_NORMAL);
         addToThemeInfoWorld(2,this.TG_DESERT_HILLS,LT_CHEEP_CHEEP);
         addToThemeInfoWorld(2,this.TG_DESERT_CASTLE,LT_CASTLE);
         addToThemeInfoWorld(3,this.TG_WATERFALLS_WAVES,LT_NORMAL,LT_INTRO,LT_PLATFORM);
         addToThemeInfoWorld(3,this.TG_CASTLE_WATER,LT_CASTLE);
         addToThemeInfoWorld(3,this.TG_BONUS_GREEN,LT_PIPE_BONUS);
         addToThemeInfoWorld(4,this.TG_FOREST,LT_NORMAL);
         addToThemeInfoWorld(4,this.TG_FOREST_TREETOPS,LT_PLATFORM);
         addToThemeInfoWorld(4,this.TG_CASTLE_BLUE,LT_CASTLE);
         addToThemeInfoWorld(5,this.TG_SNOW_FOREST,LT_NORMAL,LT_INTRO);
         addToThemeInfoWorld(5,this.TG_SNOW_HILLS,LT_PLATFORM);
         addToThemeInfoWorld(5,this.TG_CAVE_ICE,LT_UNDER_GROUND);
         addToThemeInfoWorld(5,this.TG_CASTLE_ICE,LT_CASTLE);
         addToThemeInfoWorld(5,this.TG_BONUS_ICE,LT_PIPE_BONUS);
         addToThemeInfoWorld(8,this.TG_SKY,LT_PLATFORM);
         addToThemeInfoWorld(8,this.TG_WATER,LT_WATER);
         addToThemeInfoWorld(9,this.TG_WATERFALLS_WAVES,LT_NORMAL,LT_CASTLE);
         addToThemeInfoWorld(10,this.TG_BLOCKS,LT_PLATFORM);
         addToThemeInfoWorld(11,this.TG_WATERFALLS_WAVES,LT_NORMAL,LT_INTRO,LT_PLATFORM);
         addToThemeInfoWorld(11,this.TG_CASTLE_WATER,LT_CASTLE);
         addToThemeInfoWorld(12,this.TG_PIPES,LT_NORMAL,LT_CHEEP_CHEEP,LT_PLATFORM);
         addToThemeInfoWorld(12,this.TG_CASTLE_GRAY,LT_CASTLE);
         addToThemeInfoWorld(12,this.TG_BONUS_GREEN,LT_PIPE_BONUS);
         addToThemeInfoWorld(13,this.TG_FOREST,LT_NORMAL);
         addToThemeInfoWorld(13,this.TG_BOWSER_CASTLE,LT_CASTLE);
         addToThemeInfoGeneral(this.TG_DESERT_DUNES,"2-2a");
         addToThemeInfoGeneral(this.TG_WATER,"4-1b");
         addToThemeInfoGeneral(this.TG_BLOCKS,"7-1c");
         addToThemeInfoGeneral(this.TG_TANK_INNER,"8-2c");
         addToThemeInfoGeneral(this.TG_BOWSER_CASTLE_WATER,"8-4b");
         addToThemeInfoGeneral(this.TG_NIGHT_HILLS,"13-2a");
         addToThemeInfoGeneral(this.TG_CASTLE_WALL,"13-3a");
      }
