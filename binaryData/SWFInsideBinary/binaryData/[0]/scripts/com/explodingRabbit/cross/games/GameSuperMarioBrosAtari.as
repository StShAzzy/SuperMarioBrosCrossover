package com.explodingRabbit.cross.games
{
   ...
   public class GameSuperMarioBrosAtari extends Game
   {
      ...
      {
         super("Super Mario Bros.","Nintendo",Consoles.atari,param1,"SMB (Atari)",param2);
         if(instance)
         {
      ...
      override protected function setUpLevelThemes() : void
      {
         ...
         addToThemeInfoGeneral(this.TG_MUSHROOM_PLATFORM,"8-1a","8-2a");
         ...
         addToThemeInfoWorld(4,this.TG_MUSHROOM_PLATFORM,LT_NORMAL,LT_PLATFORM);
         addToThemeInfoWorld(5,this.TG_OVERWORLD_SNOW,LT_NORMAL);
         addToThemeInfoWorld(6,this.TG_OVERWORLD,LT_NORMAL,LT_INTRO,LT_CHEEP_CHEEP);
         ...
         addToThemeInfoWorld(10,this.TG_MUSHROOM_PLATFORM,LT_NORMAL,LT_PLATFORM);
         ...
         addToThemeInfoGeneral(this.TG_CLOUDS,"10-2c");
