package com.explodingRabbit.cross.games
{
   ...
   public class GameDemonReturns extends Game
   {
      ...
      override protected function setUpLevelThemes() : void
      {
         ...
         addToThemeInfoGeneral(this.TG_UNDERGROUND_1,LT_UNDER_GROUND);
         ...
         addToThemeInfoWorld(3,this.TG_UNDERGROUND_2,LT_UNDER_GROUND);
         ...
         addToThemeInfoWorld(4,this.TG_UNDERGROUND_2,LT_UNDER_GROUND);
         ...
         addToThemeInfoWorld(5,this.TG_UNDERGROUND_3,LT_UNDER_GROUND);
         ...
         addToThemeInfoWorld(6,this.TG_UNDERGROUND_3,LT_UNDER_GROUND);
         ...
         addToThemeInfoWorld(7,this.TG_UNDERGROUND_4,LT_UNDER_GROUND);
         ...
         addToThemeInfoWorld(8,this.TG_UNDERGROUND_4,LT_UNDER_GROUND);
         ...
         addToThemeInfoGeneral(this.TG_UNDERGROUND_3,"6-2d");
         addToThemeInfoGeneral(this.TG_WATER_4,"8-2b");
         themeMapPack = MapPack.LostLevels;
         addToThemeInfoWorld(11,this.TG_OVERWORLD_2,LT_NORMAL,LT_INTRO);
         addToThemeInfoWorld(11,this.TG_PLATFORM_2,LT_PLATFORM,LT_CHEEP_CHEEP);
         addToThemeInfoWorld(11,this.TG_UNDERGROUND_2,LT_UNDER_GROUND);
         addToThemeInfoWorld(11,this.TG_CASTLE_2,LT_CASTLE);
         addToThemeInfoWorld(11,this.TG_WATER_2,LT_WATER);
         addToThemeInfoWorld(12,this.TG_OVERWORLD_3,LT_NORMAL,LT_INTRO);
         addToThemeInfoWorld(12,this.TG_PLATFORM_3,LT_PLATFORM,LT_CHEEP_CHEEP);
         addToThemeInfoWorld(12,this.TG_UNDERGROUND_3,LT_UNDER_GROUND);
         addToThemeInfoWorld(12,this.TG_CASTLE_3,LT_CASTLE);
         addToThemeInfoWorld(12,this.TG_WATER_3,LT_WATER);
         addToThemeInfoWorld(13,this.TG_OVERWORLD_4,LT_NORMAL,LT_INTRO);
         addToThemeInfoWorld(13,this.TG_PLATFORM_4,LT_PLATFORM,LT_CHEEP_CHEEP);
         addToThemeInfoWorld(13,this.TG_UNDERGROUND_4,LT_UNDER_GROUND);
         addToThemeInfoWorld(13,this.TG_CASTLE_4,LT_CASTLE);
         addToThemeInfoWorld(13,this.TG_WATER_4,LT_WATER);
         addToThemeInfoGeneral(this.TG_WATER_4,"8-1b");
         addToThemeInfoGeneral(this.TG_COIN_HEAVEN_NORMAL,"8-2b","8-3a","10-3a");
         addToThemeInfoGeneral(this.TG_OVERWORLD_3,"9-3a");
      }
