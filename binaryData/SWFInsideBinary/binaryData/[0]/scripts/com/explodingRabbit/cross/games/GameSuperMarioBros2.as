package com.explodingRabbit.cross.games
{
   ...
   public class GameSuperMarioBros2 extends Game
   {
      ...
      override protected function setUpLevelThemes() : void
      {
         ...
         addToThemeInfoWorld(5,this.TG_GRASS_NIGHT,LT_NORMAL,LT_INTRO);
         ...
         addToThemeInfoWorld(7,this.TG_SUB_SPACE,LT_NORMAL,LT_INTRO,LT_CHEEP_CHEEP,LT_PLATFORM);
         ...
         addToThemeInfoWorld(2,this.TG_DESERT,LT_NORMAL,LT_CHEEP_CHEEP);
         addToThemeInfoWorld(2,this.TG_CASTLE_DESERT,LT_CASTLE);
         addToThemeInfoWorld(3,this.TG_GRASS,LT_NORMAL);
         addToThemeInfoWorld(3,this.TG_WATERFALL,LT_PLATFORM);
         addToThemeInfoWorld(3,this.TG_CASTLE,LT_CASTLE);
         addToThemeInfoWorld(6,this.TG_GRASS,LT_NORMAL);
         addToThemeInfoWorld(6,this.TG_WATERFALL,LT_CHEEP_CHEEP);
         addToThemeInfoWorld(6,this.TG_CASTLE,LT_CASTLE);
         addToThemeInfoWorld(7,this.TG_DESERT,LT_NORMAL,LT_PLATFORM);
         addToThemeInfoWorld(7,this.TG_CASTLE_RED,LT_CASTLE);
         addToThemeInfoWorld(9,this.TG_SUB_SPACE,LT_NORMAL,LT_CASTLE);
         addToThemeInfoWorld(9,this.TG_WATER_SUB_SPACE,LT_WATER);
         addToThemeInfoWorld(9,this.TG_COIN_HEAVEN_SUB_SPACE,LT_COIN_HEAVEN);
         addToThemeInfoWorld(10,this.TG_DESERT,LT_NORMAL,LT_INTRO,LT_PLATFORM);
         addToThemeInfoWorld(10,this.TG_CASTLE_RED,LT_CASTLE);
         addToThemeInfoWorld(12,this.TG_GRASS_NIGHT,LT_NORMAL);
         ...
         addToThemeInfoGeneral(this.TG_COIN_HEAVEN_NIGHT,"12-1c");
