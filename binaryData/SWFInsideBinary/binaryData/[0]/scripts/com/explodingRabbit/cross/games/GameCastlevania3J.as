package com.explodingRabbit.cross.games
{
   ...
   public class GameCastlevania3J extends Game
   {
      ...
      public const Nsf:Class = GameCastlevania3J_Nsf;
      ...
      public function GameCastlevania3J(param1:int, param2:int = -1)
      {
         super("Akumajo Densetsu","Konami",Consoles.nintendo,param1,"Castlevania III",param2);
         if(instance)
         {
