package com.explodingRabbit.cross.games
{
   ...
   public class GameSuperMarioBros3 extends Game
   {
      ...
      {
         addToThemeInfoGeneral(this.TG_OVERWORLD,LT_NORMAL,LT_INTRO,LT_CHEEP_CHEEP);
         addToThemeInfoGeneral(this.TG_GRASS,LT_PLATFORM);
         ...
         addToThemeInfoWorld(2,this.TG_BONUS,LT_PIPE_BONUS);
         ...
         addToThemeInfoWorld(4,this.TG_UNDERGROUND_ICE,LT_UNDER_GROUND);
         ...
         addToThemeInfoWorld(5,this.TG_BONUS,LT_PIPE_BONUS);
         addToThemeInfoWorld(6,this.TG_PIPES,LT_NORMAL,LT_INTRO,LT_PLATFORM,LT_CHEEP_CHEEP);
         addToThemeInfoWorld(6,this.TG_CASTLE_PIPE,LT_CASTLE);
         addToThemeInfoWorld(6,this.TG_BONUS_PIPE,LT_PIPE_BONUS);
         addToThemeInfoWorld(7,this.TG_CLOUDS,LT_NORMAL,LT_INTRO,LT_PLATFORM,LT_CHEEP_CHEEP);
         addToThemeInfoWorld(7,this.TG_CASTLE_CLOUD,LT_CASTLE);
         addToThemeInfoWorld(7,this.TG_BONUS,LT_PIPE_BONUS);
         ...
         addToThemeInfoWorld(8,this.TG_BONUS_BLUE,LT_PIPE_BONUS);
         addToThemeInfoGeneral(this.TG_GRASS,"1-2d");
         addToThemeInfoGeneral(this.TG_GRASS_DESERT,"3-2a");
         addToThemeInfoGeneral(this.TG_GRASS_NIGHT,"8-1a");
         addToThemeInfoGeneral(this.TG_AIRSHIP_INNER,"8-2b");
         ...
         addToThemeInfoWorld(2,this.TG_DESERT_BLUE_SKY,LT_NORMAL);
         addToThemeInfoWorld(2,this.TG_GRASS_DESERT,LT_CHEEP_CHEEP);
         addToThemeInfoWorld(2,this.TG_BONUS_DESERT,LT_PIPE_BONUS);
         addToThemeInfoWorld(2,this.TG_CASTLE_DESERT,LT_CASTLE);
         addToThemeInfoWorld(3,this.TG_WATER_OVERWORLD,LT_NORMAL,LT_INTRO,LT_PLATFORM);
         addToThemeInfoWorld(3,this.TG_BONUS,LT_PIPE_BONUS);
         addToThemeInfoWorld(3,this.TG_CASTLE_WATER,LT_CASTLE);
         addToThemeInfoWorld(4,this.TG_OVERWORLD_NIGHT,LT_NORMAL,LT_PLATFORM);
         addToThemeInfoWorld(4,this.TG_CASTLE_DARK,LT_CASTLE);
         addToThemeInfoWorld(4,this.TG_BONUS,LT_PIPE_BONUS);
         addToThemeInfoWorld(5,this.TG_ICE,LT_NORMAL,LT_INTRO,LT_PLATFORM);
         addToThemeInfoWorld(5,this.TG_UNDERGROUND_ICE,LT_UNDER_GROUND);
         addToThemeInfoWorld(5,this.TG_BONUS_ICE,LT_PIPE_BONUS);
         addToThemeInfoWorld(5,this.TG_CASTLE_ICE,LT_CASTLE);
         addToThemeInfoWorld(8,this.TG_CLOUDS,LT_PLATFORM);
         addToThemeInfoWorld(9,this.TG_WATER_OVERWORLD,LT_NORMAL,LT_CASTLE);
         addToThemeInfoWorld(10,this.TG_OVERWORLD,LT_PLATFORM);
         addToThemeInfoWorld(11,this.TG_WATER_OVERWORLD,LT_NORMAL,LT_INTRO,LT_PLATFORM);
         addToThemeInfoWorld(11,this.TG_CASTLE_WATER,LT_CASTLE);
         addToThemeInfoWorld(12,this.TG_PIPES,LT_NORMAL,LT_PLATFORM,LT_CHEEP_CHEEP);
         addToThemeInfoWorld(12,this.TG_BONUS_PIPE,LT_PIPE_BONUS);
         addToThemeInfoWorld(12,this.TG_CASTLE_PIPE,LT_CASTLE);
         addToThemeInfoWorld(13,this.TG_OVERWORLD_NIGHT,LT_NORMAL);
         addToThemeInfoWorld(13,this.TG_BOWSER_CASTLE,LT_CASTLE);
         addToThemeInfoWorld(13,this.TG_BONUS_BLUE,LT_PIPE_BONUS);
         addToThemeInfoGeneral(this.TG_DESERT_PINK_SKY,"2-2a");
         addToThemeInfoGeneral(this.TG_OVERWORLD,"7-1c");
         addToThemeInfoGeneral(this.TG_WATER_SWIMMING_MUD,"8-1b");
         addToThemeInfoGeneral(this.TG_AIRSHIP_INNER,"8-2c");
         addToThemeInfoGeneral(this.TG_GRASS_NIGHT,"13-2a");
         addToThemeInfoGeneral(this.TG_AIRSHIP,"13-3a");
      }
