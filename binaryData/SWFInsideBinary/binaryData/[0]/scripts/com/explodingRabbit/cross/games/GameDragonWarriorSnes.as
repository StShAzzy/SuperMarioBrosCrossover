package com.explodingRabbit.cross.games
{
   ...
   public class GameDragonWarriorSnes extends Game
   {
      ...
      public const SngOvertureFull:Song = addSong(this.OvertureFullData,-1,null,this.VOLUME);
      ...
      public const SngPeacefulVillage:Song = addSong(this.PeacefulVillageData,-1,null,this.VOLUME);
      
      private const KingdomOfAlefgardData:Class = GameDragonWarriorSnes_KingdomOfAlefgardData;
      
      public const SngKingdomOfAlefgard:Song = addSong(this.KingdomOfAlefgardData,-1,null,this.VOLUME);
      ...
      public const SngDarkDungeonFloor1:Song = addSong(this.DarkDungeonFloor1Data,-1,null,this.VOLUME);
      
      private const DarkDungeonFloor2Data:Class = GameDragonWarriorSnes_DarkDungeonFloor2Data;
      
      public const SngDarkDungeonFloor2:Song = addSong(this.DarkDungeonFloor2Data,-1,null,this.VOLUME);
      ...
      public const SngImprovement:Song = addSong(this.ImprovementData,-1,null,this.VOLUME);
