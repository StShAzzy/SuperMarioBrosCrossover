package com.explodingRabbit.utils
{
   ...
   public class Enum
   {
      ...
      {
         var _loc4_:EnumConstants = _enumDb[getQualifiedClassName(param1)];
         if(_loc4_ == null)
         {
            return null;
         }
      ...
      protected static function initEnum(param1:Class) : void
      {
         ...
         for each(_loc5_ in _loc4_.constant)
         {
            ...
            _loc7_ = Object(_loc6_).constructor;
            if(_loc7_ != param1)
            {
      ...
      {
         var _loc3_:int = int(this._enums.length);
         if(param1 >= 0)
         {
            if(param1 >= _loc3_)
            {
...
class EnumConstants
{
   ...
   public function EnumConstants(param1:Vector.<Enum>)
   {
