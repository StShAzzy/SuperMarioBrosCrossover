package com.smbc.pickups
{
   ...
   public class Pickup extends AnimatedObject
   {
      ...
      public function Pickup(param1:String = null)
      {
         ...
         if(param1)
         {
            this.mainFrameLabel = param1.substr(com.smbc.§pickups:Pickup§.UPGRADE_STR.length);
            if(param1.indexOf(com.smbc.§pickups:Pickup§.REGULAR_STR) != -1)
            {
               this.mainType = com.smbc.§pickups:Pickup§.MAIN_TYPE_REGULAR;
               gotoAndStop(this.mainFrameLabel);
               stopAnim = true;
               this._boomerangGrabbable = true;
            }
            else if(param1.indexOf(com.smbc.§pickups:Pickup§.UPGRADE_STR) != -1)
            {
               this.mainType = com.smbc.§pickups:Pickup§.MAIN_TYPE_UPGRADE;
               gotoAndStop(this.mainFrameLabel);
               stopAnim = true;
               com.smbc.§main:LevObj§.STAT_MNGR.prepareNextUpgrade(player.charNum,param1);
               this._boomerangGrabbable = true;
            }
            else if(param1.indexOf(com.smbc.§pickups:Pickup§.FAKE_STR) != -1)
            {
               this.mainType = com.smbc.§pickups:Pickup§.MAIN_TYPE_FAKE;
            }
         }
         this.riseSpeed = 40;
      ...
      public static function generateNextUpgrade() : Pickup
      {
         ...
         if(GameSettings.DEBUG_MODE && Boolean(GameSettings.FORCE_NEXT_PICKUP))
         {
      ...
      public function exitBrickStart(param1:Brick) : void
      {
         ...
         bottomAo = true;
         if(this.mainType != com.smbc.§pickups:Pickup§.MAIN_TYPE_FAKE)
         {
            this._boomerangGrabbable = true;
         }
      ...
      {
         super.initiate();
         if(Boolean(this.disappearTmr) && Boolean(this.source))
         {
