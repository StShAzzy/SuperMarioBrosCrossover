package com.smbc.projectiles
{
   ...
   public class MegaManProjectile extends Projectile
   {
      ...
      public function MegaManProjectile(param1:MegaManBase, param2:String, param3:Object = null)
      {
         ...
         else if(param2 == TYPE_MAGMA_BAZOOKA)
         {
            this.subType = param3 as String;
         }
         else if(param2 == TYPE_MAGMA_BAZOOKA_CHARGE)
         {
            this.subType = param3 as String;
         }
      ...
      {
         return this.type == TYPE_PHARAOH_BALLOON || this.type == TYPE_PHARAOH_SHOT;
      }
      
      public function get isDefaultWeapon() : Boolean
      {
         return this.type == TYPE_BASS_BUSTER || this.type == TYPE_MEGA_BUSTER || this.type == TYPE_CHARGE_WEAK || this.type == TYPE_CHARGE_STRONG;
      }
      ...
      {
         if(this.type == TYPE_HARD_KNUCKLE && Boolean(parent))
         {
      ...
      {
         if(this.megaMan.skinNum == MegaMan.SKIN_CUT_MAN_NES || this.megaMan.skinNum == MegaMan.SKIN_CUT_MAN_SNES)
         {
            addProperty(new StatusProperty(PR_PASSTHROUGH_ALWAYS));
         }
         if(this.megaMan.skinNum == MegaMan.SKIN_CUT_MAN_NES || this.megaMan.skinNum == MegaMan.SKIN_CUT_MAN_SNES || this.megaMan.skinNum == MegaMan.SKIN_FIRE_MAN_NES)
         {
            _damageAmt = DamageValue.MEGA_MAN_MEGA_BUSTER * 1.25;
         }
         else if(this.megaMan.skinNum == MegaMan.SKIN_ICE_MAN_NES)
         {
      ...
      {
         var _loc1_:int = MAGMA_BAZOOKA_SPEED;
      ...
      override protected function setDir() : void
      {
         ...
         var _loc4_:Boolean = MegaManBase.skinProtoMan;
         if(this.megaMan.repositionBullets())
         {
            if(_loc4_ || _loc3_ == MegaMan.SKIN_MEGA_MAN_GB)
            {
      ...
      override public function checkFrame() : void
      {
         ...
         if(this.type == TYPE_MEGA_BUSTER && _loc1_ == convFrameToInt(FL_MEGA_BUSTER_END) + 1)
         {
            gotoAndStop(FL_MEGA_BUSTER_START);
         }
         else if(this.type == TYPE_CHARGE_WEAK && _loc1_ == convFrameToInt(FL_WEAK_CHARGE_END) + 1)
         {
