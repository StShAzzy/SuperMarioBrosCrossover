package com.smbc.main
{
   ...
   public class AnimatedObject extends LevObj
   {
      ...
      protected function copyLastStatsFromObject(param1:AnimatedObject) : void
      {
         this.lvx = param1.lvx;
         this.lvy = param1.lvy;
         if(Boolean(this.hRect) && Boolean(param1.hRect))
         {
      ...
      public function updateLoc() : void
      {
         ...
         if(Boolean(this.vyMaxPsv) && vy > this.vyMaxPsv)
         {
            vy = this.vyMaxPsv;
         }
         if(Boolean(this.vyMaxNgv) && vy < -this.vyMaxNgv)
         {
            vy = -this.vyMaxNgv;
         }
         if(this.vyMax)
      ...
      {
         if(!(param1 is SpringRed) || !(this is Character))
         {
            this.onGround = true;
         }
         vy = 0;
         ...
         else if(param1 is SpringRed && this is Character)
         {
            ...
            vx = 0;
            nx = this.sprNX;
            SpringRed(param1).sprBounce();
            SpringRed(param1).SPRING_OBJS_DCT.addItem(this);
            this.onSpring = true;
         }
         ny = param1.hTop;
         this.setHitPoints();
