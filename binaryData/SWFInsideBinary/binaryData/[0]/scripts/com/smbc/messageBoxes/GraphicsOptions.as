package com.smbc.messageBoxes
{
   ...
   public class GraphicsOptions extends SettingsMenuBox
   {
      ...
      {
         var _loc1_:Array = [[MenuBoxItems.CHANGE_MAP_SKIN],[MenuBoxItems.DISABLE_SKINS],[MenuBoxItems.RANDOM_MAP_SKIN,GameSettings.randomMapSkin],[MenuBoxItems.ENEMY_SKIN,SkinNames.getName(GameSettings.enemySkin)],[MenuBoxItems.INTERFACE_SKIN,SkinNames.getName(GameSettings.interfaceSkin)],[MenuBoxItems.BACK]];
         var _loc2_:int = 0;
         if(!(Level.levelInstance is TitleLevel) && StatManager.getEnabledCharacterSkinCount(StatManager.STAT_MNGR.curCharNum) > 1)
         {
            _loc1_.splice(0,0,[MenuBoxItems.CHANGE_CHAR_SKIN]);
            _loc2_ = 1;
         }
