package com.smbc.messageBoxes
{
   ...
   public class MenuBox extends MessageBox implements IMessageBoxSelectable
   {
      ...
      protected const COLOR_WHITE:uint = 4294967295;
      
      protected const COLOR_PINK:uint = 4294954695;
      
      protected const COLOR_GRAY:uint = 4289374890;
      ...
      override protected function setUpText() : void
      {
         ...
         var _loc1_:int = int(this.ARR_VEC.length);
         ...
         while(_loc6_ < _loc1_)
         {
            _loc7_ = this.ARR_VEC[_loc6_];
            _loc8_ = _loc7_[this.IND_ARR_VEC_NAME];
            _loc9_ = _loc7_[this.IND_ARR_VEC_VALUE];
            _loc10_ = _loc7_[this.IND_ARR_VEC_TEXT_FIELD];
            if(_loc10_ != null)
            {
               _loc8_ = _loc10_;
            }
      ...
      protected function getTfc(param1:int) : TextFieldContainer
      {
         return this.ARR_VEC[param1][this.IND_ARR_VEC_TEXT_FIELD] as TextFieldContainer;
      }
      ...
      protected function setNewSelection(param1:int) : void
      {
         ...
         if(Boolean(contentMaskRect) && _loc5_ > y + contentMaskRect.height + 10)
         {
      ...
      protected function chooseItem(param1:String, param2:String, param3:TextFieldContainer, param4:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case MenuBoxItems.GAME_PAD_INFO:
               ...
               _loc5_.push(MenuBoxItems.CANCEL);
