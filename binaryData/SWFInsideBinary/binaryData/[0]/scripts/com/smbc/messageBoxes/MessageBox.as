package com.smbc.messageBoxes
{
   ...
   public class MessageBox extends Sprite implements IKeyPressable, IInitiater
   {
      ...
      protected var endXPos:Number = 256;
      
      protected var endYPos:Number = 240;
      ...
      protected function createGraphics(param1:Number = NaN, param2:Number = NaN, param3:int = 0, param4:int = 0) : void
      {
         ...
         _loc5_.y = FRAME_CROP;
         addChild(_loc5_);
         var _loc6_:Rectangle = getVisibleBounds(_loc5_);
         _loc7_ = _loc6_.width;
         ...
         if(Boolean(this.maxHeight) && this.bg.height > this.maxHeight)
         {
      ...
      public function resizeBox(param1:Boolean = true, param2:Boolean = true, param3:int = 0, param4:int = 0) : void
      {
         ...
         {
            _loc8_ = getChildAt(_loc7_);
            if(_loc8_ != this.TXT_CONT)
            {
               removeChild(_loc8_);
               _loc7_--;
            }
      ...
      protected function destroy() : void
      {
         ...
         if(Boolean(this.cancelTmr) && this.cancelTmr.hasEventListener(TimerEvent.TIMER_COMPLETE))
         {
            this.cancelTmr.removeEventListener(TimerEvent.TIMER_COMPLETE,this.cancelTmrHandeler);
         }
         this.UPD_TMR.stop();
