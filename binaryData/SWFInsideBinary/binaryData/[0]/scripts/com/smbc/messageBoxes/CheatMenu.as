package com.smbc.messageBoxes
{
   ...
   public class CheatMenu extends SettingsMenuBox
   {
      ...
      override protected function chooseItem(param1:String, param2:String, param3:TextFieldContainer, param4:int) : void
      {
         ...
         var _loc6_:int = -1;
         if(Boolean(param3) && param3.text == MenuBoxItems.HIDDEN_CHEAT)
         {
         ...
         switch(param1)
         {
            ...
            case MenuBoxItems.ALL_WEAPONS_PIERCE:
               _loc8_ = convertToOnOffStr(Cheats.allWeaponsPierce = !Cheats.allWeaponsPierce);
               break;
            case MenuBoxItems.ALL_GROUND_IS_BRICKS:
               _loc8_ = convertToOnOffStr(Cheats.allGroundIsBricks = !Cheats.allGroundIsBricks);
               break;
            case MenuBoxItems.ALWAYS_BREAK_BRICKS:
               _loc8_ = convertToOnOffStr(Cheats.alwaysBreakBricks = !Cheats.alwaysBreakBricks);
               break;
            ...
            case MenuBoxItems.INVINCIBLE:
               ...
               _loc8_ = convertToOnOffStr(_loc7_);
               if(Boolean(_loc5_) && Boolean(_loc5_.player))
               {
                  if(_loc7_)
                  {
            ...
            case MenuBoxItems.WATER_MODE:
               ...
               _loc8_ = convertToOnOffStr(_loc7_);
               if(Boolean(_loc5_) && !_loc5_.initialWaterLevel)
               {
                  if(_loc7_)
                  {
