      ...
      override protected function chooseItem(param1:String, param2:String, param3:TextFieldContainer, param4:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case MenuBoxItems.DAMAGE_RESPONSE:
               if(GameSettings.classicMode)
               {
                  GameSettings.classicDamageResponse = GameSettings.classicDamageResponse.GetAtIndex(param4) as ClassicDamageResponse;
                  _loc5_ = GameSettings.classicDamageResponse.NiceName;
               }
               else
               {
