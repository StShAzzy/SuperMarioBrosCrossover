package com.smbc.messageBoxes
{
   ...
   public class GridMenuBox extends MessageBox
   {
      ...
      public function GridMenuBox(param1:Boolean = false)
      {
      ...
      override protected function setUpText() : void
      {
         ...
         {
            if(!this.itemContainerMaskRectangle.contains(_loc4_.x,_loc4_.y) && Boolean(_loc4_.parent))
            {
      ...
      private function modifySelection(param1:int, param2:int) : void
      {
         ...
         var _loc5_:GridItem = this.getItemAt(_loc3_,_loc4_);
         if(_loc5_ != null)
         {
         ...
         else
         {
            ...
            else if(param2 != 0)
            {
               if(param2 < 0)
               {
                  _loc4_ = this.getItemCountInColumn(_loc3_) - 1;
                  if(_loc4_ != this.rowCount - 1)
                  {
            ...
            _loc5_ = this.getItemAt(_loc3_,_loc4_);
            if(_loc5_ != null)
            {
               this.setSelection(_loc5_);
            }
      ...
      protected function desaturate(param1:GridItem) : void
      {
         var _loc3_:Array = null;
         var _loc4_:ColorMatrixFilter = null;
         var _loc2_:Sprite = param1.getBmpSprite();
         if(_loc2_)
         {
            _loc3_ = [];
            _loc3_ = _loc3_.concat([0.3,0.59,0.11,0,-10]);
            _loc3_ = _loc3_.concat([0.3,0.59,0.11,0,-10]);
            _loc3_ = _loc3_.concat([0.3,0.59,0.11,0,-10]);
      ...
      protected function resaturate(param1:GridItem) : void
      {
