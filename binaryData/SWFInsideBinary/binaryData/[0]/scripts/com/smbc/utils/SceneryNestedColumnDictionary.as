   ...
   public final dynamic class SceneryNestedColumnDictionary extends CustomDictionary
   {
      ...
      override public function addItem(param1:Object, param2:Object = null) : void
      {
         ...
         if(!this[param1])
         {
            ...
            _loc4_ = _loc3_.x;
            _loc5_ = _loc3_.y;
            _loc6_ = this.COL_DCTS[_loc4_];
            if((Boolean(_loc6_)) && _loc3_.width <= TILE_SIZE)
            {
            ...
            {
               _loc6_ = this.COL_DCTS[NON_GRID_ITEM_KEY];
               if(_loc6_)
               {
                  _loc3_.colKey = _loc4_;
      ...
      override public function removeItem(param1:Object) : void
      {
         ...
         if(this[param1])
         {
            ...
            if(param1 is Scenery)
            {
               ...
               if(Boolean(_loc3_) && Boolean(_loc3_[_loc2_.rowKey]))
               {
                  _loc2_.colKey = NaN;
                  _loc4_ = _loc3_[_loc2_.rowKey];
                  if(_loc4_.length <= 1)
                  {
