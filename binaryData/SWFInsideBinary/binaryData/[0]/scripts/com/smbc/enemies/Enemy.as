package com.smbc.enemies
{
   ...
   public class Enemy extends AnimatedObject implements IAttackable
   {
      ...
      private const F_CR_2_RED_R:Number = 1;
      
      private const F_CR_2_RED_G:Number = 0;
      
      private const F_CR_2_RED_B:Number = 0;
      
      private const F_CR_2_GREEN_R:Number = 1;
      
      private const F_CR_2_GREEN_G:Number = 1;
      
      private const F_CR_2_GREEN_B:Number = 1;
      ...
      private const F_CR_3_GREEN_B:Number = 1;
      ...
      internal function setStopFrame(param1:String) : void
      {
      ...
      internal function setPlayFrame(param1:String) : void
      {
         if(currentFrameLabel != this.convLab(param1))
         {
            this.gotoAndStop(this.convLab(param1));
      ...
      {
         if(Boolean(getStatusEffect(STATFX_FREEZE)) || Boolean(getStatusEffect(STATFX_STOP)))
         {
            return;
         }
         if(param2 == "left")
      ...
      {
         if(cState == ST_DIE || param1.HIT_OBJS_DCT[this] || Boolean(param1.getProperty(PR_PASSTHROUGH_ALWAYS)))
         {
            return;
         }
      ...
      private function checkAttackProps(param1:LevObj) : Boolean
      {
         ...
         else if(Boolean(_loc2_) && isSusceptibleToProperty(_loc2_))
         {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            {
               _loc7_ = _loc6_.getStatusEffectFromValue(this,param1);
               if(_loc7_)
               {
