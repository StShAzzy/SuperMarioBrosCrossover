package com.smbc.enemies
{
   ...
   public class Bowser extends Enemy
   {
      ...
      protected var hammerType:String;
      ...
      protected var fireBallClass:Class;
      ...
      public function Bowser(param1:String = null)
      {
         this.hammerType = Hammer.TYPE_BOWSER;
         this.fireBallClass = BowserFireBall;
         var _loc2_:String = BOWSER_TYPE_FIREBALL;
         if(param1 != null)
         {
            _loc2_ = Level.ExtractLevelDataProperty(param1,Level.PROP_BOWSER_TYPE,true);
         }
         this.determineType(_loc2_);
         super();
      ...
      protected function determineType(param1:String) : void
      {
         switch(param1)
         {
      ...
      override protected function updateStats() : void
      {
         ...
         else if(!this.gotAxe)
         {
            if(cState == ST_CHASE)
            {
               this.returnToNormalStateFromChase();
            }
            setState(ST_NORMAL);
            scaleX = -1;
      ...
      private function fbDelTmrLsr(param1:TimerEvent) : void
      {
         ...
         if(onScreen)
         {
            ...
            {
               _loc2_ = new this.fireBallClass(this) as BowserFireBall;
         ...
         {
            _loc2_ = new this.fireBallClass(this);
            this.FB_DCT.addItem(_loc2_);
            level.addToLevel(_loc2_);
         }
      }
      ...
      private function throwHammerTmrHandler(param1:TimerEvent) : void
      {
         ...
         {
            _loc2_ = new Hammer(this.hammerType,this);
