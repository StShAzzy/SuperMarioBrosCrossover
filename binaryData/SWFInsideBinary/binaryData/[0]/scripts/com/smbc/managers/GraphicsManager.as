   ...
   public class GraphicsManager extends MainManager
   {
      ...
      
      {
         ...
         (function():void
         {
            ...
            {
               var _loc5_:* = CHAR_INFO_VEC[param1];
               if(!_loc5_)
               {
                  _loc5_ = [];
      ...
      {
         var inactiveSkinsArr:Array;
         var skinArr:Vector.<BmdSkinCont>;
         var skinNum:int = 0;
         var n:int = 0;
         var i:int = 0;
         ...
         BmdInfo.initiate();
         inactiveSkinsArr = GameSettings.INACTIVE_SKIN_NUMS;
         ...
         skinArr = BmdInfo.BMC_VEC;
         n = int(skinArr.length);
         i = 0;
         while(i < n)
         {
            bmc = skinArr[i];
            ...
            if(bmcType == TYPE_CHARACTER)
            {
               ...
               m = int(charNumArr.length);
               j = 0;
               while(j < m)
               {
                  charNum = int(charNumArr[j]);
      ...
      private function nextSkin(param1:int, param2:int) : int
      {
         ...
         var _loc4_:int = _loc3_.indexOf(param2) + 1;
      ...
      private function getRandomSkinNum(param1:int) : int
      {
         var _loc2_:int = -1;
         var _loc3_:int = int(this.CLEAN_BMC_VEC_CHARACTER[param1].length - 1);
         do
         {
            _loc2_ = int(Math.random() * (_loc3_ + 1));
         }
         while(!StatManager.characterSkinIsEnabled(param1,_loc2_));
      ...
      public function changeCharacterSkin(param1:Character, param2:int = -1) : void
      {
         ...
         var _loc5_:int = int(this.CLEAN_BMC_VEC_CHARACTER[_loc3_].length);
         var _loc6_:int = _loc5_ - 1;
         _loc4_ = this.nextSkin(_loc3_,_loc4_);
         ...
         {
            _loc4_ = this.getRandomSkinNum(_loc3_);
         }
      ...
      private function resetBmd(param1:BmdSkinCont) : void
      {
         ...
         if(_loc4_ == TYPE_CHARACTER)
         {
            _loc5_ = int(param1.charArr[0]);
      ...
      public function prepareRecolor(param1:BmdSkinCont, param2:int = -1, param3:Array = null, param4:Boolean = false, param5:Boolean = false) : void
      {
         ...
         var _loc9_:int = param1.type;
         if(_loc9_ == TYPE_MAP || _loc9_ == TYPE_ENEMY || _loc9_ == TYPE_INTERFACE || _loc9_ == TYPE_THEME)
         {
      ...
      public function changeActiveSkins() : void
      {
         ...
         if(MessageBox.activeInstance != _loc1_)
         {
            _loc1_ = null;
         }
      ...
      public function skinIsActive(param1:BmdSkinCont, param2:int = -1) : Boolean
      {
         ...
         if(param1.type == TYPE_CHARACTER)
         {
            return StatManager.characterSkinIsEnabled(param1.charNum,param1.skinNum);
         }
         if(param1.type != BmdSkinCont.TYPE_NEUTRAL && param1.type != BmdSkinCont.TYPE_PALETTE)
         {
            return StatManager.skinSetIsEnabled(param1.skinNum);
         }
         return true;
      }
      ...
      public function readPalette(param1:BitmapData, param2:Point) : Array
      {
         ...
         var _loc11_:int = 0;
         var _loc3_:Array = [];
         var _loc4_:uint = param1.getPixel32(param2.x,param2.y);
         if(_loc4_ != COLOR_STANDARD_PALETTE)
         {
         ...
         {
            _loc4_ = param1.getPixel32(param2.x,param2.y + _loc9_);
            if(_loc4_ != COLOR_END && _loc4_ != COLOR_NEW_ROW && _loc4_ != COLOR_NEW_REGULAR_PALETTE && _loc4_ != COLOR_NEW_FLASH_PALETTE)
            {
               _loc8_ = _loc9_;
            }
      ...
      public function recolorSingleBitmap(param1:BitmapData, param2:Palette, param3:Palette, param4:int = 0, param5:int = 0, param6:Rectangle = null) : void
      {
         ...
         while(_loc9_ < _loc7_)
         {
            ...
            _loc13_ = int(param1.threshold(_loc8_,param6,param6.topLeft,"==",_loc11_,_loc12_));
            _loc9_++;
         }
      }
      ...
      private function recolorItems(param1:BmdSkinCont, param2:Array, param3:int = 0) : void
      {
         ...
         var _loc4_:BitmapData = param1.bmd;
         _loc4_.lock();
         var _loc5_:int = int(param2.length);
         var _loc12_:int = param1.type;
         if(_loc12_ == BmdSkinCont.TYPE_CHARACTER)
         {
         ...
         while(_loc13_ < _loc5_)
         {
            ...
            if(!(!_loc15_ || !_loc15_[INFO_ARR_IND_RECOLOR]))
            {
               _loc16_ = _loc7_.getInOutPalette(_loc13_,_loc9_,_loc10_,_loc8_);
               if(!((_loc17_ = _loc16_.getRowFirstColor(1)) != COLOR_NEW_ROW && _loc17_ != COLOR_NEW_REGULAR_PALETTE))
               {
