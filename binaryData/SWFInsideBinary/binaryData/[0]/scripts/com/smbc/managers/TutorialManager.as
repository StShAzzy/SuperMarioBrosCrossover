package com.smbc.managers
{
   ...
   public final class TutorialManager extends MainManager
   {
      ...
      public function checkTutorial(param1:String, param2:Boolean = false) : Boolean
      {
         ...
         var _loc3_:int = int(this.TUT_VEC.length);
         var _loc5_:int = 0;
         while(_loc5_ < _loc3_)
         {
            _loc6_ = this.TUT_VEC[_loc5_];
            _loc7_ = _loc6_[this.NAME_IND];
            _loc8_ = _loc6_[this.MSG_ARR_IND];
            if(_loc7_ == param1 && Boolean(_loc6_[this.ENABLED_IND]))
            {
               _loc9_ = 0;
      ...
      public function saveData() : Array
      {
         var _loc3_:int = 0;
         var _loc1_:Array = [];
         var _loc2_:int = int(this.TUT_VEC.length);
         while(_loc3_ < _loc2_)
         {
