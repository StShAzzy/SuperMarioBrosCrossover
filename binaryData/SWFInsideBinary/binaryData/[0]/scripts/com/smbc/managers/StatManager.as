package com.smbc.managers
{
   ...
   public final class StatManager extends MainManager
   {
      ...
      private var enabledCharactersVec:Vector.<Boolean>;
      
      private var enabledCharacterSkinsVec:Vector.<Vector.<Boolean>>;
      
      private var enabledSkinSetsVec:Vector.<Boolean>;
      ...
      public function StatManager()
      {
         ...
         this.enabledCharactersVec = new Vector.<Boolean>(Character.NUM_CHARACTERS,true);
         this.enabledCharacterSkinsVec = new Vector.<Vector.<Boolean>>(Character.NUM_CHARACTERS,true);
         this.enabledSkinSetsVec = new Vector.<Boolean>(BmdInfo.NUM_SKIN_SETS,true);
      ...
      public static function characterIsEnabled(param1:int) : Boolean
      {
         return STAT_MNGR.enabledCharactersVec[param1];
      }
      ...
      public static function get enabledCharacterCount() : int
      {
         ...
         var _loc1_:int = 0;
         for each(_loc2_ in STAT_MNGR.enabledCharactersVec)
         {
            if(_loc2_)
            {
               _loc1_++;
      ...
      public static function getEnabledCharacterSkinCount(param1:int) : int
      {
         var _loc3_:Boolean = false;
         var _loc2_:int = 0;
         for each(_loc3_ in STAT_MNGR.enabledCharacterSkinsVec[param1])
         {
            if(_loc3_)
            {
               _loc2_++;
      ...
      public static function get enabledSkinSetCount() : int
      {
         var _loc2_:Boolean = false;
         var _loc1_:int = 0;
         for each(_loc2_ in STAT_MNGR.enabledSkinSetsVec)
         {
            if(_loc2_)
            {
               _loc1_++;
      ...
      public static function toggleCharacterIsEnabled(param1:int) : Boolean
      {
         return STAT_MNGR.enabledCharactersVec[param1] = !STAT_MNGR.enabledCharactersVec[param1];
      }
      
      public static function characterSkinIsEnabled(param1:int, param2:int) : Boolean
      {
         return STAT_MNGR.enabledCharacterSkinsVec[param1][param2];
      }
      
      public static function skinSetIsEnabled(param1:int) : Boolean
      {
         return STAT_MNGR.enabledSkinSetsVec[param1];
      }
      
      public static function toggleSkinSetEnabled(param1:int) : Boolean
      {
         return STAT_MNGR.enabledSkinSetsVec[param1] = !STAT_MNGR.enabledSkinSetsVec[param1];
      }
      
      public static function toggleCharacterSkinEnabled(param1:int, param2:int) : Boolean
      {
         return STAT_MNGR.enabledCharacterSkinsVec[param1][param2] = !STAT_MNGR.enabledCharacterSkinsVec[param1][param2];
      }
      
      private static function disableAtariSkins() : void
      {
         var _loc1_:int = 0;
         while(_loc1_ < Character.NUM_CHARACTERS)
         {
            STAT_MNGR.enabledCharacterSkinsVec[_loc1_][Character.getAtariSkinNumber(_loc1_)] = false;
            _loc1_++;
         }
         STAT_MNGR.enabledCharacterSkinsVec[Bill.CHAR_NUM][Bill.SKIN_LANCE_ATARI] = false;
      ...
      private static function disableSharpX1Skins() : void
      {
         ...
         while(_loc1_ < Character.NUM_CHARACTERS)
         {
            STAT_MNGR.enabledCharacterSkinsVec[_loc1_][Character.getSpecialSkinNumber(_loc1_)] = false;
            _loc1_++;
         }
         STAT_MNGR.enabledCharacterSkinsVec[Bill.CHAR_NUM][Bill.SKIN_LANCE_X1] = false;
      ...
      {
         var _loc2_:Vector.<Boolean> = null;
         var _loc3_:int = 0;
         var _loc1_:int = 0;
         while(_loc1_ < STAT_MNGR.enabledCharacterSkinsVec.length)
         {
            _loc2_ = STAT_MNGR.enabledCharacterSkinsVec[_loc1_];
            _loc3_ = 0;
         ...
         _loc1_ = 0;
         while(_loc1_ < BmdInfo.NUM_SKIN_SETS)
         {
            STAT_MNGR.enabledSkinSetsVec[_loc1_] = false;
            _loc1_++;
         }
      }
      ...
      public static function enableAllSkinsExceptInvisible() : void
      {
         ...
         while(_loc1_ < BmdInfo.NUM_SKIN_SETS)
         {
            STAT_MNGR.enabledSkinSetsVec[_loc1_] = true;
            _loc1_++;
         }
      ...
      public static function enable8BitSkinsOnly() : void
      {
         ...
         var _loc5_:int = 0;
         var _loc1_:BmdSkinCont = null;
         var _loc2_:int = 0;
         while(_loc2_ < STAT_MNGR.enabledCharacterSkinsVec.length)
         {
            _loc4_ = STAT_MNGR.enabledCharacterSkinsVec[_loc2_];
            _loc5_ = 0;
            while(_loc5_ < _loc4_.length)
            {
               _loc1_ = STAT_MNGR.getBmc(_loc2_,_loc5_);
               if(_loc1_.consoleType == ConsoleType.BIT_8 || _loc1_.consoleType == ConsoleType.GB)
               {
                  _loc4_[_loc5_] = true;
               }
               else
         ...
         var _loc3_:Vector.<BmdSkinCont> = BmdInfo.getBmcVec();
         _loc2_ = 0;
         while(_loc2_ < BmdInfo.NUM_SKIN_SETS)
         {
            _loc1_ = _loc3_[_loc2_];
            if(_loc1_.consoleType == ConsoleType.BIT_8 || _loc1_.consoleType == ConsoleType.GB)
            {
               STAT_MNGR.enabledSkinSetsVec[_loc2_] = true;
            }
            else
            {
               STAT_MNGR.enabledSkinSetsVec[_loc2_] = false;
            }
            _loc2_++;
         }
         disableAtariSkins();
      ...
      public static function enable16BitSkinsOnly() : void
      {
         ...
         while(_loc2_ < STAT_MNGR.enabledCharacterSkinsVec.length)
         {
            ...
            {
               _loc1_ = STAT_MNGR.getBmc(_loc2_,_loc5_);
               if(_loc1_.consoleType == ConsoleType.BIT_16)
               {
                  _loc4_[_loc5_] = true;
               }
               else
      ...
      public static function enableGameBoySkinsOnly() : void
      {
         ...
         while(_loc2_ < STAT_MNGR.enabledCharacterSkinsVec.length)
         {
            ...
            {
               _loc1_ = STAT_MNGR.getBmc(_loc2_,_loc5_);
               if(_loc1_.consoleType == ConsoleType.GB)
               {
                  _loc4_[_loc5_] = true;
               }
               else
      ...
      public static function enableSharpX1SkinsOnly() : void
      {
         ...
         while(_loc1_ < Character.NUM_CHARACTERS)
         {
            STAT_MNGR.enabledCharacterSkinsVec[_loc1_][Character.getSpecialSkinNumber(_loc1_)] = true;
            _loc1_++;
         }
         STAT_MNGR.enabledCharacterSkinsVec[Bill.CHAR_NUM][Bill.SKIN_LANCE_X1] = true;
      ...
      public static function enableAtariSkinsOnly() : void
      {
         ...
         while(_loc1_ < Character.NUM_CHARACTERS)
         {
            STAT_MNGR.enabledCharacterSkinsVec[_loc1_][Character.getAtariSkinNumber(_loc1_)] = true;
            _loc1_++;
         }
         STAT_MNGR.enabledCharacterSkinsVec[Bill.CHAR_NUM][Bill.SKIN_LANCE_ATARI] = true;
      ...
      public static function enableClassicSkinsOnly() : void
      {
         ...
         while(_loc1_ < Character.NUM_CHARACTERS)
         {
            STAT_MNGR.enabledCharacterSkinsVec[_loc1_][0] = true;
            _loc1_++;
         }
      ...
      public static function enableClassic16BitSkinsOnly() : void
      {
         ...
         while(_loc1_ < Character.NUM_CHARACTERS)
         {
            STAT_MNGR.enabledCharacterSkinsVec[_loc1_][1] = true;
            _loc1_++;
         }
      ...
      {
         this.firstLevel = LevelID.Create(GameSettings.FIRST_LEVEL);
         super.initiate();
      ...
      private function setUpDefaultVecs() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            this.enabledCharactersVec[_loc2_] = true;
            this.enabledCharacterSkinsVec[_loc2_] = new Vector.<Boolean>(CHAR_SKIN_ORDER_VEC[_loc2_].length,true);
            _loc2_++;
         }
      ...
      public function resetAllStats(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            this._currentLevelID = this.firstLevel;
         }
         this._newLev = true;
         this.passedHw = false;
      }
      ...
      {
         this._currentLevelID = new LevelID(this._currentLevelID.world,1);
      }
      ...
      public function startNewLevel() : void
      {
         ...
         if(level.newLev)
         {
            ...
            if(GameSettings.DEBUG_MODE && Boolean(GameSettings.OVERRIDE_TIME_LEFT))
            {
      ...
      {
         if(param2 == LEV_NUM_MAX || param1 == this.LAST_WORLD && param2 == LEV_NUM_MAX - 1)
         {
            this._allowCharacterRevival = true;
         }
      }
      ...
      public function beatGameHandler() : void
      {
         ...
         if(this._numBricksBroken >= NUM_BRICKS_TO_BREAK)
         {
            _loc1_.push(MenuBoxItems.ALWAYS_BREAK_BRICKS);
         }
      ...
      public function setRandomCharNum() : void
      {
         ...
         while(!StatManager.characterIsEnabled(this.curCharNum));
      ...
      public function saveAreaStats(param1:String, param2:String, param3:String, param4:Array) : Array
      {
         ...
         else
         {
            ...
            {
               _loc9_ = this._levStatsVec[_loc8_][0];
               if(_loc9_ == param2)
               {
      ...
      private function saveStats() : Array
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            _loc6_ = _loc1_[_loc4_][IND_LOAD_SAVE_ARR_VALUE];
            if(_loc6_ is int || _loc6_ is Boolean)
            {
      ...
      private function loadStats(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            _loc6_ = _loc5_[IND_LOAD_SAVE_ARR_NAME];
            _loc7_ = int(param1[0]);
         ...
         this._currentLevelID = new LevelID(this.curWorldNum,this.curLevNum);
      }
      ...
      private function saveVector(param1:Vector.<Object>) : Array
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            if(_loc5_ is Array || _loc5_ is Vector.<*>)
            {
      ...
      private function loadVectorNestedStuff(param1:Array, param2:Array) : void
      {
         ...
         while(_loc7_ < _loc6_)
         {
            ...
            else if(_loc3_ == Vector.<Enum>)
            {
               _loc5_[_loc7_] = Enum(_loc5_[_loc7_]).GetAtIndex(param1.shift());
            }
            else if(_loc3_ == Vector.<Boolean>)
            {
               _loc5_[_loc7_] = Boolean(param1.shift());
            }
            else
            {
               if(_loc3_ != Vector.<Vector.<Boolean>>)
               {
                  throw new Error("unknown type");
               }
               _loc5_[_loc7_] = this.loadVectorBoolean(param1);
            }
            _loc7_++;
         }
      }
      ...
      private function loadVectorBoolean(param1:Array) : Vector.<Boolean>
      {
         ...
         while(_loc4_ < _loc3_)
         {
            _loc2_.push(Boolean(param1.shift()));
            _loc4_++;
         }
         return _loc2_;
      }
      ...
      private function fileRefLoadCompleteHandler(param1:Event) : void
      {
         ...
         this._fileRef = null;
         var _loc3_:int = int(_loc2_.indexOf(this.SAVE_DATA_PREFIX_STR));
         var _loc4_:int = int(_loc2_.indexOf(this.SAVE_DATA_SUFFIX_STR));
         ...
         var _loc5_:Array = _loc2_.split(this.SAVE_DATA_STR_DIVIDER);
         ...
         var _loc8_:Number = Versions.toNum(_loc5_.shift());
         if(_loc8_ < GameSettings.VERSION_SAVE_FILE_COMPAT_MIN || _loc6_ < this.LOAD_DATA_REQ_LENGTH)
         {
         ...
         _loc6_ = int(btnMngr.keyCodesVec.length);
      ...
      public function getBmc(param1:int, param2:int) : BmdSkinCont
      {
         return GraphicsManager.INSTANCE.CLEAN_BMC_VEC_CHARACTER[param1][param2];
      }
      ...
      public function changeStat(param1:String, param2:int, param3:Function = null) : void
      {
         ...
         var _loc6_:int = int(this[param1]);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_)
         {
         ...
         _loc6_ += param2;
         var _loc8_:int = int(this[_loc4_ + this.MAX_STR]);
         var _loc9_:int = int(this[_loc4_ + this.MIN_STR]);
         if(_loc6_ > _loc8_)
         {
            _loc6_ = _loc8_;
         }
      ...
      {
         var _loc2_:CustomDictionary = null;
         if(GameSettings.classicMode)
         {
            _loc2_ = this.getObtainedUpgradesDct(param1);
            return _loc2_[PickupInfo.MUSHROOM] != undefined && _loc2_[PickupInfo.FIRE_FLOWER] != undefined;
         }
      ...
      public function addCharUpgrade(param1:int, param2:String) : void
      {
         ...
         if(param2 == PickupInfo.FIRE_FLOWER && this.curCharNum != Mario.CHAR_NUM && this.curCharNum != Luigi.CHAR_NUM && GameSettings.powerupMode != PowerupMode.Classic)
         {
            return;
         }
         ...
         if(player)
         {
            if(param2 == PickupInfo.MUSHROOM)
            {
               if(GameSettings.powerupMode == PowerupMode.Classic)
               {
                  for each(_loc4_ in player.classicGetMushroomUpgrades)
                  {
                     this.addCharUpgrade(param1,_loc4_);
                  }
               }
               else
               {
            ...
            else if(GameSettings.powerupMode == PowerupMode.Classic && param2 == PickupInfo.FIRE_FLOWER)
            {
               for each(_loc4_ in player.classicGetFireFlowerUpgrades)
               {
                  this.addCharUpgrade(param1,_loc4_);
               }
            }
            _loc3_ = player.replaceableUpgrades[param2];
            if(Boolean(_loc3_) && !this.obtainedUpgradesVec[param1][_loc3_])
            {
               this.availableUpgradesVec[param1].addItem(_loc3_);
            }
         }
      ...
      public function hasCompetingSingleItem(param1:int, param2:String) : Boolean
      {
         ...
         var _loc4_:CustomDictionary = this.SINGLE_UPGRADES_VEC[param1];
         if(_loc4_[param2])
         {
            for each(_loc5_ in _loc4_)
            {
               if(Boolean(_loc3_[_loc5_]) && _loc5_ != param2)
               {
                  return true;
               }
            }
      ...
      public function removeAllUpgradesForChar(param1:int, param2:Boolean = false, param3:Boolean = false) : void
      {
         ...
         {
            if(Boolean(player) && player.neverLoseUpgrades[_loc7_] != undefined)
            {
               _loc6_.addItem(_loc7_,_loc7_);
            }
            if(Boolean(player) && player.restorableUpgrades[_loc7_] != undefined)
            {
      ...
      public function removeCharUpgrade(param1:int, param2:String, param3:Boolean = false) : void
      {
         ...
         if(param2 == PickupInfo.MUSHROOM && player && GameSettings.difficulty != Difficulties.VERY_EASY && !GameSettings.classicMode)
         {
            for each(_loc4_ in player.mushroomUpgrades)
            {
      ...
      public function getRandomUpgrade(param1:int) : String
      {
         ...
         var _loc4_:int = this.getNextAvailableTier(param1);
         if(_loc4_ != -1)
         {
      ...
      public function getNextAvailableTier(param1:int) : int
      {
         ...
         var _loc7_:int = this.getTier(param1) + 1;
         if(_loc7_ > _loc6_)
         {
            _loc7_ = 0;
         }
         ...
         while(_loc8_ <= _loc6_)
         {
            ...
            {
               if(_loc4_.containsValue(_loc10_) && Boolean(player))
               {
                  _loc10_ = player.replaceableUpgrades[_loc10_];
               }
               if(Boolean(_loc10_) && !_loc4_.containsValue(_loc10_))
               {
                  return _loc8_;
               }
            }
      ...
      private function setTier(param1:int, param2:int) : void
      {
         ...
         {
            if(_loc4_.containsValue(_loc6_) && Boolean(player))
            {
               _loc6_ = player.replaceableUpgrades[_loc6_];
            }
            if(Boolean(_loc6_) && !_loc4_.containsValue(_loc6_))
            {
      ...
      public function set currentLevelID(param1:LevelID) : void
      {
