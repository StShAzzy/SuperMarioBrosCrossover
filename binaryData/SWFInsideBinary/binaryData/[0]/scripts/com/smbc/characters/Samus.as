package com.smbc.characters
{
   ...
   public class Samus extends Character
   {
      ...
      public static const SKIN_ORDER:Array = [SKIN_SAMUS_NES,SKIN_SAMUS_SNES,SKIN_SAMUS_GB,SKIN_SAMUS_X1,SKIN_SAMUS_ATARI,SKIN_SAMUS_NO_SUIT_NES,SKIN_SAMUS_NO_SUIT_SNES,SKIN_SAMUS_NO_SUIT_SUPER_METROID,SKIN_SAMUS_ZERO_SUIT_NES,SKIN_DARK_SAMUS_NES,SKIN_DARK_SAMUS_SNES,SKIN_DARK_SAMUS_GB,SKIN_PIT_NES,SKIN_DARK_PIT_NES];
      ...
      private const REPL_COLOR_1_1:uint = 4293132376;
      
      private const REPL_COLOR_2_1:uint = 4291316748;
      
      private const REPL_COLOR_3_1:uint = 4294755580;
      
      private const REPL_COLOR_1_2:uint = 4292356096;
      
      private const REPL_COLOR_2_2:uint = 4278227968;
      
      private const REPL_COLOR_3_2:uint = 4294744120;
      
      private const REPL_COLOR_1_3:uint = 4292356096;
      
      private const REPL_COLOR_2_3:uint = 4278227968;
      
      private const REPL_COLOR_3_3:uint = 4294755544;
      ...
      {
         return Vector.<String>([this.classicWeapon,SAMUS_SCREW_ATTACK,SAMUS_MISSILE_CAPACITY]);
      }
      
      override public function get classicLoseFireFlowerUpgrades() : Vector.<String>
      {
         return Vector.<String>([this.classicWeapon,SAMUS_SCREW_ATTACK]);
      }
      ...
      override public function hitPickup(param1:Pickup, param2:Boolean = true) : void
      {
         ...
         var _loc4_:Boolean = upgradeIsActive(SAMUS_MISSILE);
         ...
         switch(param1.type)
         {
            ...
            case MUSHROOM:
               ...
               {
                  this.setAmmo(SAMUS_MISSILE,CLASSIC_MISSILE_DEFAULT_AMMO);
               }
               this.changeSuitColor();
               this.updDrops();
               this.updAmmoDisplay();
