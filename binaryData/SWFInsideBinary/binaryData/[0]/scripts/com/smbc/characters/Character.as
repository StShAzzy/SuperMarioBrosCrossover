package com.smbc.characters
{
   ...
   public class Character extends AnimatedObject implements IKeyPressable, IKeyReleasable
   {
      ...
      protected const STAR_COLOR_1_1:uint = 4278233088;
      
      protected const STAR_COLOR_2_1:uint = 4294744120;
      
      protected const STAR_COLOR_3_1:uint = 4294967295;
      
      protected const STAR_COLOR_1_2:uint = 4292356096;
      
      protected const STAR_COLOR_2_2:uint = 4294744120;
      
      protected const STAR_COLOR_3_2:uint = 4294967295;
      
      protected const STAR_COLOR_1_3:uint = 4278190080;
      
      protected const STAR_COLOR_2_3:uint = 4291316748;
      
      protected const STAR_COLOR_3_3:uint = 4294753456;
      
      protected var outColor1_1:uint = 4278233088;
      
      protected var outColor2_1:uint = 4294744120;
      
      protected var outColor3_1:uint = 4294967295;
      
      protected var outColor1_2:uint = 4292356096;
      
      protected var outColor2_2:uint = 4294744120;
      
      protected var outColor3_2:uint = 4294967295;
      
      protected var outColor1_3:uint = 4278190080;
      
      protected var outColor2_3:uint = 4291316748;
      
      protected var outColor3_3:uint = 4294753456;
      ...
      public function Character()
      {
         ...
         _loc5_ = classObj[SUFFIX_VEC_PROPERTY_NAME];
         if(_loc5_)
         {
      ...
      public static function getSkinPreviews(param1:int) : Vector.<CustomMovieClip>
      {
         var _loc2_:Object = CharacterInfo.getCharClassFromNum(param1) as Object;
         var _loc3_:int = 0;
         if(Boolean(Level.levelInstance) && Boolean(Level.levelInstance.player))
         {
      ...
      public static function getAmmoVec(param1:int) : Array
      {
         ...
         while(_loc7_ < _loc6_)
         {
            ...
            _loc10_ = _loc9_[IND_AMMO_ARR_IND];
      ...
      private static function setUpAmmoDepletionDct(param1:int) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            _loc8_ = _loc7_[IND_AMMO_DEPL_ARR_TYPE];
      ...
      public function get classicGetMushroomUpgrades() : Vector.<String>
      {
         return new Vector.<String>();
      }
      
      public function get classicLoseMushroomUpgrades() : Vector.<String>
      {
         return this.classicGetMushroomUpgrades;
      }
      
      public function get classicGetFireFlowerUpgrades() : Vector.<String>
      {
         return new Vector.<String>();
      }
      
      public function get classicLoseFireFlowerUpgrades() : Vector.<String>
      {
         return this.classicGetFireFlowerUpgrades;
      }
      ...
      protected function saveSkinPreviews() : Boolean
      {
         ...
         while(_loc5_ < _loc2_.length)
         {
            ...
            while(_loc7_ < _loc3_)
            {
               ...
               _loc9_ = ImageSaver.INSTANCE.getBitmapData(this,0);
               _loc10_ = _loc9_.getColorBoundsRect(4294967295,0,false);
               ...
               _loc11_.copyPixels(_loc9_,_loc10_,GlobVars.ZERO_PT);
               _loc12_ = new CustomMovieClip();
               _loc12_.setNumFrames(1);
      ...
      override public function animate(param1:ICustomTimer) : Boolean
      {
         ...
         if(param1 == this.swapAnimTmr && Boolean(this.SWAP_PS_VEC.length))
         {
            this.swapPs();
         }
      ...
      override protected function updateStats() : void
      {
         ...
         this.checkPlatform();
         if(Boolean(this.C_HIT_DCT.length) || Boolean(this.L_HIT_DCT.length))
         {
         ...
         if(Boolean(this.pipe) && cState != "pipe")
         {
            this.pipe = null;
         }
      ...
      protected function activateStoredButtons() : void
      {
         ...
         var _loc1_:int = int(this.STORED_BUTTONS_VEC.length);
         while(_loc2_ < _loc1_)
         {
      ...
      {
         var _loc2_:int = int(this.pState - 1);
         if(_loc2_ < 0)
         {
            _loc2_ = 0;
         }
      ...
      override public function groundBelow(param1:Ground) : void
      {
         ...
         if(!lastOnGround && !onGround && !(param1 is SpringRed) && cState != ST_FLAG_SLIDE && cState != this.ST_VINE)
         {
            this.landOnGround();
         }
         super.groundBelow(param1);
         if(!(param1 is SpringRed))
         {
      ...
      {
         var _loc4_:TutorialManager = null;
         var _loc5_:PipeTransporter = null;
         if(this.dead)
         {
            return;
         }
         ...
         var _loc3_:Boolean = this.upgradeIsActive(FIRE_FLOWER);
         ...
         if(param1.mainType == PickupInfo.MAIN_TYPE_UPGRADE)
         {
            ...
            else if(GameSettings.classicMode && param1.type == MUSHROOM && this.upgradeIsActive(MUSHROOM))
            {
               param1.type = FIRE_FLOWER;
               param1.playsRegularSound = true;
            }
         ...
         switch(param1.type)
         {
            ...
            case PickupInfo.STAR:
               ...
               SND_MNGR.playSound(this.SFX_GAME_POWER_UP);
               _loc4_ = TutorialManager.TUT_MNGR;
               _loc4_.checkTutorial(_loc4_.TYPE_STAR,true);
               break;
            ...
            case PickupInfo.PIPE_TRANSPORTER:
               _loc5_ = param1 as PipeTransporter;
               if(_loc5_.ptType == "global")
               {
                  if(_loc5_.axis == "horizontal" && onGround)
                  {
                     this.setOnPipeHorz(_loc5_);
                  }
                  else if(_loc5_.axis == "vertical")
                  {
                     if(hMidX >= hLft && hMidX <= hRht)
                     {
                        this.setOnPipeVert(_loc5_);
                     }
                  }
               }
         }
      ...
      protected function fullyPowerup() : void
      {
         ...
         {
            if(!this.upgradeIsActive(MUSHROOM))
            {
               hitRandomUpgrade(this.charNum,false);
            }
            if(!this.upgradeIsActive(FIRE_FLOWER))
            {
               hitRandomUpgrade(this.charNum,false);
            }
      ...
      protected function getAmmoTypeWithLeastAmmo() : String
      {
         ...
         for(var _loc7_ in this.ammoDct)
         {
            _loc3_ = _loc7_;
            _loc7_;
      ...
      {
         var _loc1_:String = null;
         for(var _loc4_ in this.ammoDct)
         {
            _loc1_ = _loc4_;
            _loc4_;
      ...
      private function get shouldDieInstantly() : Boolean
      {
         ...
         if(GameSettings.classicDamageResponse == ClassicDamageResponse.InstantDeath && GameSettings.classicMode)
         {
            return true;
         }
         return false;
      ...
      protected function takeDamage(param1:LevObj) : void
      {
         ...
         if(!this.canGetMushroom || !this.upgradeIsActive(MUSHROOM) || this.shouldDieInstantly)
         {
            this.die(param1);
            return;
         }
         ...
         {
            _loc3_ = null;
            _loc4_ = this.upgradeIsActive(FIRE_FLOWER);
            if(_loc4_)
            {
               STAT_MNGR.removeCharUpgrade(this.charNum,FIRE_FLOWER,true);
               for each(var _loc7_ in this.classicLoseFireFlowerUpgrades)
               {
                  _loc3_ = _loc7_;
                  _loc7_;
                  STAT_MNGR.removeCharUpgrade(this.charNum,_loc3_,true);
               }
            }
            if(GameSettings.classicDamageResponse == ClassicDamageResponse.LoseEverything || !_loc4_)
            {
               STAT_MNGR.removeCharUpgrade(this.charNum,MUSHROOM,true);
               for each(_loc7_ in this.classicLoseMushroomUpgrades)
               {
                  _loc3_ = _loc7_;
                  _loc7_;
                  STAT_MNGR.removeCharUpgrade(this.charNum,_loc3_,true);
      ...
      {
         var _loc2_:int = int(param1.indexOf("_"));
         if(_loc2_ != -1)
         {
      ...
      protected function noDamageTmrLsr(param1:TimerEvent) : void
      {
         ...
         if(Boolean(this.flickerTmr) && this.flickerTmr.running)
         {
            this.flickerStop();
         }
      }
      ...
      override public function finalCheck() : void
      {
         ...
         if(this is Bill)
         {
            _loc4_ = Bill(this).torso;
            _loc1_ = _loc4_.numChildren;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
            ...
            _loc5_ = Bill(this).legs;
            _loc1_ = _loc5_.numChildren;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
         ...
         if(this is MegaMan)
         {
            _loc6_ = MegaMan(this).head;
            _loc1_ = _loc6_.numChildren;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
      ...
      {
         vy = -this.bouncePwr;
         if(Boolean(param1) && ny > param1.hTop)
         {
            ny = param1.hTop;
         }
         this.setHitPoints();
      ...
      override public function checkStgPos() : void
      {
         ...
         if((Cheats.bouncyPits || level is TitleLevel) && !this.dead && this.checkBouncePit() && this.pitTransArr == null && !this.pipe)
         {
            this.bouncePit();
            return;
         }
         ...
         if(!(this is Sophia) && ny - height >= GLOB_STG_BOT || this is Sophia && hTop >= GLOB_STG_BOT)
         {
            ...
            else if(Boolean(this.pitTransArr) && !this._fellInPit)
            {
               if(this.dead)
               {
                  this.initiatePitDeath();
      ...
      public function springLaunch(param1:SpringRed) : void
      {
      }
      ...
      override public function cleanUp() : void
      {
         ...
         if(Boolean(level) && Boolean(level.charDct))
         {
      ...
      override protected function removeListeners() : void
      {
         ...
         if(Boolean(this.bubbleTmr) && this.bubbleTmr.hasEventListener(TimerEvent.TIMER_COMPLETE))
         {
            this.bubbleTmr.removeEventListener(TimerEvent.TIMER_COMPLETE,this.bubbleTmrLsr);
         }
         if(Boolean(this.freezeGameTmr) && this.freezeGameTmr.hasEventListener(TimerEvent.TIMER_COMPLETE))
         {
            this.freezeGameTmr.removeEventListener(TimerEvent.TIMER_COMPLETE,this.freezeGameTmrHandler);
         }
         if(Boolean(this.noDamageTmr) && this.noDamageTmr.hasEventListener(TimerEvent.TIMER_COMPLETE))
         {
            this.noDamageTmr.removeEventListener(TimerEvent.TIMER_COMPLETE,this.noDamageTmrLsr);
         }
         if(Boolean(this.starPwrTmr1) && this.starPwrTmr1.hasEventListener(TimerEvent.TIMER_COMPLETE))
         {
            this.starPwrTmr1.removeEventListener(TimerEvent.TIMER_COMPLETE,this.starPwrTmr1Handler);
         }
         if(Boolean(this.starPwrTmr2) && this.starPwrTmr2.hasEventListener(TimerEvent.TIMER_COMPLETE))
         {
            this.starPwrTmr2.removeEventListener(TimerEvent.TIMER_COMPLETE,this.starPwrTmr2Handler);
         }
         if(Boolean(this.starPwrTmr3) && this.starPwrTmr3.hasEventListener(TimerEvent.TIMER_COMPLETE))
         {
            this.starPwrTmr3.removeEventListener(TimerEvent.TIMER_COMPLETE,this.starPwrTmr3Handler);
         }
         if(Boolean(this.flagDelayTmr) && this.flagDelayTmr.hasEventListener(TimerEvent.TIMER_COMPLETE))
         {
            this.flagDelayTmr.removeEventListener(TimerEvent.TIMER_COMPLETE,this.flagDelayTmrLsr);
         }
         if(Boolean(this.musicDelTmr) && this.musicDelTmr.hasEventListener(TimerEvent.TIMER_COMPLETE))
         {
            this.musicDelTmr.removeEventListener(TimerEvent.TIMER_COMPLETE,this.musicDelTmrLsr);
         }
         if(this.flickerTmr)
      ...
      {
         return this._isGoodSwimmer;
      }
      
      public function get isWideCharacter() : Boolean
      {
         return this._isWideCharacter;
      }
      
      public function get canGetMushroom() : Boolean
      {
         return this._canGetMushroom || GameSettings.powerupMode == PowerupMode.Classic;
      }
      
      public function set canGetMushroom(param1:Boolean) : void
      {
         this._canGetMushroom = param1;
      }
   }
}
