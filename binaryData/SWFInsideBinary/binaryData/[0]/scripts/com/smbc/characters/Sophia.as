package com.smbc.characters
{
   ...
   public final class Sophia extends Character
   {
      ...
      {
         return Vector.<String>([SOPHIA_CRUSHER,SOPHIA_WALL_CLIMB,SOPHIA_CEILING_CLIMB,this.classicWeapon]);
      }
      ...
      override protected function jump() : void
      {
         ...
         this.moveWheelsDown();
         if(Boolean(this.attachedToPlatform) || Boolean(onPlatform))
         {
      ...
      override protected function checkState() : void
      {
         ...
         if(cState == ST_CLIMB && !this.attachedToPlatform)
         {
            ...
            while(_loc6_ < _loc5_)
            {
               ...
               _loc8_ = level.getGroundAt(_loc7_.x,_loc7_.y);
      ...
      private function checkWallsForClimb(param1:Boolean = false, param2:Boolean = false) : void
      {
         ...
         if(!this.vertical)
         {
            ...
            _loc7_ = level.getGroundAt(_loc3_,_loc4_);
            if((!_loc7_ || !_loc7_.visible) && this.sophiaUpBtn)
            {
               if(_loc14_)
               {
                  _loc6_ = level.getGroundAt(_loc3_,_loc4_ - TILE_SIZE);
            ...
            if(!_loc14_)
            {
               ...
               _loc6_ = level.getGroundAt(_loc5_.x,_loc5_.y);
               if(!_loc6_ || !_loc6_.visible)
               {
                  _loc6_ = level.getGroundAt(_loc5_.x + TILE_SIZE * _loc8_,_loc5_.y);
                  if(!_loc6_ || !_loc6_.visible)
                  {
                     _loc6_ = level.getGroundAt(_loc3_,_loc4_ + TILE_SIZE);
                     if((Boolean(_loc6_)) && _loc6_.visible)
                     {
                        _loc6_ = level.getGroundAt(_loc6_.x - TILE_SIZE * _loc8_,_loc6_.y);
                        if(!_loc6_ || !_loc6_.visible)
                        {
            ...
            if(_loc7_ && _loc7_.visible || Boolean(this.falseGroundRect))
            {
               ...
               if((!_loc6_ || !_loc6_.visible) && _loc9_)
               {
                  if(_loc7_)
                  {
               ...
               if(Boolean(this.falseGroundRect) && cState != ST_WALL_TRANS)
               {
                  _loc10_ = true;
               }
            }
            ...
            if(_loc10_)
            {
               ...
               if(!_loc6_ || !_loc6_.visible)
               {
                  _loc7_ = level.getGroundAt(_loc3_ - TILE_SIZE * _loc8_,_loc4_);
                  if((Boolean(_loc7_)) && _loc7_.visible)
                  {
                     ...
                     if(_loc11_ < MAX_INVERTED_CLIMB_DIST)
                     {
                        ...
                        {
                           _loc6_ = level.getGroundAt(_loc3_ + TILE_SIZE * _loc8_,_loc4_);
                           if(!_loc6_ || !_loc6_.visible)
                           {
                           ...
                           {
                              _loc6_ = level.getGroundAt(_loc3_ + TILE_SIZE * _loc8_,_loc4_ + level.TILE_SIZE * 2);
                              if((Boolean(_loc6_)) && _loc6_.visible)
                              {
                                 _loc6_ = level.getGroundAt(_loc6_.x - TILE_SIZE * _loc8_,_loc6_.y);
                                 if(!_loc6_ || !_loc6_.visible)
         ...
         else
         {
            ...
            if(!_loc6_ || !_loc6_.visible)
            {
               _loc6_ = level.getGroundAt(_loc5_.x,_loc5_.y + TILE_SIZE * _loc8_);
               if(!_loc6_ || !_loc6_.visible)
               {
                  if(_loc15_)
                  {
                  ...
                  _loc6_ = level.getGroundAt(_loc16_,_loc4_);
                  if((Boolean(_loc6_)) && _loc6_.visible)
                  {
                     _loc6_ = level.getGroundAt(_loc6_.x,_loc6_.y - TILE_SIZE * _loc8_);
                     if(!_loc6_ || !_loc6_.visible)
                     {
                        this.falseGroundRect = new Rectangle(_loc3_,_loc4_,TILE_SIZE,TILE_SIZE);
                     }
            ...
            if((!_loc7_ || !_loc7_.visible) && this.sophiaUpBtn)
            {
               if(_loc15_)
               {
                  _loc6_ = level.getGroundAt(_loc3_ + TILE_SIZE,_loc4_);
                  if((Boolean(_loc6_)) && _loc6_.visible)
                  {
            ...
            if(_loc10_)
            {
               ...
               if(!_loc6_ || !_loc6_.visible)
               {
                  ...
                  _loc6_ = level.getGroundAt(_loc3_,_loc4_ + level.TILE_SIZE * _loc8_);
                  if(!_loc6_ || !_loc6_.visible)
                  {
                     if(_loc15_)
                     {
                  ...
                  if(Boolean(_loc7_) && (!_loc6_ || !_loc6_.visible || this.sophiaDwnBtn))
                  {
                     _loc11_ = hMidY - _loc7_.hMidY;
                     if(_loc11_ < 0)
                     {
      ...
      override public function hitPickup(param1:Pickup, param2:Boolean = true) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case FIRE_FLOWER:
               ...
               this.updHoverBarVisibility();
               this.updSubWeapon();
               if(GameSettings.classicMode && _loc3_)
               {
                  if(this.classicWeapon == SOPHIA_MISSILE)
                  {
                     increaseAmmoByValue(SOPHIA_MISSILE,MISSILE_PICKUP_VALUE * 2);
                  }
                  else if(this.classicWeapon == SOPHIA_HOMING_MISSILE)
                  {
      ...
      override public function pressAtkBtn() : void
      {
         ...
         if(this.sophiaDwnBtn && !underWater && GameSettings.classicSpecialInput)
         {
      ...
      private function detachFromWall(param1:Boolean = true) : void
      {
         ...
         else if(rotation == ROT_WALL_BOT && Boolean(this.attachedToPlatform))
         {
      ...
      private function checkDropFromWall(param1:Boolean = false) : Boolean
      {
         ...
         if(this.vertical)
         {
            ...
            for each(_loc5_ in _loc3_)
            {
               ...
               _loc7_ = level.getGroundAt(_loc6_.x,_loc6_.y);
               if((Boolean(_loc7_)) && _loc7_.visible)
               {
                  return false;
               }
      ...
      {
         if(Boolean(this.attachedToPlatform) && param1 == this.attachedToPlatform)
         {
      ...
      override public function groundBelow(param1:Ground) : void
      {
         ...
         if(Boolean(onPlatform) && !(param1 is Platform))
         {
            this.attachedToPlatform = null;
            onPlatform = null;
         }
      ...
      {
         if(param1 == swapAnimTmr && Boolean(SWAP_PS_VEC.length))
         {
            this.swapPs();
         }
