package com.smbc.characters
{
   ...
   public class Bass extends MegaManBase
   {
      ...
      public static const AMMO_ARR:Array = [[MM_SUPER_ARM,MAX_WPN_ENGY,MAX_WPN_ENGY],[MM_METAL_BLADE,MAX_WPN_ENGY,MAX_WPN_ENGY],[MM_HARD_KNUCKLE,MAX_WPN_ENGY,MAX_WPN_ENGY],[MM_PHARAOH_SHOT,MAX_WPN_ENGY,MAX_WPN_ENGY],[MM_CHARGE_KICK,MAX_WPN_ENGY,MAX_WPN_ENGY],[MM_FLAME_BLAST,MAX_WPN_ENGY,MAX_WPN_ENGY],[MM_MAGMA_BAZOOKA,MAX_WPN_ENGY,MAX_WPN_ENGY],[MM_WATER_SHIELD,MAX_WPN_ENGY,MAX_WPN_ENGY],[MM_SCREW_CRUSHER,MAX_WPN_ENGY,MAX_WPN_ENGY]];
      
      public static const AMMO_DCT:CustomDictionary = new CustomDictionary();
      
      public static const AMMO_DEPLETION_ARR:Array = [[MM_SUPER_ARM,8],[MM_METAL_BLADE,2],[MM_HARD_KNUCKLE,8],[MM_PHARAOH_SHOT,4],[MegaManProjectile.TYPE_PHARAOH_BALLOON,8],[MM_CHARGE_KICK,4],[MM_FLAME_BLAST,4],[MM_MAGMA_BAZOOKA,2],[MegaManProjectile.TYPE_MAGMA_BAZOOKA_CHARGE,12],[MM_WATER_SHIELD,16],[MM_SCREW_CRUSHER,2]];
      ...
      public static const SKIN_ORDER:Array = [SKIN_BASS_NES,SKIN_BASS_SNES,SKIN_BASS_GB,SKIN_BASS_X1,SKIN_BASS_ATARI,SKIN_DR_WILY_NES,SKIN_DR_WILY_SNES,SKIN_MR_X_NES,SKIN_MR_X_SNES,SKIN_DR_COSSACK_NES,SKIN_DR_COSSACK_SNES,SKIN_QUICK_MAN_NES,SKIN_QUICK_MAN_SNES,SKIN_GEMINI_MAN_NES,SKIN_GEMINI_MAN_SNES,SKIN_SKULL_MAN_NES];
      ...
      private const CHOOSE_CHAR_SEQ:Array = [[1,pressRhtBtn],[0,pressDwnBtn],[47,pressJmpBtn],[136,relJmpBtn],[220,pressJmpBtn],[83,relDwnBtn],[334,relJmpBtn]];
