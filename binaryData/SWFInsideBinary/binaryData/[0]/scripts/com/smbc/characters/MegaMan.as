package com.smbc.characters
{
   ...
   public final class MegaMan extends MegaManBase
   {
      ...
      public static const OBTAINABLE_UPGRADES_ARR:Array = [[MM_SUPER_ARM,MM_METAL_BLADE,MM_HARD_KNUCKLE,MM_PHARAOH_SHOT,MM_CHARGE_KICK,MM_FLAME_BLAST,MM_MAGMA_BAZOOKA,MM_WATER_SHIELD,MM_SCREW_CRUSHER]];
      ...
      public static const AMMO_DEPLETION_ARR:Array = [[MM_SUPER_ARM,8],[MM_METAL_BLADE,2],[MM_HARD_KNUCKLE,8],[MM_PHARAOH_SHOT,4],[MM_RUSH_COIL,4],[MegaManProjectile.TYPE_PHARAOH_BALLOON,8],[MM_CHARGE_KICK,4],[MM_FLAME_BLAST,4],[MM_MAGMA_BAZOOKA,2],[MegaManProjectile.TYPE_MAGMA_BAZOOKA_CHARGE,12],[MM_WATER_SHIELD,16],[MM_SCREW_CRUSHER,2]];
      ...
      public static const SKIN_ORDER:Array = [SKIN_MEGA_MAN_NES,SKIN_MEGA_MAN_SNES,SKIN_MEGA_MAN_GB,SKIN_MEGA_MAN_X1,SKIN_MEGA_MAN_ATARI,SKIN_MEGA_MAN_NO_HELMET_NES,SKIN_MEGA_MAN_NO_HELMET_SNES,SKIN_MEGA_MAN_NO_HELMET_GB,SKIN_ROCK_NES,SKIN_ROCK_SNES,SKIN_QUINT,SKIN_PROTO_MAN_NES,SKIN_PROTO_MAN_SNES,SKIN_PROTO_MAN_GB,SKIN_BREAK_MAN_NES,SKIN_BREAK_MAN_SNES,SKIN_BREAK_MAN_GB,SKIN_ROLL_NES,SKIN_ROLL_SNES,SKIN_DR_LIGHT_NES,SKIN_CUT_MAN_NES,SKIN_CUT_MAN_SNES,SKIN_FIRE_MAN_NES,SKIN_ICE_MAN_NES,SKIN_FRANCESCA,SKIN_DOROPIE,SKIN_ROKKO_CHAN];
      ...
      override public function setStats() : void
      {
         ...
         {
            this.swapWeaponsTimer = new CustomTimer(this.SWAP_WEAPONS_TIMER_DELAY,1);
            this.swapWeaponsTimer.addEventListener(TimerEvent.TIMER_COMPLETE,this.swapWeaponsTimerHandler,false,0,true);
            addTmr(this.swapWeaponsTimer);
         }
      }
      ...
      protected function swapWeaponsTimerHandler(param1:TimerEvent) : void
      {
         this.swapWeaponsTimer.reset();
      ...
      {
         super.relSelBtn();
         if(GameSettings.classicMode && this.swapWeaponsTimer.running)
         {
            this.swapWeaponsTimer.reset();
      ...
      override protected function removeListeners() : void
      {
         ...
         if(this.swapWeaponsTimer)
         {
            this.swapWeaponsTimer.removeEventListener(TimerEvent.TIMER_COMPLETE,this.swapWeaponsTimerHandler);
         }
      }
      ...
      {
         super.reattachLsrs();
         if(Boolean(this.swapWeaponsTimer) && !this.swapWeaponsTimer.hasEventListener(TimerEvent.TIMER_COMPLETE))
         {
            this.swapWeaponsTimer.addEventListener(TimerEvent.TIMER_COMPLETE,this.swapWeaponsTimerHandler);
         }
      }
   }
}
