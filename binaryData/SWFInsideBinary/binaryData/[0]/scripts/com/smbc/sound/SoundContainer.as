package com.smbc.sound
{
   ...
   public class SoundContainer
   {
      ...
      {
         if(Boolean(this.soundData) && Boolean(this.sound))
         {
      ...
      protected function onSampleData(param1:SampleDataEvent) : void
      {
         ...
         else if(Boolean(this.soundData.bytesAvailable) || this.loop)
         {
            _loc3_ = int(this.soundData.bytesAvailable);
            ...
            if(this.loop)
            {
               while(_loc3_ < NUM_BYTES_PER_CYCLE && _loc5_ < MAX_LOOPS_IN_ONE_CYCLE)
               {
                  ...
                  {
                     _loc4_ = int(this.soundData.bytesAvailable);
                  }
