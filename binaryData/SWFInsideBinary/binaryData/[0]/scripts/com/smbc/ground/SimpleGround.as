package com.smbc.ground
{
   ...
   public class SimpleGround extends Ground
   {
      ...
      public function checkNearbyGround() : void
      {
         ...
         if(_loc2_)
         {
            _loc9_ = _loc2_.baseName;
            if(_loc9_ != baseName && !this.baseNameException(_loc9_,this.bnExceptionDct))
            {
               _loc2_ = null;
            }
         }
               ...
               if(_loc7_)
               {
                  ...
                  if(_loc4_)
                  {
                     if(_loc5_)
                     {
                        ...
                        else if(!_loc1_ && !_loc3_ && _loc6_ && Boolean(_loc8_))
                        {
                        ...
                        else if(Boolean(_loc1_) && Boolean(_loc3_) && Boolean(_loc6_) && !_loc8_)
                        {
                     ...
                     else
                     {
                        ...
                        else if(!_loc1_ && Boolean(_loc6_))
                        {
                           _loc10_ += corStr + topStr;
                        }
                        else if(Boolean(_loc1_) && !_loc6_)
                        {
                  ...
                  else if(_loc5_)
                  {
                     ...
                     else if(!_loc3_ && Boolean(_loc8_))
                     {
                        _loc10_ += corStr + topStr;
                     }
                     else if(Boolean(_loc3_) && !_loc8_)
                     {
                        _loc10_ += corStr + botStr;
                     }
                  }
               ...
               else
               {
                  ...
                  if(_loc4_)
                  {
                     if(_loc5_)
                     {
                        ...
                        else if(Boolean(_loc1_) && !_loc3_)
                        {
                           _loc10_ += corStr + rhtStr;
                        }
                        else if(!_loc1_ && Boolean(_loc3_))
                        {
            ...
            else if(_loc7_)
            {
               ...
               if(_loc4_)
               {
                  if(_loc5_)
                  {
                     ...
                     else if(Boolean(_loc6_) && !_loc8_)
                     {
                        _loc10_ += corStr + rhtStr;
                     }
                     else if(!_loc6_ && Boolean(_loc8_))
                     {
                        _loc10_ += corStr + lftStr;
                     }
                  }
