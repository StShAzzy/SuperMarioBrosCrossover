package com.smbc.ground
{
   ...
   public class Ground extends LevObj
   {
      ...
      public function Ground(param1:String)
      {
         ...
         if(param1 != null)
         {
            _loc2_ = int(param1.indexOf(Level.PROP_SEP));
            if(_loc2_ != -1)
            {
            ...
            while(_loc6_ < _loc4_)
            {
               ...
               if(_loc7_.toLowerCase() != _loc7_ && _loc7_.toUpperCase() == _loc7_)
               {
                  if(_loc6_ != _loc3_)
                  {
                     _loc5_ = _loc6_;
      ...
      internal function standingOnGround(param1:AnimatedObject) : void
      {
      }
