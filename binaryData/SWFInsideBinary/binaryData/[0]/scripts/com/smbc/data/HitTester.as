package com.smbc.data
{
   ...
   public class HitTester
   {
      ...
      private function checkLastHitPoints(param1:LevObj, param2:Boolean, param3:LevObj, param4:Boolean, param5:Boolean = false) : void
      {
         ...
         if(param5)
         {
            _loc15_ = param1 as AnimatedObject;
            _loc6_ = _loc15_.hRect2.lhTop;
         ...
         if(_loc7_ <= _loc10_)
         {
            if(_loc9_ <= _loc12_)
            {
               ...
               {
                  if(param1 is Mushroom && param3.x == 544 && GameSettings.mapPack == MapPack.Smb && StatManager.STAT_MNGR.currentLevelID.fullName == "1-2b")
                  {
                     param1.hit(param3,"right");
                     param3.hit(param1,"left");
                  }
