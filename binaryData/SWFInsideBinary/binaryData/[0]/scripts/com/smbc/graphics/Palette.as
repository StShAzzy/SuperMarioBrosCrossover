   ...
   public class Palette
   {
      ...
      private function drawToPalSheet() : void
      {
         ...
         while(_loc1_ < this._numRows)
         {
            ...
            {
               _loc2_ = this.itemNum + (SET_HEIGHT + SPACE_BTW_SETS) * this.var_1;
            }
      ...
      private function getYPos(param1:Boolean = false) : int
      {
         ...
         return this.itemNum + (SET_HEIGHT + SPACE_BTW_SETS) * this.var_1;
      }
      ...
      {
         savePalette(this,this.type,this.skin,this.theme,this.var_1);
      }
