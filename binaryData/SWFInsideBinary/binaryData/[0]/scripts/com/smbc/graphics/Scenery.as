package com.smbc.graphics
{
   ...
   public class Scenery extends SkinObj
   {
      ...
      protected var TILE_SIZE:int;
      
      protected var HALF_TILE_SIZE:int;
      
      private var GLOB_STG_RHT:int;
      ...
      public function Scenery(param1:String)
      {
         ...
         this.TILE_SIZE = this.level.TILE_SIZE;
         this.HALF_TILE_SIZE = this.TILE_SIZE / 2;
         this.GLOB_STG_RHT = Level.GLOB_STG_RHT;
         if(param1 != null)
         {
            _loc3_ = int(param1.indexOf(Level.PROP_SEP));
            if(_loc3_ != -1)
            {
         ...
         super();
         if(FRONT_LAYER_DCT[param1] != undefined)
         {
            this.topLayer = true;
         }
         else if(BACK_LAYER_DCT[param1] != undefined)
         {
            this.bottomLayer = true;
         }
         if(Boolean(param1) && param1.indexOf(WAVE_BASE_STR) != -1)
         {
         ...
         if(Boolean(param1) && param1.indexOf(TEXT_ADD_STR) != -1)
         {
      ...
      public function updateOnSkinChange() : Boolean
      {
         ...
         if((currentLabel == FL_CASTLE_SMALL && y == 480 - this.TILE_SIZE * 3 || currentLabel == FL_CASTLE_BIG) && (mapSkin == 3 || mapSkin == 4))
         {
            if(mapSkin == 3)
            {
         ...
         if(this.animTmrSkinArr)
         {
            _loc4_ = this.animTmrSkinArr[GameSettings.getMapSkinLimited()];
            if(_loc4_)
            {
               mainAnimTmr = _loc4_;
