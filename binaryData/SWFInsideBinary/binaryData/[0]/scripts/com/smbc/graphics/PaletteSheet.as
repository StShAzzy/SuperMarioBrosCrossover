package com.smbc.graphics
{
   ...
   public class PaletteSheet
   {
      ...
      private function getArrFromRow(param1:int, param2:int, param3:int = 0, param4:Boolean = false) : Array
      {
         ...
         {
            _loc7_ = this.getArrFromBox(param1,param2,_loc6_,param3);
            if(!_loc7_)
            {
               break;
            }
      ...
      public function getMapThemePalette(param1:int, param2:int, param3:int) : Palette
      {
         ...
         var _loc4_:Array = [];
         var _loc5_:Array = this.getArrFromBox(param1,0,param3,THEME_TYPE_MAP);
         if(_loc5_)
         {
            _loc4_.push(_loc5_);
         }
         _loc5_ = this.getArrFromBox(param1,param2,param3,THEME_TYPE_MAP);
         if(_loc5_)
         {
            _loc4_.push(_loc5_);
         }
      ...
      public function getInOutPalette(param1:int, param2:int, param3:int, param4:int) : Palette
      {
         ...
         var _loc5_:Array = [];
         var _loc6_:Array = this.getStandardArr(param1,param2,param3,param4);
         if(_loc6_)
         {
            _loc5_.push(_loc6_);
         }
         _loc6_ = this.getArrFromBox(param1,param2,param3,param4);
         if(_loc6_)
         {
            _loc5_.push(_loc6_);
         }
